...
|---|---|---|---|---|---|---|---|---|---|
| SCHEDULE_NOTIFICATIONS-FN01 | schedulePlanNotifications | SCHEDULE_NOTIFICATIONS-F01 | Use case / Service | planned:lib/app_versions/v1/services/notifications/application/schedule_notifications_fn01.dart | Plan activated or updated | Command + actor context | Result/Error | Audit/event when required | Approved - DD docs complete |
| SCHEDULE_NOTIFICATIONS-FN02 | handleNotificationAction | SCHEDULE_NOTIFICATIONS-F02 | Use case / Service | planned:lib/app_versions/v1/services/notifications/application/schedule_notifications_fn02.dart | Notification action complete/skip | Command + actor context | Result/Error | Audit/event when required | Approved - DD docs complete |
...
|---|---|---|---|
| SCHEDULE_NOTIFICATIONS-FN-EV01-01 | Happy path cho SCHEDULE_NOTIFICATIONS-FN01. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV01-02 | Business rule violation cho SCHEDULE_NOTIFICATIONS-BR01. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV01-03 | Permission denied theo role/scope. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV01-04 | Idempotency/retry nếu có ghi dữ liệu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV01-05 | Audit hoặc event được tạo khi BD yêu cầu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
...
| ID | Requirement | DD docs status | Implementation evidence |
|---|---|---|---|
| SCHEDULE_NOTIFICATIONS-FN-EV02-01 | Happy path cho SCHEDULE_NOTIFICATIONS-FN02. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV02-02 | Business rule violation cho SCHEDULE_NOTIFICATIONS-BR02. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV02-03 | Permission denied theo role/scope. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV02-04 | Idempotency/retry nếu có ghi dữ liệu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| SCHEDULE_NOTIFICATIONS-FN-EV02-05 | Audit hoặc event được tạo khi BD yêu cầu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
