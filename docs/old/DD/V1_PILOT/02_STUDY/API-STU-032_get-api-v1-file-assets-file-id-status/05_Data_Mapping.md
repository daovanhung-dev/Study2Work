...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thông điệp an toàn theo trạng thái/kết quả | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chủ sở hữu/người duyệt được quyền.
...
- Endpoint input contract: → thông điệp an toàn theo trạng thái/kết quả.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện chủ sở hữu hoặc quyền đính kèm theo miền; đọc kết quả quét mới nhất

- Operations/observability contract: Thăm dò tối đa 1/2 giây; riêng tư
