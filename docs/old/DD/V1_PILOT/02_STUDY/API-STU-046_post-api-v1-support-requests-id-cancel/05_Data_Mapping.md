...
format: "markdown"
dd_id: "API-STU-046"
api_name: "POST /api/v1/support-requests/{id}/cancel"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | đã hủy | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Lý do → đã hủy.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa yêu cầu còn mở; thêm sự kiện; yêu cầu kết thúc không đổi

- Operations/observability contract: Khóa lặp
