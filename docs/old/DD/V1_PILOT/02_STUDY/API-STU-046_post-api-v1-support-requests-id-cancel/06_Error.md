...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SUPPORT_REQUEST_TERMINAL` | As specified by API catalog. | `SOURCE_REQUIRED` | `SUPPORT_REQUEST_TERMINAL` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L181` |
