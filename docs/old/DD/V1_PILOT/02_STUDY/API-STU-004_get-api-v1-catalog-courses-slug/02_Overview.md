...
| Purpose | xem trước chương trình khóa học/phiên bản và trạng thái của người học |
...
| Side effects | Phần công khai CDN 60 giây; phần riêng tư `no-store` |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L129` — endpoint contract.
