...
format: "markdown"
dd_id: "API-STU-013"
api_name: "GET /api/v1/me/primary-path"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | kỳ đang hoạt động, phiên bản được ghim, tiến độ, `nextSwitchAllowedAt` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → kỳ đang hoạt động, phiên bản được ghim, tiến độ, `nextSwitchAllowedAt`.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc kỳ đang hoạt động theo chỉ mục một phần và ảnh chụp lộ trình; bảo đảm duy nhất một kỳ đang hoạt động
