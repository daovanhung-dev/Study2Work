...
| API ID | `API-STU-050` |
| API name | `POST /api/v1/admin/learners/{learnerId}/progress-adjustments` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/admin/learners/{learnerId}/progress-adjustments` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L185`.
