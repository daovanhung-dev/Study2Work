...
| Purpose | loại, hướng dẫn, giới hạn, thang chấm; bài trắc nghiệm không trả đáp án đúng |
| Consumer/Actor | Người học có quyền trong phạm vi |
| Authentication | Người học có quyền trong phạm vi |
| Authorization | Người học có quyền trong phạm vi |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L153` — endpoint contract.
