...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | loại, hướng dẫn, giới hạn, thang chấm; bài trắc nghiệm không trả đáp án đúng | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> loại, hướng dẫn, giới hạn, thang chấm; bài trắc nghiệm không trả đáp án đúng
...
{
  "success": false,
  "businessCode": "ASSESSMENT_NOT_ACCESSIBLE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
