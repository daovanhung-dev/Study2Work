...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | URL chuyển hướng dùng một lần | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học đủ điều kiện đã chấp thuận.
...
- Endpoint input contract: → URL chuyển hướng dùng một lần.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm lại điều kiện/chấp thuận hiện hành; thêm sự kiện liên kết; trả liên kết Zalo ngoài hệ thống, không lưu bí mật trong bộ nhớ đệm ứng dụng khách

- Operations/observability contract: Giới hạn 10/giờ; kiểm toán
