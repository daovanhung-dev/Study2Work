...
| Purpose | URL chuyển hướng dùng một lần |
| Consumer/Actor | Người học đủ điều kiện đã chấp thuận |
| Authentication | Người học đủ điều kiện đã chấp thuận |
| Authorization | Người học đủ điều kiện đã chấp thuận |
...
| Side effects | Giới hạn 10/giờ; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L176` — endpoint contract.
