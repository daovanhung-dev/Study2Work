...
| Purpose | thời điểm đã đọc |
| Consumer/Actor | Người nhận |
| Authentication | Người nhận |
| Authorization | Người nhận |
...
| Side effects | Lặp an toàn; không cần kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L170` — endpoint contract.
