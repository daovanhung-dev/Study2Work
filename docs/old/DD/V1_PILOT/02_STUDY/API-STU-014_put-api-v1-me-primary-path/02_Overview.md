...
| Purpose | kỳ mới đang hoạt động |
| Consumer/Actor | Người học đang hoạt động + đã hoàn tất thiết lập ban đầu |
| Authentication | Người học đang hoạt động + đã hoàn tất thiết lập ban đầu |
| Authorization | Người học đang hoạt động + đã hoàn tất thiết lập ban đầu |
...
| Side effects | Khóa lặp bắt buộc; `study.primary_path.changed`; kiểm toán; không lưu đệm |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L139` — endpoint contract.
