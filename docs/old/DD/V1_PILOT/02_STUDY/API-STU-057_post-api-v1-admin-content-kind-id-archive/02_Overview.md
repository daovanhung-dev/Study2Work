...
| Purpose | thực thể ổn định đã lưu trữ |
| Consumer/Actor | `PERM-STU-004` + MFA |
| Authentication | `PERM-STU-004` + MFA |
| Authorization | `PERM-STU-004` + MFA |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L197` — endpoint contract.
