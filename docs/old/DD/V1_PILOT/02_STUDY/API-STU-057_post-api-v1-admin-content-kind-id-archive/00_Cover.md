...
| API ID | `API-STU-057` |
| API name | `POST /api/v1/admin/content/{kind}/{id}/archive` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/admin/content/{kind}/{id}/archive` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L197`.
