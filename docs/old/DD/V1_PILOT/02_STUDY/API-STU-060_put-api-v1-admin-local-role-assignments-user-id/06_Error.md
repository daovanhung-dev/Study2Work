...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `ROLE_SCOPE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `ROLE_SCOPE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L200` |
| 2 | Endpoint business/error code | DIRECT | `SEPARATION_OF_DUTIES_VIOLATION` | As specified by API catalog. | `SOURCE_REQUIRED` | `SEPARATION_OF_DUTIES_VIOLATION` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L200` |
