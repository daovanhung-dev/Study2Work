...
| Purpose | phân công |
| Consumer/Actor | `PERM-STU-011` + MFA |
| Authentication | `PERM-STU-011` + MFA |
| Authorization | `PERM-STU-011` + MFA |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L200` — endpoint contract.
