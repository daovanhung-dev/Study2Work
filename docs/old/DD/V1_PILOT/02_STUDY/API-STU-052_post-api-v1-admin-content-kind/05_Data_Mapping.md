...
format: "markdown"
dd_id: "API-STU-052"
api_name: "POST /api/v1/admin/content/{kind}"
...
| Siêu dữ liệu ổn định + bản nháp đầu tiên | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thực thể/phiên bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Siêu dữ liệu ổn định + bản nháp đầu tiên → thực thể/phiên bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX slug duy nhất, tạo thực thể ổn định + phiên bản `DRAFT` + phân công tác giả
