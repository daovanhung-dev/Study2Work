...
format: "markdown"
dd_id: "API-STU-006"
api_name: "GET /api/v1/metadata/skills"
...
| trang | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | kỹ năng chuẩn đang hoạt động | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: `q`, trang → kỹ năng chuẩn đang hoạt động.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc kỹ năng bằng FTS/trigram, sắp xếp theo tên chuẩn hóa

- Operations/observability contract: Bộ nhớ đệm 10 phút
