...
| Module | `Study` |
| Method | `GET` |
| Endpoint | `/api/v1/lessons/{lessonId}/study` |
| Purpose | khối/nội dung đã làm sạch, cổng tiến độ và bài đánh giá nguyên tử |
| Consumer/Actor | Người học đã ghi danh vào phiên bản sở hữu |
| Authentication | Người học đã ghi danh vào phiên bản sở hữu |
| Authorization | Người học đã ghi danh vào phiên bản sở hữu |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L149` — endpoint contract.
