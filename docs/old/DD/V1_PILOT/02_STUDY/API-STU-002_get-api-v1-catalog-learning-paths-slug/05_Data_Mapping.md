...
format: "markdown"
dd_id: "API-STU-002"
api_name: "GET /api/v1/catalog/learning-paths/{slug}"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phiên bản hiện hành đã xuất bản, các phiên bản khóa học được ghim, điều kiện tiên quyết | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Slug → phiên bản hiện hành đã xuất bản, các phiên bản khóa học được ghim, điều kiện tiên quyết.

<a id="s04"></a>
### S04. Execute source-defined processing

> Nối lộ trình ổn định, phiên bản hiện hành và thành phần theo slug duy nhất; không thay thế ngữ cảnh ghi danh cũ

- Operations/observability contract: CDN 60 giây
