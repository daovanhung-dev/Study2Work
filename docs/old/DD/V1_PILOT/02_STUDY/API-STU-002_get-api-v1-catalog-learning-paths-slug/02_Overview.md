...
| Purpose | phiên bản hiện hành đã xuất bản, các phiên bản khóa học được ghim, điều kiện tiên quyết |
...
| Side effects | CDN 60 giây |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L127` — endpoint contract.
