...
| Purpose | thẻ lộ trình đã xuất bản |
...
| Side effects | CDN/Redis 60 giây, ETag |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L126` — endpoint contract.
...
- `learning_paths` (`TBL-STU-009`).
- `learning_path_versions` (`TBL-STU-010`).
