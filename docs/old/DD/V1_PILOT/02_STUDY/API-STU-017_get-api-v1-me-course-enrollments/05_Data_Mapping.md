...
format: "markdown"
dd_id: "API-STU-017"
api_name: "GET /api/v1/me/course-enrollments"
...
| Trang/trạng thái/nguồn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lần ghi danh/tiến độ đúng phiên bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/trạng thái/nguồn → lần ghi danh/tiến độ đúng phiên bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc lần ghi danh + phiên bản khóa học + ảnh chụp bằng `(user,status,updated_at)`; không thay phiên bản hiện hành
