...
| ---: | --- | --- | --- |
| 1 | Câu trả lời từng phần thuộc danh sách cho phép | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Câu trả lời từng phần thuộc danh sách cho phép, `If-Match` → bản nháp đã lưu
