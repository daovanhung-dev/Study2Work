...
format: "markdown"
dd_id: "API-STU-005"
api_name: "GET /api/v1/catalog/sample-lessons/{lessonId}"
...
| UUID | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | khối/nội dung mẫu đã làm sạch | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: UUID → khối/nội dung mẫu đã làm sạch.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện cờ bài học mẫu và phiên bản đã xuất bản; URL nội dung đa phương tiện có chữ ký tối đa 10 phút; không cho HTML không an toàn

- Operations/observability contract: Siêu dữ liệu CDN 60 giây
