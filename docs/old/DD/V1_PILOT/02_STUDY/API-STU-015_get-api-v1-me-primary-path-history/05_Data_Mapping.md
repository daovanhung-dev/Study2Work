...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | các kỳ bất biến/lý do thay đổi | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang → các kỳ bất biến/lý do thay đổi.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn `(learner_id,started_at desc,id)`
