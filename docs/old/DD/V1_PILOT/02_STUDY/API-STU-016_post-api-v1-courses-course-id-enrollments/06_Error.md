...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `COURSE_NOT_PUBLISHED` | As specified by API catalog. | `SOURCE_REQUIRED` | `COURSE_NOT_PUBLISHED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L146` |
| 2 | Endpoint business/error code | DIRECT | `ENROLLMENT_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `ENROLLMENT_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L146` |
