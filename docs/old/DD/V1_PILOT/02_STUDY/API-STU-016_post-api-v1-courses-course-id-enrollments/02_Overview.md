...
| Purpose | lần ghi danh ghim phiên bản |
| Consumer/Actor | Người học đang hoạt động; không bắt buộc thiết lập ban đầu |
| Authentication | Người học đang hoạt động; không bắt buộc thiết lập ban đầu |
| Authorization | Người học đang hoạt động; không bắt buộc thiết lập ban đầu |
...
| Side effects | Khóa lặp bắt buộc; `study.course.enrolled`; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L146` — endpoint contract.
