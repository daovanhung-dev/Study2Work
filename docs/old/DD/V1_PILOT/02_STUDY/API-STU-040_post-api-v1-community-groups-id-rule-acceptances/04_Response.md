...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | chấp thuận | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
{
  "success": false,
  "businessCode": "COMMUNITY_NOT_ELIGIBLE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
