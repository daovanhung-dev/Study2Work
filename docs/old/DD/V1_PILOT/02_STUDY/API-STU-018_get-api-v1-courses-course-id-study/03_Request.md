...
| ---: | --- | --- | --- |
| 1 | ID lần ghi danh tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID lần ghi danh tùy chọn → chương trình được ghim, quyền truy cập/tiến độ
