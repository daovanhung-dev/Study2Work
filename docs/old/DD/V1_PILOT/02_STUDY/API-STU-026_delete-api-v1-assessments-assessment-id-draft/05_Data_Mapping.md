...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | `null` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: `If-Match` → `null`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX xóa mềm/gỡ liên kết bản nháp có thể sửa; không xóa lượt làm đã niêm phong/kiểm toán tệp
