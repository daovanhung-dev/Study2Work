...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `DATE_RANGE_TOO_LARGE` | As specified by API catalog. | `SOURCE_REQUIRED` | `DATE_RANGE_TOO_LARGE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L152` |
