...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/me/learning-history` |
...
| ---: | --- | --- | --- |
| 1 | Trang/ngày/loại | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/ngày/loại → dòng thời gian hoạt động bất biến
