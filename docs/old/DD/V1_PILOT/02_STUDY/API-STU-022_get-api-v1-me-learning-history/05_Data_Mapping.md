...
format: "markdown"
dd_id: "API-STU-022"
api_name: "GET /api/v1/me/learning-history"
...
| Trang/ngày/loại | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | dòng thời gian hoạt động bất biến | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/ngày/loại → dòng thời gian hoạt động bất biến.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn `(user_id,occurred_at desc,id)`; che các trường tải tin đã hết hạn
