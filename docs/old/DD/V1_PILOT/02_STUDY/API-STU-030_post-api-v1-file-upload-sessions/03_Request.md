...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/file-upload-sessions` |
...
| ---: | --- | --- | --- |
| 1 | Mục đích, tên tệp, MIME/kích thước dự kiến <=25MiB, SHA-256 | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Mục đích, tên tệp, MIME/kích thước dự kiến <=25MiB, SHA-256 → ID tải lên + PUT đã ký
