...
| Module | `Study` |
| Method | `POST` |
| Endpoint | `/api/v1/file-upload-sessions` |
| Purpose | ID tải lên + PUT đã ký |
| Consumer/Actor | Người dùng Study đã xác thực |
| Authentication | Người dùng Study đã xác thực |
| Authorization | Người dùng Study đã xác thực |
...
| Side effects | Khóa lặp bắt buộc; URL có chữ ký 15 phút; 20/giờ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L160` — endpoint contract.
