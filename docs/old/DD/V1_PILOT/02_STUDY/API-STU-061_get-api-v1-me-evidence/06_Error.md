...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `TOKEN_AUDIENCE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `TOKEN_AUDIENCE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L214` |
| 2 | Endpoint business/error code | DIRECT | `EVIDENCE_NOT_AVAILABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `EVIDENCE_NOT_AVAILABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L214` |
