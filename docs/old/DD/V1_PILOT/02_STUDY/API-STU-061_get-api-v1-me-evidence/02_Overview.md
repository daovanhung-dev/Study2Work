...
| Module | `Study` |
| Method | `GET` |
| Endpoint | `/api/v1/me/evidence` |
| Purpose | minh chứng `ISSUED` của chính mình; mặc định không trả tệp bí mật |
| Consumer/Actor | Người học; mã thông báo `aud=study-evidence`, phạm vi `evidence:self:read` |
| Authentication | Người học; mã thông báo `aud=study-evidence`, phạm vi `evidence:self:read` |
| Authorization | Người học; mã thông báo `aud=study-evidence`, phạm vi `evidence:self:read` |
...
| Side effects | Riêng tư, không lưu; kiểm toán truy cập; 60/phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L214` — endpoint contract.
...
- [OQ-STU-EVIDENCE-FILES](../../OPEN_QUESTIONS.md#oq-stu-evidence-files).
