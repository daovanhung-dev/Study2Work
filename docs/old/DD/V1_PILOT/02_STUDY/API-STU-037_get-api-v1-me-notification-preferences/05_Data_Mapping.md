...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tùy chọn kênh/danh mục | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → tùy chọn kênh/danh mục.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc giá trị mặc định và giá trị ghi đè
