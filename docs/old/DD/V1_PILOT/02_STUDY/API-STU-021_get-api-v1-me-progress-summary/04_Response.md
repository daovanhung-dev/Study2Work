...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | lộ trình đang hoạt động, thẻ khóa học, lượt chờ duyệt, dữ kiện hoàn thành | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> lộ trình đang hoạt động, thẻ khóa học, lượt chờ duyệt, dữ kiện hoàn thành
