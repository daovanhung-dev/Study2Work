...
| Module | `Study` |
| Method | `GET` |
| Endpoint | `/api/v1/me/progress/summary` |
| Purpose | lộ trình đang hoạt động, thẻ khóa học, lượt chờ duyệt, dữ kiện hoàn thành |
| Consumer/Actor | Người học |
| Authentication | Người học |
| Authorization | Người học |
...
| Side effects | Riêng tư; bộ nhớ đệm người dùng 15 giây bị làm mới qua hộp thư đi |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L151` — endpoint contract.
