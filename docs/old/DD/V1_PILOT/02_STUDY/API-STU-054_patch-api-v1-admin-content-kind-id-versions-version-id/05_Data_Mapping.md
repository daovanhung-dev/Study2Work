...
format: "markdown"
dd_id: "API-STU-054"
api_name: "PATCH /api/v1/admin/content/{kind}/{id}/versions/{versionId}"
...
| Vá siêu dữ liệu/cấu trúc | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản nháp/phiên bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Tác giả hoặc `PERM-STU-002`.
...
- Endpoint input contract: Vá siêu dữ liệu/cấu trúc, `If-Match` → bản nháp/phiên bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa phiên bản; yêu cầu `DRAFT`; làm sạch danh sách Markdown/HTML cho phép; kiểm đúng vị trí bài đánh giá và phiên bản được ghim

- Operations/observability contract: Nên dùng khóa lặp; kiểm toán chênh lệch; không lưu đệm
