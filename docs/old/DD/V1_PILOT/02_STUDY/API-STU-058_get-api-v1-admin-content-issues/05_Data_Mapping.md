...
format: "markdown"
dd_id: "API-STU-058"
api_name: "GET /api/v1/admin/content-issues"
...
| Trang/trạng thái/mức độ/đích | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hàng đợi vấn đề | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/trạng thái/mức độ/đích → hàng đợi vấn đề.

<a id="s04"></a>
### S04. Execute source-defined processing

> Có chỉ mục theo trạng thái/mức độ/báo cáo; truy cập nội dung đã làm sạch
