...
format: "markdown"
dd_id: "API-STU-029"
api_name: "GET /api/v1/assessment-attempts/{attemptId}"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | câu trả lời đã nộp bất biến, điểm/lượt duyệt; người duyệt nhận URL tệp sạch riêng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chủ sở hữu hoặc người duyệt `PERM-STU-006`.
...
- Endpoint input contract: → câu trả lời đã nộp bất biến, điểm/lượt duyệt; người duyệt nhận URL tệp sạch riêng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện chủ sở hữu hoặc phạm vi duyệt được phân công; nối loại câu trả lời/lịch sử duyệt

- Operations/observability contract: Riêng tư, không lưu; kiểm toán truy cập của người duyệt
