...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | nhóm và phiên bản quy tắc hiện hành đã chấp thuận | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> nhóm và phiên bản quy tắc hiện hành đã chấp thuận
