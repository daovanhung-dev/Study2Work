...
| API ID | `API-STU-059` |
| API name | `PUT /api/v1/admin/content-issues/{id}/status` |
| HTTP method | `PUT` |
| Endpoint | `/api/v1/admin/content-issues/{id}/status` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L199`.
