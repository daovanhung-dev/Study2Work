...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/admin/content-issues/{id}/status` |
...
| ---: | --- | --- | --- |
| 1 | Trạng thái, cách giải quyết | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trạng thái, cách giải quyết, `If-Match` → vấn đề
