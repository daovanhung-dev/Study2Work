...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PROGRESS_REGRESSION` | As specified by API catalog. | `SOURCE_REQUIRED` | `PROGRESS_REGRESSION` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L150` |
| 2 | Endpoint business/error code | DIRECT | `VERSION_CONFLICT` | As specified by API catalog. | `412` | `VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L150` |
| 3 | Endpoint business/error code | DIRECT | `BLOCK_NOT_IN_LESSON` | As specified by API catalog. | `SOURCE_REQUIRED` | `BLOCK_NOT_IN_LESSON` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L150` |
