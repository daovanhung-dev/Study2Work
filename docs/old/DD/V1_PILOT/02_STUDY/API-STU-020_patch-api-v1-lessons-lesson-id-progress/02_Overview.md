...
| Purpose | ảnh chụp bài học/khóa học/lộ trình |
...
| Side effects | Nên dùng khóa lặp; hộp thư đi cho hoàn thành/hoạt động; chỉ kiểm toán điều chỉnh |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L150` — endpoint contract.
