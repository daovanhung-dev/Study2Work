...
format: "markdown"
dd_id: "API-STU-012"
api_name: "GET /api/v1/me/path-recommendations"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | ba phiên bản lộ trình đầu, dải điểm/lý do/phiên bản lượt chạy | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học đang hoạt động + đã thiết lập ban đầu.
...
- Endpoint input contract: → ba phiên bản lộ trình đầu, dải điểm/lý do/phiên bản lượt chạy.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc lượt/mục gợi ý bất biến mới nhất; bỏ lộ trình chưa xuất bản và đánh dấu lỗi thời nếu danh mục đã đổi
