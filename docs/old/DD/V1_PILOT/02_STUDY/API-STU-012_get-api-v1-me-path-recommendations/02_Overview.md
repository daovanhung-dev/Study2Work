...
| Purpose | ba phiên bản lộ trình đầu, dải điểm/lý do/phiên bản lượt chạy |
| Consumer/Actor | Người học đang hoạt động + đã thiết lập ban đầu |
| Authentication | Người học đang hoạt động + đã thiết lập ban đầu |
| Authorization | Người học đang hoạt động + đã thiết lập ban đầu |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L137` — endpoint contract.
