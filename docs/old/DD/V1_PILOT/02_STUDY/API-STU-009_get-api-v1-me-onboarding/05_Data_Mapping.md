...
format: "markdown"
dd_id: "API-STU-009"
api_name: "GET /api/v1/me/onboarding"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lược đồ câu hỏi, câu trả lời đã lưu, trạng thái/phiên bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → lược đồ câu hỏi, câu trả lời đã lưu, trạng thái/phiên bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc thiết lập ban đầu và bảng câu hỏi hiện hành; không bao giờ chặn API học độc lập
