...
| API ID | `API-STU-048` |
| API name | `POST /api/v1/admin/assessment-attempts/{attemptId}/reviews` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/admin/assessment-attempts/{attemptId}/reviews` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L183`.
