...
format: "markdown"
dd_id: "API-STU-055"
api_name: "POST /api/v1/admin/content/{kind}/{id}/versions/{versionId}/pre-publish-checks"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | báo cáo kiểm tra bất biến | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Tác giả/người xuất bản.
...
- Endpoint input contract: `If-Match` → báo cáo kiểm tra bất biến.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc quyền, cấu trúc, cú pháp liên kết, mọi tài sản `CLEAN`, thang chấm/câu hỏi, siêu dữ liệu khả năng tiếp cận; ghi ảnh chụp kiểm tra

- Operations/observability contract: Khóa lặp; sự kiện hoàn tất kiểm tra
