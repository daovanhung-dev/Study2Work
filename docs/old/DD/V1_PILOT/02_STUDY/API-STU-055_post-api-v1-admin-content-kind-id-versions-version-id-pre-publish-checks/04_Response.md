...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | báo cáo kiểm tra bất biến | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
