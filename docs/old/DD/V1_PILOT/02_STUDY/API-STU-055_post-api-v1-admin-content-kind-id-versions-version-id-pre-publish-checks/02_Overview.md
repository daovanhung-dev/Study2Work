...
| Purpose | báo cáo kiểm tra bất biến |
| Consumer/Actor | Tác giả/người xuất bản |
| Authentication | Tác giả/người xuất bản |
| Authorization | Tác giả/người xuất bản |
...
| Side effects | Khóa lặp; sự kiện hoàn tất kiểm tra |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L195` — endpoint contract.
