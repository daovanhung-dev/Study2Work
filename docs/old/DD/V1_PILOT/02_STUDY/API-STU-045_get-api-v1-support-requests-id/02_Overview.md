...
| Module | `Study` |
| Method | `GET` |
| Endpoint | `/api/v1/support-requests/{id}` |
| Purpose | yêu cầu/sự kiện/ghi chú đã che dữ liệu |
| Consumer/Actor | Chủ sở hữu hoặc `PERM-STU-008` |
| Authentication | Chủ sở hữu hoặc `PERM-STU-008` |
| Authorization | Chủ sở hữu hoặc `PERM-STU-008` |
...
| Side effects | Kiểm toán truy cập của nhân sự |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L180` — endpoint contract.
