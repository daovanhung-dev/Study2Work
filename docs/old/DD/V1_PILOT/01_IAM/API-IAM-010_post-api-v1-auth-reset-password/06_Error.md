...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `TOKEN_INVALID_OR_EXPIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `TOKEN_INVALID_OR_EXPIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L96` |
| 2 | Endpoint business/error code | DIRECT | `PASSWORD_POLICY_FAILED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PASSWORD_POLICY_FAILED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L96` |
| 3 | Endpoint business/error code | DIRECT | `PASSWORD_REUSED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PASSWORD_REUSED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L96` |
