...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | phiên đang hoạt động, cờ phiên hiện tại, thông tin thiết bị/IP khái quát | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> phiên đang hoạt động, cờ phiên hiện tại, thông tin thiết bị/IP khái quát
