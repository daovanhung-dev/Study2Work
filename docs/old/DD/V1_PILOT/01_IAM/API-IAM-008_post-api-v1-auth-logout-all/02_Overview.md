...
| Purpose | số phiên bị thu hồi |
| Consumer/Actor | Đã xác thực + mật khẩu/MFA gần đây |
| Authentication | Đã xác thực + mật khẩu/MFA gần đây |
| Authorization | Đã xác thực + mật khẩu/MFA gần đây |
...
| Side effects | Xử lý lặp an toàn; sự kiện `identity.sessions.revoked`; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L94` — endpoint contract.
