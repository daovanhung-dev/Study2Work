...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | bí mật và tải tin QR một lần, mã khôi phục một lần | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> bí mật và tải tin QR một lần, mã khôi phục một lần
