...
| Purpose | bí mật và tải tin QR một lần, mã khôi phục một lần |
| Consumer/Actor | Người dùng đặc quyền + xác minh tăng cường |
| Authentication | Người dùng đặc quyền + xác minh tăng cường |
| Authorization | Người dùng đặc quyền + xác minh tăng cường |
...
| Side effects | Khóa lặp; `no-store`; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L103` — endpoint contract.
...
- [OQ-IAM-MFA-ENROLLMENT](../../OPEN_QUESTIONS.md#oq-iam-mfa-enrollment).
