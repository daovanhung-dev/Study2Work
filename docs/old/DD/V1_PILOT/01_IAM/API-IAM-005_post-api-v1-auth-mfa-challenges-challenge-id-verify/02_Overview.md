...
| Purpose | mã truy cập/mã làm mới |
| Consumer/Actor | Người dùng có thử thách |
| Authentication | Người dùng có thử thách |
| Authorization | Người dùng có thử thách |
...
| Side effects | Khóa lặp bắt buộc; kiểm toán; 10/15 phút/thử thách |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L91` — endpoint contract.
