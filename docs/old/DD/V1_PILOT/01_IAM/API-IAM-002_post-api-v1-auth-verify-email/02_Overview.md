...
| Purpose | mã truy cập/mã làm mới và tài khoản `ACTIVE` |
...
| Side effects | Khóa lặp bắt buộc; sự kiện `identity.user.verified`; 10/phút/IP |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L88` — endpoint contract.
