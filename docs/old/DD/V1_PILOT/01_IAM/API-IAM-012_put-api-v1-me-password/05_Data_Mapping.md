...
| Mật khẩu hiện tại + mật khẩu mới | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Đã xác thực + mật khẩu/MFA hiện tại.
...
- Endpoint input contract: Mật khẩu hiện tại + mật khẩu mới → thành công.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa thông tin xác thực; xác minh mật khẩu hiện tại; cập nhật hàm băm; thu hồi các phiên khác; tăng `authVersion`

- Operations/observability contract: Khóa lặp; sự kiện/kiểm toán đổi mật khẩu
