...
format: "markdown"
dd_id: "API-IAM-013"
api_name: "POST /api/v1/me/email-change-requests"
...
| Email mới | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thời điểm hết hạn | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Email mới → thời điểm hết hạn.

<a id="s04"></a>
### S04. Execute source-defined processing

> Email chuẩn hóa duy nhất; tạo mã `CHANGE_EMAIL` đã băm; email cũ vẫn là định danh đăng nhập

- Operations/observability contract: Xử lý lặp an toàn; giao nhận + kiểm toán; 3/ngày
