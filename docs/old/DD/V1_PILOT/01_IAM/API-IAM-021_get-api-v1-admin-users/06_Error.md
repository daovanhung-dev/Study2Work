...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `MFA_REQUIRED` | As specified by API catalog. | `403` | `MFA_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L107` |
| 2 | Endpoint business/error code | DIRECT | `PERMISSION_DENIED` | As specified by API catalog. | `403` | `PERMISSION_DENIED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L107` |
