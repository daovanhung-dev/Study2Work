...
| Purpose | người dùng đã che dữ liệu |
| Consumer/Actor | `PERM-IAM-001` |
| Authentication | `PERM-IAM-001` |
...
| Side effects | Không dùng bộ nhớ đệm chung; kiểm toán tìm kiếm; 60/phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L107` — endpoint contract.
