...
| Purpose | mã thông báo hoặc thử thách MFA |
...
| Side effects | Kiểm toán bảo mật cả thành công/thất bại; tần suất như mục 2.3; sự kiện rủi ro đăng nhập nếu bất thường |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L90` — endpoint contract.
