...
format: "markdown"
dd_id: "API-IAM-024"
api_name: "GET /.well-known/jwks.json"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | khóa công khai đang hoạt động/luân chuyển | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Không có đầu vào → khóa công khai đang hoạt động/luân chuyển.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc siêu dữ liệu khóa ký hoặc cấu hình; chỉ trả tham số công khai; lưu đệm khóa cũ đến hết TTL tối đa của mã thông báo

- Operations/observability contract: CDN 5 phút; ETag
