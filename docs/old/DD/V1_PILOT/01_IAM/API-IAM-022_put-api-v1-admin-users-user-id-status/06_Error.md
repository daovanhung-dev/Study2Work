...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `INVALID_ACCOUNT_TRANSITION` | As specified by API catalog. | `SOURCE_REQUIRED` | `INVALID_ACCOUNT_TRANSITION` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L108` |
| 2 | Endpoint business/error code | DIRECT | `VERSION_CONFLICT` | As specified by API catalog. | `412` | `VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L108` |
| 3 | Endpoint business/error code | DIRECT | `SELF_SUSPEND_FORBIDDEN` | As specified by API catalog. | `SOURCE_REQUIRED` | `SELF_SUSPEND_FORBIDDEN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L108` |
