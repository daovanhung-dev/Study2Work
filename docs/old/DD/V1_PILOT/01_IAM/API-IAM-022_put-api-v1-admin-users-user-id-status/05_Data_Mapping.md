...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | người dùng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-IAM-002` + MFA.
...
- Endpoint input contract: `ACTIVE` | `SUSPENDED`, lý do, `If-Match` → người dùng.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa người dùng; kiểm chuyển trạng thái; tăng `authVersion`; khi đình chỉ thì thu hồi phiên; ghi hộp thư đi

- Operations/observability contract: Khóa lặp; kiểm toán trước/sau; sự kiện đổi trạng thái
