...
format: "markdown"
dd_id: "API-IAM-020"
api_name: "DELETE /api/v1/me/deletion-request"
...
| Xác nhận | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | `ACTIVE` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Đã xác thực qua luồng khôi phục.
...
- Endpoint input contract: Xác nhận → `ACTIVE`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa người dùng; chỉ trong thời hạn ân hạn và chưa ẩn danh hóa; khôi phục hoạt động, tạo phiên mới sau khi xác thực lại
