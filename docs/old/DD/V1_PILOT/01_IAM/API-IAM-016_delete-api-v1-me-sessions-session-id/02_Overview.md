...
| Purpose | đã thu hồi |
| Consumer/Actor | Đã xác thực + chủ sở hữu |
| Authentication | Đã xác thực + chủ sở hữu |
| Authorization | Đã xác thực + chủ sở hữu |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L102` — endpoint contract.
