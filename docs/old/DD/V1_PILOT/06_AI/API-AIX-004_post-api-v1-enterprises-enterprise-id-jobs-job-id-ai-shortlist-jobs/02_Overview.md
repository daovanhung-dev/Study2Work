...
| Module | `AI` |
| Method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/ai-shortlist-jobs` |
| Purpose | gợi ý bất đồng bộ |
| Consumer/Actor | `PERM-WRK-071` + người duyệt là con người |
| Authentication | `PERM-WRK-071` + người duyệt là con người |
| Authorization | `PERM-WRK-071` + người duyệt là con người |
...
| Side effects | Khóa lặp; kiểm toán tập đã chọn/trường loại trừ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L408` — endpoint contract.
