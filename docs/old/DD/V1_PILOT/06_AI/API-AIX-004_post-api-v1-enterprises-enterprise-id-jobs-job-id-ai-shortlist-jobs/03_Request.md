...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/ai-shortlist-jobs` |
...
| ---: | --- | --- | --- |
| 1 | ID đơn ứng tuyển nêu rõ <=100, phiên bản tiêu chí | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID đơn ứng tuyển nêu rõ <=100, phiên bản tiêu chí → gợi ý bất đồng bộ
