...
| Module | `AI` |
| Method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/ai-jd-jobs` |
| Purpose | tác vụ bất đồng bộ |
| Consumer/Actor | Người biên tập việc làm + quyền sử dụng |
| Authentication | Người biên tập việc làm + quyền sử dụng |
| Authorization | Người biên tập việc làm + quyền sử dụng |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L406` — endpoint contract.
