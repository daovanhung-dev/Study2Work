...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/ai-jd-jobs` |
...
| ---: | --- | --- | --- |
| 1 | Bản sửa đổi nháp, phần/phong cách yêu cầu | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Bản sửa đổi nháp, phần/phong cách yêu cầu → tác vụ bất đồng bộ
