...
| Purpose | phiên bản bất biến |
| Consumer/Actor | `PERM-AIX-003` |
| Authentication | `PERM-AIX-003` |
| Authorization | `PERM-AIX-003` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L413` — endpoint contract.
