...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PROMPT_POLICY_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `PROMPT_POLICY_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L413` |
| 2 | Endpoint business/error code | DIRECT | `REQUIRED_EXCLUSION_MISSING` | As specified by API catalog. | `SOURCE_REQUIRED` | `REQUIRED_EXCLUSION_MISSING` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L413` |
