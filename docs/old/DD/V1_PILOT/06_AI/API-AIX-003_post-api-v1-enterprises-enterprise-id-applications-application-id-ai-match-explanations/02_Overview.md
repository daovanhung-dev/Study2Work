...
| Module | `AI` |
| Method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/ai-match-explanations` |
| Purpose | tác vụ bất đồng bộ |
| Consumer/Actor | Nhà tuyển dụng được phân công + `PERM-WRK-070` |
| Authentication | Nhà tuyển dụng được phân công + `PERM-WRK-070` |
| Authorization | Nhà tuyển dụng được phân công + `PERM-WRK-070` |
...
| Side effects | Khóa lặp; truy cập/kiểm toán; 10/giờ/thành viên |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L407` — endpoint contract.
