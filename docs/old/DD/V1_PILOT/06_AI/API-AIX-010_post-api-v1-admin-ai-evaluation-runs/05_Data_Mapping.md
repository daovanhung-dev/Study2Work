...
format: "markdown"
dd_id: "API-AIX-010"
api_name: "POST /api/v1/admin/ai/evaluation-runs"
...
| Phiên bản cấu hình/lời nhắc/tập đánh giá | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lượt chạy bất đồng bộ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Phiên bản cấu hình/lời nhắc/tập đánh giá → lượt chạy bất đồng bộ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chụp đầu vào; không có PII sản xuất; chỉ số/tình huống lỗi bất biến; chặn kích hoạt dưới ngưỡng
