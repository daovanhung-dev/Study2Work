...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `EVAL_DATASET_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `EVAL_DATASET_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L414` |
| 2 | Endpoint business/error code | DIRECT | `AI_PROVIDER_UNAVAILABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `AI_PROVIDER_UNAVAILABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L414` |
