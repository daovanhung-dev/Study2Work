...
format: "markdown"
dd_id: "API-AIX-001"
api_name: "POST /api/v1/me/cvs/{cvId}/ai-writing-jobs"
...
| Bản sửa đổi, phần, mục tiêu, văn bản nguồn <=10k, ngôn ngữ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Chủ sở hữu CV + quyền sử dụng/đồng ý AI.
...
- Endpoint input contract: Bản sửa đổi, phần, mục tiêu, văn bản nguồn <=10k, ngôn ngữ → tác vụ bất đồng bộ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chụp các trường cho phép đã làm sạch; giữ quyền sử dụng; tạo tác vụ AI với phiên bản mô hình/lời nhắc/chính sách; hộp thư đi; không tự sửa CV

- Operations/observability contract: Khóa lặp; 10/giờ; kiểm toán/nguồn gốc
