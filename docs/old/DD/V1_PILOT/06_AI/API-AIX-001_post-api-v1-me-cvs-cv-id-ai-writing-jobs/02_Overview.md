...
| Module | `AI` |
| Method | `POST` |
| Endpoint | `/api/v1/me/cvs/{cvId}/ai-writing-jobs` |
| Purpose | tác vụ bất đồng bộ |
| Consumer/Actor | Chủ sở hữu CV + quyền sử dụng/đồng ý AI |
| Authentication | Chủ sở hữu CV + quyền sử dụng/đồng ý AI |
| Authorization | Chủ sở hữu CV + quyền sử dụng/đồng ý AI |
...
| Side effects | Khóa lặp; 10/giờ; kiểm toán/nguồn gốc |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L405` — endpoint contract.
