...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/admin/ai/model-configs/{configId}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `configId` | `configId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Tham số nhà cung cấp/mô hình | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Tham số nhà cung cấp/mô hình, `If-Match` → cấu hình có phiên bản
