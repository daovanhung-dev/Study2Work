...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/billing/orders` |
| Purpose | đơn hàng + chuyển hướng/liên kết sâu của nhà cung cấp |
| Consumer/Actor | Ứng viên hoặc thành viên lập hóa đơn tổ chức |
| Authentication | Ứng viên hoặc thành viên lập hóa đơn tổ chức |
| Authorization | Ứng viên hoặc thành viên lập hóa đơn tổ chức |
...
| Side effects | Khóa lặp bắt buộc; kiểm toán; 10/giờ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L376` — endpoint contract.
