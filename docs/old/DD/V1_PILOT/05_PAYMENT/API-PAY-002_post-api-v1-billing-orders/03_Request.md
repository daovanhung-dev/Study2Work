...
| ---: | --- | --- | --- |
| 1 | Phiên bản sản phẩm/giá, số lượng, nhà cung cấp VNPAY/MOMO, ngữ cảnh tổ chức tùy chọn, danh sách đường dẫn trả về cho phép | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phiên bản sản phẩm/giá, số lượng, nhà cung cấp VNPAY/MOMO, ngữ cảnh tổ chức tùy chọn, danh sách đường dẫn trả về cho phép → đơn hàng + chuyển hướng/liên kết sâu của nhà cung cấp
