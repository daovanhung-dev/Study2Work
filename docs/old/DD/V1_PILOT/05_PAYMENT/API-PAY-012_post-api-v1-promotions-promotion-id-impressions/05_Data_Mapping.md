...
format: "markdown"
dd_id: "API-PAY-012"
api_name: "POST /api/v1/promotions/{promotionId}/impressions"
...
| `promotionId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Mã vị trí | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Ứng dụng khách công khai có mã vị trí đã ký.
...
- Endpoint input contract: Mã vị trí → đã tiếp nhận.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm chữ ký/hết hạn; khử trùng lặp phiên trình duyệt+vị trí; thêm chỉ số, không có PII

- Operations/observability contract: `202`; giới hạn tần suất cao
