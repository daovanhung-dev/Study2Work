...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/billing/returns/{provider}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `provider` | `provider` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Chỉ tham chiếu/đơn nhà cung cấp | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Chỉ tham chiếu/đơn nhà cung cấp → tải tin trang trạng thái đã làm sạch
