...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/admin/payments/reconciliation` |
...
| ---: | --- | --- | --- |
| 1 | Trang/nhà cung cấp/ngày/trạng thái | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/nhà cung cấp/ngày/trạng thái → hàng đợi sai lệch
