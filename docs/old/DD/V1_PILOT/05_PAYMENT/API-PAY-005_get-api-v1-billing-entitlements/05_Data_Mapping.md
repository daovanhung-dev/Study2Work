...
format: "markdown"
dd_id: "API-PAY-005"
api_name: "GET /api/v1/billing/entitlements"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | số dư/cấp quyền/hết hạn | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chủ sở hữu/thành viên lập hóa đơn tổ chức.
...
- Endpoint input contract: Trang/loại/trạng thái → số dư/cấp quyền/hết hạn.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn chủ thể/tổ chức/trạng thái/hết hạn; số dư suy ra từ sổ cái
