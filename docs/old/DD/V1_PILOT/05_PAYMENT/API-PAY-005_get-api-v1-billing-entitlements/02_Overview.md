...
| Purpose | số dư/cấp quyền/hết hạn |
| Consumer/Actor | Chủ sở hữu/thành viên lập hóa đơn tổ chức |
| Authentication | Chủ sở hữu/thành viên lập hóa đơn tổ chức |
| Authorization | Chủ sở hữu/thành viên lập hóa đơn tổ chức |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L379` — endpoint contract.
