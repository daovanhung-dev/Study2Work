...
| Purpose | lượt thử mới |
| Consumer/Actor | Chủ sở hữu/thành viên lập hóa đơn |
| Authentication | Chủ sở hữu/thành viên lập hóa đơn |
| Authorization | Chủ sở hữu/thành viên lập hóa đơn |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L378` — endpoint contract.
