...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/billing/orders/{orderId}/retry` |
...
| ---: | --- | --- | --- |
| 1 | Nhà cung cấp tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Nhà cung cấp tùy chọn → lượt thử mới
