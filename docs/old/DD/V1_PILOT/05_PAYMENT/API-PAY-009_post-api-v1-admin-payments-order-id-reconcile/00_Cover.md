...
| API ID | `API-PAY-009` |
| API name | `POST /api/v1/admin/payments/{orderId}/reconcile` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/admin/payments/{orderId}/reconcile` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L383`.
