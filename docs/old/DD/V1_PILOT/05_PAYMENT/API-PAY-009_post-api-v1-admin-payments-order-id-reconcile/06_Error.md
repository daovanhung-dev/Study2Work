...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PROVIDER_EVIDENCE_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PROVIDER_EVIDENCE_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L383` |
| 2 | Endpoint business/error code | DIRECT | `ORDER_ALREADY_FINAL` | As specified by API catalog. | `SOURCE_REQUIRED` | `ORDER_ALREADY_FINAL` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L383` |
