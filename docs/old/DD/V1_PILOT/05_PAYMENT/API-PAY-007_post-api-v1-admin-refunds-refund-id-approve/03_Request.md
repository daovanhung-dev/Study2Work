...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/refunds/{refundId}/approve` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `refundId` | `refundId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Số tiền/lý do/ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Số tiền/lý do/`If-Match` → hoàn tiền đang xử lý
