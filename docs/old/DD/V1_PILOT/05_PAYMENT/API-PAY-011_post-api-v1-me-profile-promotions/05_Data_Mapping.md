...
format: "markdown"
dd_id: "API-PAY-011"
api_name: "POST /api/v1/me/profile-promotions"
...
| Bản xem trước hồ sơ đã xuất bản, kỳ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | quảng bá hồ sơ tài trợ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Ứng viên đã cho phép + quyền sử dụng.
...
- Endpoint input contract: Bản xem trước hồ sơ đã xuất bản, kỳ → quảng bá hồ sơ tài trợ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Yêu cầu đồng ý tìm kiếm đang hoạt động; giữ tín dụng; dừng/gỡ chỉ mục ngay khi từ chối đồng ý

- Operations/observability contract: Khóa lặp; kiểm toán/đồng ý
