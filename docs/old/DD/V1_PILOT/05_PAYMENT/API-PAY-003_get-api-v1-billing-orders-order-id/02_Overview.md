...
| Module | `Payment` |
| Method | `GET` |
| Endpoint | `/api/v1/billing/orders/{orderId}` |
| Purpose | trạng thái đơn hàng/nhà cung cấp/thanh toán/quyền sử dụng/hoàn tiền |
| Consumer/Actor | Người mua hoặc thành viên tài chính tổ chức |
| Authentication | Người mua hoặc thành viên tài chính tổ chức |
| Authorization | Người mua hoặc thành viên tài chính tổ chức |
...
| Side effects | Riêng tư, không lưu |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L377` — endpoint contract.
