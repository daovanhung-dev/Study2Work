...
format: "markdown"
dd_id: "API-PAY-003"
api_name: "GET /api/v1/billing/orders/{orderId}"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | trạng thái đơn hàng/nhà cung cấp/thanh toán/quyền sử dụng/hoàn tiền | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người mua hoặc thành viên tài chính tổ chức.
...
- Endpoint input contract: → trạng thái đơn hàng/nhà cung cấp/thanh toán/quyền sử dụng/hoàn tiền.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện ghép chủ sở hữu/tổ chức; đọc bản chiếu được dựng từ sổ cái/webhook
