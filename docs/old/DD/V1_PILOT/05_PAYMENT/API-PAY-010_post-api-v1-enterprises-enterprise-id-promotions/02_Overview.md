...
| Purpose | quảng bá |
| Consumer/Actor | `PERM-WRK-060` + quyền sử dụng |
| Authentication | `PERM-WRK-060` + quyền sử dụng |
| Authorization | `PERM-WRK-060` + quyền sử dụng |
...
| Side effects | Khóa lặp; kiểm toán/sự kiện |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L384` — endpoint contract.
