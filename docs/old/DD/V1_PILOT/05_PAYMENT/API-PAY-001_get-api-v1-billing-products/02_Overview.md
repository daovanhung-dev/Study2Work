...
| Purpose | sản phẩm/giá/quyền lợi còn hiệu lực |
| Consumer/Actor | Đã xác thực |
| Authentication | Đã xác thực |
...
| Side effects | Bộ nhớ đệm 5 phút, ETag |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L375` — endpoint contract.
