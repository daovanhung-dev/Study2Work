...
format: "markdown"
dd_id: "API-PAY-001"
api_name: "GET /api/v1/billing/products"
...
| Đối tượng / | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | sản phẩm/giá/quyền lợi còn hiệu lực | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Đối tượng `CANDIDATE`/`ENTERPRISE` → sản phẩm/giá/quyền lợi còn hiệu lực.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc danh mục có phiên bản; giá doanh nghiệp vẫn là số nguyên VND

- Operations/observability contract: Bộ nhớ đệm 5 phút, ETag
