...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `EXPORT_SCOPE_DENIED` | As specified by API catalog. | `SOURCE_REQUIRED` | `EXPORT_SCOPE_DENIED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L429` |
| 2 | Endpoint business/error code | DIRECT | `EXPORT_TOO_LARGE` | As specified by API catalog. | `SOURCE_REQUIRED` | `EXPORT_TOO_LARGE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L429` |
