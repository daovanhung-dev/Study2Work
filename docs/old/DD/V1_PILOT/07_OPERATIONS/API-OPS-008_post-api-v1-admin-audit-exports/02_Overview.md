...
| Module | `Operations` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/audit-exports` |
| Purpose | xuất mã hóa bất đồng bộ |
| Consumer/Actor | Quyền xuất + xác minh tăng cường |
| Authentication | Quyền xuất + xác minh tăng cường |
| Authorization | Quyền xuất + xác minh tăng cường |
...
| Side effects | Khóa lặp; kiểm toán xuất bất biến |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L429` — endpoint contract.
