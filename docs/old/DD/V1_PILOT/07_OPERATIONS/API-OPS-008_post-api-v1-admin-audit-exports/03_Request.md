...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/audit-exports` |
...
| ---: | --- | --- | --- |
| 1 | Cùng bộ lọc, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Cùng bộ lọc, lý do → xuất mã hóa bất đồng bộ
