...
format: "markdown"
dd_id: "API-OPS-002"
api_name: "POST /api/v1/admin/verification-cases/{id}/decisions"
...
| Chấp thuận/từ chối/yêu cầu thông tin, lý do/danh sách kiểm | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | quyết định | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-OPS-001`, không phải người nộp.
...
- Endpoint input contract: Chấp thuận/từ chối/yêu cầu thông tin, lý do/danh sách kiểm, `If-Match` → quyết định.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa hồ sơ/tổ chức; thêm quyết định, cập nhật bản chiếu xác minh tổ chức; không xóa tài liệu
