...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/verification-cases/{id}/decisions` |
...
| ---: | --- | --- | --- |
| 1 | Chấp thuận/từ chối/yêu cầu thông tin, lý do/danh sách kiểm | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Chấp thuận/từ chối/yêu cầu thông tin, lý do/danh sách kiểm, `If-Match` → quyết định
