...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/admin/verification-cases` |
...
| ---: | --- | --- | --- |
| 1 | Trang/loại/trạng thái/tuổi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/loại/trạng thái/tuổi → hồ sơ doanh nghiệp/trường đại học
