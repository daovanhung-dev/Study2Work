...
| Module | `Operations` |
| Method | `GET` |
| Endpoint | `/api/v1/admin/verification-cases` |
| Purpose | hồ sơ doanh nghiệp/trường đại học |
| Consumer/Actor | `PERM-OPS-001` + MFA |
| Authentication | `PERM-OPS-001` + MFA |
| Authorization | `PERM-OPS-001` + MFA |
...
| Side effects | Không lưu đệm; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L422` — endpoint contract.
