...
| Module | `Operations` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/trusted-publisher-grants/{id}/revoke` |
| Purpose | đã thu hồi |
| Consumer/Actor | `PERM-OPS-003` + MFA |
| Authentication | `PERM-OPS-003` + MFA |
| Authorization | `PERM-OPS-003` + MFA |
...
| Side effects | Khóa lặp; cảnh báo/sự kiện |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L427` — endpoint contract.
