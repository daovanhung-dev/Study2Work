...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/admin/operational-reports` |
...
| ---: | --- | --- | --- |
| 1 | Mã báo cáo/ngày/bộ lọc | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Mã báo cáo/ngày/bộ lọc → chỉ số tổng hợp + độ mới
