...
format: "markdown"
dd_id: "API-OPS-010"
api_name: "GET /api/v1/admin/operational-reports"
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `REPORT_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `REPORT_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L431` |
| 2 | Endpoint business/error code | DIRECT | `DATA_NOT_FRESH` | As specified by API catalog. | `SOURCE_REQUIRED` | `DATA_NOT_FRESH` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L431` |
