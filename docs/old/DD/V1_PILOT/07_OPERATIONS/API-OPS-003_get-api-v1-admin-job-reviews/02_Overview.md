...
| Module | `Operations` |
| Method | `GET` |
| Endpoint | `/api/v1/admin/job-reviews` |
| Purpose | hàng đợi duyệt việc làm |
| Consumer/Actor | `PERM-OPS-002` |
| Authentication | `PERM-OPS-002` |
| Authorization | `PERM-OPS-002` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L424` — endpoint contract.
