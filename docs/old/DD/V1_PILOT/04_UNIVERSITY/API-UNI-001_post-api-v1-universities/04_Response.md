...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | tổ chức `PENDING_VERIFICATION` + tư cách thành viên chủ sở hữu | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> tổ chức `PENDING_VERIFICATION` + tư cách thành viên chủ sở hữu
...
{
  "success": false,
  "businessCode": "UNIVERSITY_DUPLICATE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
