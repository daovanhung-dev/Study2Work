...
| Purpose | tổ chức `PENDING_VERIFICATION` + tư cách thành viên chủ sở hữu |
| Consumer/Actor | Đại diện đã xác thực |
| Authentication | Đại diện đã xác thực |
| Authorization | Đại diện đã xác thực |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L345` — endpoint contract.
