...
| ---: | --- | --- | --- |
| 1 | Thông tin pháp lý/hồ sơ/liên hệ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Thông tin pháp lý/hồ sơ/liên hệ → tổ chức `PENDING_VERIFICATION` + tư cách thành viên chủ sở hữu
