...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CONSENT_REQUIRED` | As specified by API catalog. | `403` | `CONSENT_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L358` |
| 2 | Endpoint business/error code | DIRECT | `JOB_NOT_ACCEPTING_APPLICATIONS` | As specified by API catalog. | `SOURCE_REQUIRED` | `JOB_NOT_ACCEPTING_APPLICATIONS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L358` |
