...
format: "markdown"
dd_id: "API-UNI-012"
api_name: "POST /api/v1/universities/{universityId}/partnerships"
...
| ID doanh nghiệp, phạm vi, ngày tháng | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | quan hệ đối tác `PROPOSED` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-022`.
...
- Endpoint input contract: ID doanh nghiệp, phạm vi, ngày tháng → quan hệ đối tác `PROPOSED`.

<a id="s04"></a>
### S04. Execute source-defined processing

> Tạo yêu cầu hai bên; chưa chia sẻ dữ liệu cho đến khi doanh nghiệp chấp nhận; mục đích/phạm vi chính xác

- Operations/observability contract: Xử lý lặp an toàn; kiểm toán/thông báo
