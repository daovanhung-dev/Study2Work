...
format: "markdown"
dd_id: "API-UNI-002"
api_name: "POST /api/v1/universities/{universityId}/verification-submissions"
...
| Dữ liệu pháp lý + tài liệu | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-UNI-001`.
...
- Endpoint input contract: Dữ liệu pháp lý + tài liệu `CLEAN` → hồ sơ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện tổ chức; ảnh chụp nộp bất biến; hộp thư đi người duyệt
