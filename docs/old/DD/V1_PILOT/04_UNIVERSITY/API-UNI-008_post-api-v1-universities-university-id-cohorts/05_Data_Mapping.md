...
format: "markdown"
dd_id: "API-UNI-008"
api_name: "POST /api/v1/universities/{universityId}/cohorts"
...
| Tên, mã, ngày tháng, tiêu chí | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | nhóm | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Tên, mã, ngày tháng, tiêu chí → nhóm.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX duy nhất tổ chức+mã; thành viên qua ID liên kết rõ ràng/ảnh chụp tiêu chí
