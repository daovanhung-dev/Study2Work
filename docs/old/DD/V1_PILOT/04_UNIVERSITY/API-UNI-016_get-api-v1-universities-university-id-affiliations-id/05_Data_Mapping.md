...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | trạng thái người học thuộc danh sách cho phép cho mục đích đã chấp thuận | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-031` + đồng ý cụ thể đang hoạt động.
...
- Endpoint input contract: → trạng thái người học thuộc danh sách cho phép cho mục đích đã chấp thuận.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện tổ chức/liên kết + mục đích/hết hạn đồng ý; tối thiểu hóa trường; không bao giờ gồm minh chứng Study/CV/trò chuyện

- Operations/observability contract: Mọi truy cập được kiểm toán riêng tư; không lưu
