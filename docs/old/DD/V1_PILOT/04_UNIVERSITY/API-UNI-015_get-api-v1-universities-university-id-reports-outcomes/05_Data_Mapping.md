...
format: "markdown"
dd_id: "API-UNI-015"
api_name: "GET /api/v1/universities/{universityId}/reports/outcomes"
...
| Ngày/nhóm/chương trình/chiều dữ liệu | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | chỉ số tổng hợp | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-030`.
...
- Endpoint input contract: Ngày/nhóm/chương trình/chiều dữ liệu → chỉ số tổng hợp.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn chỉ số hằng ngày/dữ kiện ẩn danh đã đồng ý theo tổ chức; ẩn nhóm `<10`; không có đơn ứng tuyển/trò chuyện/minh chứng gốc

- Operations/observability contract: Riêng tư; kiểm toán truy vấn; xuất bất đồng bộ
