...
| Purpose | đã rút |
| Consumer/Actor | Người học đã liên kết + xác minh tăng cường |
| Authentication | Người học đã liên kết + xác minh tăng cường |
| Authorization | Người học đã liên kết + xác minh tăng cường |
...
| Side effects | Khóa lặp; sự kiện/kiểm toán riêng tư |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L351` — endpoint contract.
