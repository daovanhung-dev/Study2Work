...
| ---: | --- |
| HTTP method | `DELETE` |
| URI | `/api/v1/me/university-affiliations/{affiliationId}/consent` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `affiliationId` | `affiliationId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Mục đích/tất cả, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Mục đích/tất cả, lý do → đã rút
