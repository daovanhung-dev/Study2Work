...
| Purpose | trạng thái |
| Consumer/Actor | Doanh nghiệp `PERM-WRK-050` |
| Authentication | Doanh nghiệp `PERM-WRK-050` |
| Authorization | Doanh nghiệp `PERM-WRK-050` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L357` — endpoint contract.
