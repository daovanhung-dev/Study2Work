...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/university-partnerships/{id}/respond` |
...
| ---: | --- | --- | --- |
| 1 | Chấp thuận/từ chối, phạm vi/phiên bản | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Chấp thuận/từ chối, phạm vi/phiên bản → trạng thái
