...
format: "markdown"
dd_id: "API-UNI-013"
api_name: "POST /api/v1/enterprises/{enterpriseId}/university-partnerships/{id}/respond"
...
| Chấp thuận/từ chối, phạm vi/phiên bản | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Doanh nghiệp `PERM-WRK-050`.
...
- Endpoint input contract: Chấp thuận/từ chối, phạm vi/phiên bản → trạng thái.

<a id="s04"></a>
### S04. Execute source-defined processing

> Giao dịch Work CSDL xuyên loại tổ chức vì hai loại cùng ở Work DB; kiểm tư cách thành viên riêng; thêm lịch sử
