...
| Purpose | chương trình `DRAFT` |
| Consumer/Actor | `PERM-UNI-020` |
| Authentication | `PERM-UNI-020` |
| Authorization | `PERM-UNI-020` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L354` — endpoint contract.
