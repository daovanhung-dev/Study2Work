...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/university-affiliations/{invitationId}/accept` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `invitationId` | `invitationId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Phiên bản/mục đích sự đồng ý/thời hạn <=12 tháng | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phiên bản/mục đích sự đồng ý/thời hạn <=12 tháng → liên kết `VERIFIED`
