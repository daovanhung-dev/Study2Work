...
| API ID | `API-UNI-006` |
| API name | `POST /api/v1/me/university-affiliations/{invitationId}/accept` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/me/university-affiliations/{invitationId}/accept` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L350`.
