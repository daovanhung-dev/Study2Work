...
| Purpose | liên kết `VERIFIED` |
| Consumer/Actor | Ứng viên/người học được mời |
| Authentication | Ứng viên/người học được mời |
| Authorization | Ứng viên/người học được mời |
...
| Side effects | Xử lý lặp an toàn; kiểm toán riêng tư |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L350` — endpoint contract.
