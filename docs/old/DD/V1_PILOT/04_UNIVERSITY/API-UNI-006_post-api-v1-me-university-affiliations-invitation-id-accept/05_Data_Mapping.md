...
format: "markdown"
dd_id: "API-UNI-006"
api_name: "POST /api/v1/me/university-affiliations/{invitationId}/accept"
...
| `invitationId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Phiên bản/mục đích sự đồng ý/thời hạn <=12 tháng | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | liên kết `VERIFIED` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Ứng viên/người học được mời.
...
- Endpoint input contract: Phiên bản/mục đích sự đồng ý/thời hạn <=12 tháng → liên kết `VERIFIED`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX xác minh danh tính/chứng minh email/lời mời; thêm sự đồng ý và liên kết; mặc định không cấp dữ liệu cá nhân ngoài danh tính

- Operations/observability contract: Xử lý lặp an toàn; kiểm toán riêng tư
