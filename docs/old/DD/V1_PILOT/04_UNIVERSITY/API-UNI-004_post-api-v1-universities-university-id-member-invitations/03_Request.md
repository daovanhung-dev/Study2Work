...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/member-invitations` |
...
| ---: | --- | --- | --- |
| 1 | Email, vai trò, hết hạn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Email, vai trò, hết hạn → lời mời
