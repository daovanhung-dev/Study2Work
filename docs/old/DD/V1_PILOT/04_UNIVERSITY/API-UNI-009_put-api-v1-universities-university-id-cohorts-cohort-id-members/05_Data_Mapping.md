...
| `cohortId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Thêm/xóa ID liên kết | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | số lượng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-011`.
...
- Endpoint input contract: Thêm/xóa ID liên kết, `If-Match` → số lượng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện ghép tổ chức; chỉ liên kết đang hoạt động; thêm lịch sử thành viên
