...
format: "markdown"
dd_id: "API-UNI-011"
api_name: "POST /api/v1/universities/{universityId}/campus-job-distributions"
...
| ID việc làm đã xuất bản, nhóm, kỳ, thông điệp | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phân phối | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-021`.
...
- Endpoint input contract: ID việc làm đã xuất bản, nhóm, kỳ, thông điệp → phân phối.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm việc làm công khai/đang nhận đơn và nhóm tổ chức; tạo tổng hợp phân phối/người nhận; không tự ứng tuyển

- Operations/observability contract: Khóa lặp; hộp thư đi thông báo
