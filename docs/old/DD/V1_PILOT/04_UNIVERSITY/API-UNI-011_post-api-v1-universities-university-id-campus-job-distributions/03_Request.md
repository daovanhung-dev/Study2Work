...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/campus-job-distributions` |
...
| ---: | --- | --- | --- |
| 1 | ID việc làm đã xuất bản, nhóm, kỳ, thông điệp | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID việc làm đã xuất bản, nhóm, kỳ, thông điệp → phân phối
