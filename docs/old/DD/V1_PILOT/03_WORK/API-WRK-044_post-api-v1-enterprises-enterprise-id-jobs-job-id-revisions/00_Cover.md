...
| API ID | `API-WRK-044` |
| API name | `POST /api/v1/enterprises/{enterpriseId}/jobs/{jobId}/revisions` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/revisions` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L305`.
