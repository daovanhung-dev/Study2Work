...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/revisions` |
...
| ---: | --- | --- | --- |
| 1 | ID bản sửa đổi gốc/ghi chú thay đổi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID bản sửa đổi gốc/ghi chú thay đổi → bản sửa đổi `DRAFT`
