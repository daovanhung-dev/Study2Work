...
format: "markdown"
dd_id: "API-WRK-044"
api_name: "POST /api/v1/enterprises/{enterpriseId}/jobs/{jobId}/revisions"
...
| ID bản sửa đổi gốc/ghi chú thay đổi | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản sửa đổi `DRAFT` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: ID bản sửa đổi gốc/ghi chú thay đổi → bản sửa đổi `DRAFT`.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện tổ chức; sao chép bản sửa đổi bất biến; chính sách chỉ cho một bản nháp có thể sửa/việc làm/thành viên
