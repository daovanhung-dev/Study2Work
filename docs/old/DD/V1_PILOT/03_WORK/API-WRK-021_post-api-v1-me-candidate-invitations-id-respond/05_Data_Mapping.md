...
format: "markdown"
dd_id: "API-WRK-021"
api_name: "POST /api/v1/me/candidate-invitations/{id}/respond"
...
| /, lý do tùy chọn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lời mời; chấp thuận chỉ trả URL ứng tuyển | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người được mời.
...
- Endpoint input contract: `ACCEPTED`/`DECLINED`, lý do tùy chọn → lời mời; chấp thuận chỉ trả URL ứng tuyển.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX chuyển trạng thái lời mời; `ACCEPTED` không tạo đơn ứng tuyển/cuộc trò chuyện
