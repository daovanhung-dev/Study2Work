...
| API ID | `API-WRK-021` |
| API name | `POST /api/v1/me/candidate-invitations/{id}/respond` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/me/candidate-invitations/{id}/respond` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L254`.
