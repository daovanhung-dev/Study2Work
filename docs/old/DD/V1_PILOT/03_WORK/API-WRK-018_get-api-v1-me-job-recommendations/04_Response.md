...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | gợi ý tự nhiên có giải thích + tài trợ gắn nhãn riêng | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> gợi ý tự nhiên có giải thích + tài trợ gắn nhãn riêng
...
{
  "success": false,
  "businessCode": "PROFILE_MINIMUM_REQUIRED",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
