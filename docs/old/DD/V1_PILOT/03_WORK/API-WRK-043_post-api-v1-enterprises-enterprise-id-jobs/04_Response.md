...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | việc làm ổn định + bản sửa đổi `DRAFT` | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> việc làm ổn định + bản sửa đổi `DRAFT`
...
{
  "success": false,
  "businessCode": "ENTERPRISE_NOT_VERIFIED",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
