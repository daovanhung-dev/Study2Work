...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/review-submissions` |
...
| ---: | --- | --- | --- |
| 1 | Bản sửa đổi/phiên bản, tuyên bố, quyền | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Bản sửa đổi/phiên bản, tuyên bố, quyền → `REVIEW_PENDING`
