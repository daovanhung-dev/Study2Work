...
| Consumer/Actor | `PERM-WRK-012` |
| Authentication | `PERM-WRK-012` |
| Authorization | `PERM-WRK-012` |
...
| Side effects | Khóa lặp; hộp thư đi người duyệt/kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L307` — endpoint contract.
