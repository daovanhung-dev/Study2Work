...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CV_QUOTA_EXCEEDED` | As specified by API catalog. | `SOURCE_REQUIRED` | `CV_QUOTA_EXCEEDED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L242` |
| 2 | Endpoint business/error code | DIRECT | `TEMPLATE_ENTITLEMENT_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `TEMPLATE_ENTITLEMENT_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L242` |
