...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | hồ sơ, độ hoàn thiện, trạng thái/phiên bản riêng tư/tìm kiếm | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> hồ sơ, độ hoàn thiện, trạng thái/phiên bản riêng tư/tìm kiếm
