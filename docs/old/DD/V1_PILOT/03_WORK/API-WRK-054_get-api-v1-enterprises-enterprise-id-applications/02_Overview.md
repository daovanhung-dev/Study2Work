...
| Purpose | hàng ATS |
| Consumer/Actor | `PERM-WRK-030` |
| Authentication | `PERM-WRK-030` |
| Authorization | `PERM-WRK-030` |
...
| Side effects | Riêng tư; xuất dữ liệu cần quyền riêng |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L322` — endpoint contract.
