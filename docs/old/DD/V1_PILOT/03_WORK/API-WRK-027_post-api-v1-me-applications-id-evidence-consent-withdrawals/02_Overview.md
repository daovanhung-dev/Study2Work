...
| Purpose | thời điểm ẩn |
| Consumer/Actor | Chủ sở hữu + xác minh tăng cường |
| Authentication | Chủ sở hữu + xác minh tăng cường |
| Authorization | Chủ sở hữu + xác minh tăng cường |
...
| Side effects | Khóa lặp; kiểm toán/sự kiện riêng tư |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L265` — endpoint contract.
