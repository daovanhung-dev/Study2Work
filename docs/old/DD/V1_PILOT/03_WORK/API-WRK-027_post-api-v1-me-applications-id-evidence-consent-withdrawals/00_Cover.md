...
| API ID | `API-WRK-027` |
| API name | `POST /api/v1/me/applications/{id}/evidence-consent-withdrawals` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/me/applications/{id}/evidence-consent-withdrawals` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L265`.
