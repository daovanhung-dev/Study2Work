...
| ---: | --- |
| HTTP method | `PATCH` |
| URI | `/api/v1/me/cvs/{cvId}/revisions/{revisionId}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `cvId` | `cvId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
| 2 | `revisionId` | `revisionId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Các phần đã định kiểu | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Các phần đã định kiểu, `If-Match` → bản sửa đổi nháp
