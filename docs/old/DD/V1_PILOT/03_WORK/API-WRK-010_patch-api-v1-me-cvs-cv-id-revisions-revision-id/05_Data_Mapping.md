...
format: "markdown"
dd_id: "API-WRK-010"
api_name: "PATCH /api/v1/me/cvs/{cvId}/revisions/{revisionId}"
...
| `cvId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| `revisionId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Các phần đã định kiểu | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản sửa đổi nháp | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Các phần đã định kiểu, `If-Match` → bản sửa đổi nháp.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa bản nháp; yêu cầu `DRAFT`/chủ sở hữu; làm sạch lược đồ/ngày tháng/văn bản; tăng phiên bản

- Operations/observability contract: Tự lưu, khóa lặp tùy chọn; riêng tư, không lưu
