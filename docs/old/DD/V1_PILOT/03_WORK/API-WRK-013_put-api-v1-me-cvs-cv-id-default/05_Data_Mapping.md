...
format: "markdown"
dd_id: "API-WRK-013"
api_name: "PUT /api/v1/me/cvs/{cvId}/default"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | CV mặc định | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → CV mặc định.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa ứng viên; kiểm CV đã xuất bản thuộc chủ sở hữu; xóa/đặt một bản mặc định theo ràng buộc duy nhất
