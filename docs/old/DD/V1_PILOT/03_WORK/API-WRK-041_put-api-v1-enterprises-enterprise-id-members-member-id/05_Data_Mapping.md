...
format: "markdown"
dd_id: "API-WRK-041"
api_name: "PUT /api/v1/enterprises/{enterpriseId}/members/{memberId}"
...
| `memberId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Vai trò/trạng thái, , lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tư cách thành viên | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-004` + MFA.
...
- Endpoint input contract: Vai trò/trạng thái, `If-Match`, lý do → tư cách thành viên.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa tổ chức/thành viên; chặn xóa chủ sở hữu cuối cùng và tự nâng quyền
