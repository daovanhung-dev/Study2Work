...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/enterprises/{enterpriseId}/members/{memberId}` |
...
| 2 | `memberId` | `memberId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Vai trò/trạng thái, , lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Vai trò/trạng thái, `If-Match`, lý do → tư cách thành viên
