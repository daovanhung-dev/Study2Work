...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/interviews/{id}/reschedules` |
...
| ---: | --- | --- | --- |
| 1 | hiện hành, khung giờ/lý do mới | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> `scheduleVersion` hiện hành, khung giờ/lý do mới → phiên bản lịch bất biến mới
