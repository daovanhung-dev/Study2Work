...
format: "markdown"
dd_id: "API-WRK-016"
api_name: "PATCH /api/v1/me/portfolio-items/{id}"
...
| Trường | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Trường, `If-Match` → mục.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX điều kiện chủ sở hữu/ID; kiểm dữ liệu; tăng phiên bản

- Operations/observability contract: Khóa lặp tùy chọn; kiểm toán
