...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/publish` |
...
| ---: | --- | --- | --- |
| 1 | Bản sửa đổi, ID duyệt/cấp | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Bản sửa đổi, ID duyệt/cấp, `If-Match` → `PUBLISHED`
