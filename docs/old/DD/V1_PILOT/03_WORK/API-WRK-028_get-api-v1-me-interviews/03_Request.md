...
| ---: | --- | --- | --- |
| 1 | Trang/sắp tới/trạng thái | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/sắp tới/trạng thái → phỏng vấn/phiên bản lịch hiện hành
