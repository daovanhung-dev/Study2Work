...
format: "markdown"
dd_id: "API-WRK-028"
api_name: "GET /api/v1/me/interviews"
...
| Trang/sắp tới/trạng thái | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phỏng vấn/phiên bản lịch hiện hành | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/sắp tới/trạng thái → phỏng vấn/phiên bản lịch hiện hành.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn ứng viên/thời gian bắt đầu/trạng thái; gồm siêu dữ liệu liên kết tải ICS
