...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `ENTERPRISE_DUPLICATE` | As specified by API catalog. | `SOURCE_REQUIRED` | `ENTERPRISE_DUPLICATE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L291` |
| 2 | Endpoint business/error code | DIRECT | `LEGAL_INFO_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `LEGAL_INFO_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L291` |
