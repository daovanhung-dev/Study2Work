...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/me/candidate-search-consent` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `enabled` | `enabled` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | DIRECT physical key; source does not lock complete type/location validation. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | thời hạn tùy chọn, danh sách trường hiển thị cho phép, phiên bản chính sách | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> `enabled`, thời hạn tùy chọn, danh sách trường hiển thị cho phép, phiên bản chính sách, `If-Match` → trạng thái
