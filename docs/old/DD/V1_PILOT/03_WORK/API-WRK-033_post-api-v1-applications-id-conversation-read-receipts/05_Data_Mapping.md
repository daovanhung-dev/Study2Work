...
format: "markdown"
dd_id: "API-WRK-033"
api_name: "POST /api/v1/applications/{id}/conversation/read-receipts"
...
| Trình tự đã đọc cuối | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | biên nhận | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người tham gia.
...
- Endpoint input contract: Trình tự đã đọc cuối → biên nhận.

<a id="s04"></a>
### S04. Execute source-defined processing

> Cập nhật chèn giá trị lớn nhất đơn điệu theo người tham gia; từ chối trình tự vượt cuộc hội thoại

- Operations/observability contract: Lặp an toàn; sự kiện biên nhận WebSocket
