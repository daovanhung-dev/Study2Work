...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/applications/{id}/conversation/read-receipts` |
...
| ---: | --- | --- | --- |
| 1 | Trình tự đã đọc cuối | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trình tự đã đọc cuối → biên nhận
