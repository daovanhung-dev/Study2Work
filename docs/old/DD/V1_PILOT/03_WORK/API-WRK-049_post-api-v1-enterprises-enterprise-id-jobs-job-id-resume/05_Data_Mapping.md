...
format: "markdown"
dd_id: "API-WRK-049"
api_name: "POST /api/v1/enterprises/{enterpriseId}/jobs/{jobId}/resume"
...
- Endpoint input contract: `If-Match` → `PUBLISHED`.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm lại hết hạn/chính sách/quyền sử dụng/bản sửa đổi hiện hành dưới khóa

- Operations/observability contract: Khóa lặp; kiểm toán/chỉ mục
