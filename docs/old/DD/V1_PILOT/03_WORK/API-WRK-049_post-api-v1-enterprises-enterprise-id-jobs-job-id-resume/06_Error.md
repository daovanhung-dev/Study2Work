...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `JOB_EXPIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `JOB_EXPIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L310` |
| 2 | Endpoint business/error code | DIRECT | `JOB_POLICY_FAILED` | As specified by API catalog. | `SOURCE_REQUIRED` | `JOB_POLICY_FAILED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L310` |
