...
| Module | `Work` |
| Method | `POST` |
| Endpoint | `/api/v1/applications/{id}/conversation/messages` |
| Purpose | tin nhắn/trình tự được chấp nhận |
| Consumer/Actor | Ứng viên chủ sở hữu hoặc nhà tuyển dụng đang được phân công |
| Authentication | Ứng viên chủ sở hữu hoặc nhà tuyển dụng đang được phân công |
| Authorization | Ứng viên chủ sở hữu hoặc nhà tuyển dụng đang được phân công |
...
| Side effects | Khóa lặp bắt buộc; xác nhận SLO <=2 giây; kiểm toán siêu dữ liệu kiểm duyệt; 30/phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L270` — endpoint contract.
