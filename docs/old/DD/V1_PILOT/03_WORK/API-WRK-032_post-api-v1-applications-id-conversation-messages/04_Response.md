...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | tin nhắn/trình tự được chấp nhận | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> tin nhắn/trình tự được chấp nhận
...
{
  "success": false,
  "businessCode": "CONVERSATION_READ_ONLY",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
