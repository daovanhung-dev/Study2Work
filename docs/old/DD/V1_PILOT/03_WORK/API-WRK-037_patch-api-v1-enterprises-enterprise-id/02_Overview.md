...
| Purpose | hồ sơ |
| Consumer/Actor | `PERM-WRK-001` |
| Authentication | `PERM-WRK-001` |
| Authorization | `PERM-WRK-001` |
...
| Side effects | Khóa lặp; kiểm toán trước/sau |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L293` — endpoint contract.
