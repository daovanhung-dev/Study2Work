...
format: "markdown"
dd_id: "API-WRK-055"
api_name: "GET /api/v1/enterprises/{enterpriseId}/applications/{applicationId}"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | ảnh chụp bất biến, câu trả lời, lịch sử, trạng thái minh chứng, phỏng vấn/trò chuyện; chỉ có liên hệ sau khi ứng tuyển | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Nhà tuyển dụng được phân công hoặc `PERM-WRK-031`.
...
- Endpoint input contract: → ảnh chụp bất biến, câu trả lời, lịch sử, trạng thái minh chứng, phỏng vấn/trò chuyện; chỉ có liên hệ sau khi ứng tuyển.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện tổ chức; quyền theo trường; thân minh chứng chỉ `READY` và chưa ẩn/thu hồi

- Operations/observability contract: Kiểm toán truy cập PII; không lưu
