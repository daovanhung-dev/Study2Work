...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | điều kiện đủ, câu hỏi, bản sửa đổi hiện hành, CV mặc định, trạng thái tích hợp minh chứng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → điều kiện đủ, câu hỏi, bản sửa đổi hiện hành, CV mặc định, trạng thái tích hợp minh chứng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc bản sửa đổi việc làm đã xuất bản, tính duy nhất của đơn có sẵn, ứng viên/CV; không gọi Study
