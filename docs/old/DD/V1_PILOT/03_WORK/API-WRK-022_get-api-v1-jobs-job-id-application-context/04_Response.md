...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | điều kiện đủ, câu hỏi, bản sửa đổi hiện hành, CV mặc định, trạng thái tích hợp minh chứng | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
{
  "success": false,
  "businessCode": "JOB_NOT_ACCEPTING_APPLICATIONS",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
