...
| API ID | `API-WRK-022` |
| API name | `GET /api/v1/jobs/{jobId}/application-context` |
| HTTP method | `GET` |
| Endpoint | `/api/v1/jobs/{jobId}/application-context` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L260`.
