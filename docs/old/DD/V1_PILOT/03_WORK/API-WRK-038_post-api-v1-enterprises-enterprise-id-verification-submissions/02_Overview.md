...
| Purpose | hồ sơ `SUBMITTED` |
| Consumer/Actor | `PERM-WRK-002` |
| Authentication | `PERM-WRK-002` |
| Authorization | `PERM-WRK-002` |
...
| Side effects | Xử lý lặp an toàn; hàng đợi người duyệt/kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L294` — endpoint contract.
