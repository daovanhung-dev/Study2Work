...
| Purpose | lịch sử và bản ghi che theo thứ tự |
| Consumer/Actor | Ứng viên chủ sở hữu hoặc nhà tuyển dụng được phân công |
| Authentication | Ứng viên chủ sở hữu hoặc nhà tuyển dụng được phân công |
| Authorization | Ứng viên chủ sở hữu hoặc nhà tuyển dụng được phân công |
...
| Side effects | Riêng tư, không lưu; dùng con trỏ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L269` — endpoint contract.
