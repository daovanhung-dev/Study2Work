...
| Module | `Work` |
| Method | `GET` |
| Endpoint | `/api/v1/jobs/{jobSlug}` |
| Purpose | bản sửa đổi đã xuất bản, doanh nghiệp, thời hạn, nhãn tài trợ |
| Consumer/Actor | Công khai |
| Authentication | Công khai |
| Authorization | Công khai |
...
| Side effects | CDN 60 giây; khử trùng lặp lượt xem theo hàm băm người dùng/IP/ngày |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L230` — endpoint contract.
...
- [OQ-WRK-PUBLIC-JOB-SLUG](../../OPEN_QUESTIONS.md#oq-wrk-public-job-slug).
