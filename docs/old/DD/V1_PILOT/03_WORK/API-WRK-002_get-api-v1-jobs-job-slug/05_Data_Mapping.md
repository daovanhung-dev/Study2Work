...
format: "markdown"
dd_id: "API-WRK-002"
api_name: "GET /api/v1/jobs/{jobSlug}"
...
| `jobSlug` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản sửa đổi đã xuất bản, doanh nghiệp, thời hạn, nhãn tài trợ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Slug → bản sửa đổi đã xuất bản, doanh nghiệp, thời hạn, nhãn tài trợ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Slug/phiên bản hiện hành duy nhất; tăng lượt xem bằng sự kiện khử trùng lặp bất đồng bộ, không ghi trong TX đọc

- Operations/observability contract: CDN 60 giây; khử trùng lặp lượt xem theo hàm băm người dùng/IP/ngày
