...
| ---: | --- |
| HTTP method | `PATCH` |
| URI | `/api/v1/enterprises/{enterpriseId}/jobs/{jobId}/revisions/{revisionId}` |
...
| 2 | Optimistic-concurrency version | If-Match | Yes | Quoted version | DIRECT endpoint/global convention. | [S03](./05_Data_Mapping.md#s03) |
...
| 2 | `jobId` | `jobId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
| 3 | `revisionId` | `revisionId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | JD có cấu trúc, kỹ năng, lương, địa điểm, câu hỏi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> JD có cấu trúc, kỹ năng, lương, địa điểm, câu hỏi, `If-Match` → bản nháp
