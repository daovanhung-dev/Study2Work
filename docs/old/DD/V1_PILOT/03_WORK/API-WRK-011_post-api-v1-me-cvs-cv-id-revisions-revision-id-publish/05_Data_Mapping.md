...
format: "markdown"
dd_id: "API-WRK-011"
api_name: "POST /api/v1/me/cvs/{cvId}/revisions/{revisionId}/publish"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản sửa đổi `PUBLISHED` bất biến | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: `If-Match` → bản sửa đổi `PUBLISHED` bất biến.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm trường bắt buộc; xuất bản, thay thế bản hiện hành trước đó; chỉ cập nhật xem trước tìm kiếm khi có đồng ý rõ ràng

- Operations/observability contract: Khóa lặp bắt buộc; kiểm toán/sự kiện
