...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `INTERVIEW_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `INTERVIEW_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L268` |
| 2 | Endpoint business/error code | DIRECT | `ICS_LINK_EXPIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `ICS_LINK_EXPIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L268` |
