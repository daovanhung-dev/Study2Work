...
| Module | `Work` |
| Method | `GET` |
| Endpoint | `/api/v1/interviews/{id}/calendar.ics` |
| Purpose | tệp lịch ICS hiện hành |
| Consumer/Actor | Người tham gia phỏng vấn; cho phép liên kết có chữ ký dùng một lần |
| Authentication | Người tham gia phỏng vấn; cho phép liên kết có chữ ký dùng một lần |
| Authorization | Người tham gia phỏng vấn; cho phép liên kết có chữ ký dùng một lần |
...
| Side effects | Riêng tư, không lưu; kiểm toán truy cập |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L268` — endpoint contract.
