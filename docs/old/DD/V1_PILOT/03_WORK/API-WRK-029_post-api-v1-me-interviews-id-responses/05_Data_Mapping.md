...
format: "markdown"
dd_id: "API-WRK-029"
api_name: "POST /api/v1/me/interviews/{id}/responses"
...
| Phiên bản lịch; xác nhận, từ chối hoặc yêu cầu đổi lịch; khung giờ thay thế/lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Phiên bản lịch; xác nhận, từ chối hoặc yêu cầu đổi lịch; khung giờ thay thế/lý do → phỏng vấn.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa phỏng vấn; dùng đúng `scheduleVersion`; kiểm thời gian tương lai/múi giờ; thêm sự kiện; yêu cầu đổi lịch không thay đổi lịch cho đến khi nhà tuyển dụng chấp nhận
