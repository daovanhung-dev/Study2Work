...
| Purpose | việc làm/bản sửa đổi hiện hành |
| Consumer/Actor | `PERM-WRK-010` |
| Authentication | `PERM-WRK-010` |
| Authorization | `PERM-WRK-010` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L303` — endpoint contract.
