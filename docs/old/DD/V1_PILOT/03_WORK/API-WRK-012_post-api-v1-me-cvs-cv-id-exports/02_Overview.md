...
| Module | `Work` |
| Method | `POST` |
| Endpoint | `/api/v1/me/cvs/{cvId}/exports` |
| Purpose | tác vụ xuất bất đồng bộ |
| Consumer/Actor | Chủ sở hữu + quyền sử dụng nếu gói cao cấp |
| Authentication | Chủ sở hữu + quyền sử dụng nếu gói cao cấp |
| Authorization | Chủ sở hữu + quyền sử dụng nếu gói cao cấp |
...
| Side effects | Khóa lặp; 10/giờ; sự kiện hoàn tất/hoàn lại giữ chỗ khi lỗi |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L245` — endpoint contract.
