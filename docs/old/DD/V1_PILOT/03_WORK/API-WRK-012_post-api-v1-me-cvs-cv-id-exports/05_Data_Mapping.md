...
format: "markdown"
dd_id: "API-WRK-012"
api_name: "POST /api/v1/me/cvs/{cvId}/exports"
...
| Định dạng PDF, phiên bản mẫu | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tác vụ xuất bất đồng bộ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chủ sở hữu + quyền sử dụng nếu gói cao cấp.
...
- Endpoint input contract: Định dạng PDF, phiên bản mẫu → tác vụ xuất bất đồng bộ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chụp bản sửa đổi CV bất biến + mẫu; trừ giữ chỗ quyền sử dụng nguyên tử nếu có phí; đưa tác vụ dựng qua hộp thư đi

- Operations/observability contract: Khóa lặp; 10/giờ; sự kiện hoàn tất/hoàn lại giữ chỗ khi lỗi
