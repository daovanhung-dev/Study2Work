...
format: "markdown"
dd_id: "API-WRK-006"
api_name: "PATCH /api/v1/me/candidate-profile"
...
| Trường hồ sơ thuộc danh sách cho phép, kỹ năng, kinh nghiệm, học vấn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trường hồ sơ thuộc danh sách cho phép, kỹ năng, kinh nghiệm, học vấn, `If-Match` → hồ sơ.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa hồ sơ; kiểm ngày tháng/danh mục; làm sạch văn bản giàu định dạng; thay các mục lồng nhau bằng ID con ổn định; tăng phiên bản

- Operations/observability contract: Khóa lặp tùy chọn; kiểm toán PII; chỉ lập chỉ mục tìm kiếm lại khi đã tham gia
