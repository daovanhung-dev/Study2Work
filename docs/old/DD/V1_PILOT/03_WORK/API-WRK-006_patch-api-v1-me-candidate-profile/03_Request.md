...
| ---: | --- |
| HTTP method | `PATCH` |
| URI | `/api/v1/me/candidate-profile` |
...
| ---: | --- | --- | --- |
| 1 | Trường hồ sơ thuộc danh sách cho phép, kỹ năng, kinh nghiệm, học vấn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trường hồ sơ thuộc danh sách cho phép, kỹ năng, kinh nghiệm, học vấn, `If-Match` → hồ sơ
