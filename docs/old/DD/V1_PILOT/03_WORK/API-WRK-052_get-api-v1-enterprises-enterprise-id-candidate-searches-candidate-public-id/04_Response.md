...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | hồ sơ công khai/bản xem trước hồ sơ năng lực đã che dữ liệu | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> hồ sơ công khai/bản xem trước hồ sơ năng lực đã che dữ liệu
...
{
  "success": false,
  "businessCode": "CANDIDATE_NOT_FOUND",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
