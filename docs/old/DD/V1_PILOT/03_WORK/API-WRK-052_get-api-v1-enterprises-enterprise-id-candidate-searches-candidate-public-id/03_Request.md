...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/enterprises/{enterpriseId}/candidate-searches/{candidatePublicId}` |
...
| 2 | `candidatePublicId` | `candidatePublicId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
