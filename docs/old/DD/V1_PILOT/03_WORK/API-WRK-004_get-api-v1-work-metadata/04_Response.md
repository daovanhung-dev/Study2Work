...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | kỹ năng, ngành, địa điểm, hình thức làm việc/tuyển dụng | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> kỹ năng, ngành, địa điểm, hình thức làm việc/tuyển dụng
...
{
  "success": false,
  "businessCode": "METADATA_GROUP_INVALID",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
