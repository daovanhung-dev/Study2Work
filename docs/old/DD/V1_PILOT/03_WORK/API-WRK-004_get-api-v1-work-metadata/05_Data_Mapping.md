...
format: "markdown"
dd_id: "API-WRK-004"
api_name: "GET /api/v1/work-metadata"
...
| Nhóm tùy chọn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | kỹ năng, ngành, địa điểm, hình thức làm việc/tuyển dụng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Nhóm tùy chọn → kỹ năng, ngành, địa điểm, hình thức làm việc/tuyển dụng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc danh mục/bản chiếu chuẩn đang hoạt động

- Operations/observability contract: Bộ nhớ đệm 10 phút, ETag
