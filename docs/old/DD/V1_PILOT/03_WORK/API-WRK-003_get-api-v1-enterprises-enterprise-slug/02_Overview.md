...
| Purpose | hồ sơ nhà tuyển dụng công khai đã xác minh + việc làm đã xuất bản |
...
| Side effects | CDN 5 phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L231` — endpoint contract.
