...
format: "markdown"
dd_id: "API-WRK-056"
api_name: "PUT /api/v1/enterprises/{enterpriseId}/applications/{applicationId}/assignees"
...
| ID thành viên đang hoạt động | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phân công | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-032`.
...
- Endpoint input contract: ID thành viên đang hoạt động, `If-Match` → phân công.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa đơn ứng tuyển; mọi người được phân công cùng tổ chức và có vai trò nhà tuyển dụng; ít nhất một người chính để trò chuyện nhà tuyển dụng có thể ghi

- Operations/observability contract: Khóa lặp; kiểm toán/sự kiện
