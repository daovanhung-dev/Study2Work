...
| ---: | --- |
| HTTP method | `DELETE` |
| URI | `/api/v1/applications/{id}/conversation/messages/{messageId}` |
...
| 2 | `messageId` | `messageId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
