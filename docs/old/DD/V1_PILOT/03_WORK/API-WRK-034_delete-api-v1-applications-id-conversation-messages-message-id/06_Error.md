...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `MESSAGE_DELETE_WINDOW_EXPIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `MESSAGE_DELETE_WINDOW_EXPIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L272` |
| 2 | Endpoint business/error code | DIRECT | `MESSAGE_NOT_OWNED` | As specified by API catalog. | `SOURCE_REQUIRED` | `MESSAGE_NOT_OWNED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L272` |
