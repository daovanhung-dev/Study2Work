...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/jobs/{jobId}/applications` |
...
| ---: | --- | --- | --- |
| 1 | ID bản sửa đổi việc làm, bản sửa đổi CV đã xuất bản, thư giới thiệu <=5000, câu trả lời, ID+phiên bản minh chứng Study đã chọn, văn bản/chính sách đồng ý, ID hồ sơ năng lực | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID bản sửa đổi việc làm, bản sửa đổi CV đã xuất bản, thư giới thiệu <=5000, câu trả lời, ID+phiên bản minh chứng Study đã chọn, văn bản/chính sách đồng ý, ID hồ sơ năng lực → đơn ứng tuyển
