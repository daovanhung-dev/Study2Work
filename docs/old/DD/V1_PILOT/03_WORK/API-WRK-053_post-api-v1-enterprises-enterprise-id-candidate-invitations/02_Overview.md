...
| Purpose | lời mời |
| Consumer/Actor | `PERM-WRK-021` |
| Authentication | `PERM-WRK-021` |
| Authorization | `PERM-WRK-021` |
...
| Side effects | Khóa lặp; trừ quyền sử dụng lời mời; thông báo/kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L321` — endpoint contract.
