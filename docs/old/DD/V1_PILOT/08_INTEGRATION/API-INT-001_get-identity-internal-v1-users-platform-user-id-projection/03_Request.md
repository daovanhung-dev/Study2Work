...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/internal/v1/users/{platformUserId}/projection` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `platformUserId` | `platformUserId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Chủ thể + phiên bản đã biết tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Chủ thể + phiên bản đã biết tùy chọn → trạng thái/`authVersion`/vai trò/hàm băm email/phiên bản tối thiểu
