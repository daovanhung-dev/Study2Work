...
| API ID | `API-INT-008` |
| API name | `POST work /internal/v1/ai-provider-callbacks/{provider}` |
| HTTP method | `POST` |
| Endpoint | `/internal/v1/ai-provider-callbacks/{provider}` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L446`.
