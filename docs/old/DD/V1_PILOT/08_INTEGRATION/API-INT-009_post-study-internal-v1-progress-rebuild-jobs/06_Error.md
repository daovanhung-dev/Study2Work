...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `REBUILD_SCOPE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `REBUILD_SCOPE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L447` |
