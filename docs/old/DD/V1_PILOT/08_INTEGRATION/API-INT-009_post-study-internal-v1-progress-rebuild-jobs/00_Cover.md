...
| API ID | `API-INT-009` |
| API name | `POST study /internal/v1/progress-rebuild-jobs` |
| HTTP method | `POST` |
| Endpoint | `/internal/v1/progress-rebuild-jobs` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L447`.
