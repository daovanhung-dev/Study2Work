...
format: "markdown"
dd_id: "API-INT-009"
api_name: "POST study /internal/v1/progress-rebuild-jobs"
...
| ID người học/đích/lý do/kiểm toán nguồn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tác vụ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chỉ tiến trình nền/dịch vụ quản trị Study.
...
- Endpoint input contract: ID người học/đích/lý do/kiểm toán nguồn → tác vụ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Không truy cập người học; khử trùng lặp tác vụ; dựng lại ảnh chụp từ dữ kiện, thêm chênh lệch/kiểm toán; không viết lại dữ kiện
