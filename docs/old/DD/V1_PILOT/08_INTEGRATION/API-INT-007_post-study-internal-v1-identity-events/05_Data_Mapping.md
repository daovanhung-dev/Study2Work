...
format: "markdown"
dd_id: "API-INT-007"
api_name: "POST study /internal/v1/identity-events"
...
| Như trên | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Như trên.

<a id="s04"></a>
### S04. Execute source-defined processing

> Cùng bản chiếu đơn điệu; không bao giờ tạo thông tin xác thực
