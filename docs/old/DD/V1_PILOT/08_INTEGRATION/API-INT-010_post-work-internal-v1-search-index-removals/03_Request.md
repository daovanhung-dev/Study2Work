...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/internal/v1/search-index-removals` |
...
| ---: | --- | --- | --- |
| 1 | ID ứng viên/ID sự kiện đồng ý/hạn chót | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID ứng viên/ID sự kiện đồng ý/hạn chót → kết quả
