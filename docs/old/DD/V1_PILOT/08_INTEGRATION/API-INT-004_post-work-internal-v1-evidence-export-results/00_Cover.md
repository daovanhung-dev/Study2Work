...
| API ID | `API-INT-004` |
| API name | `POST work /internal/v1/evidence-export-results` |
| HTTP method | `POST` |
| Endpoint | `/internal/v1/evidence-export-results` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L442`.
