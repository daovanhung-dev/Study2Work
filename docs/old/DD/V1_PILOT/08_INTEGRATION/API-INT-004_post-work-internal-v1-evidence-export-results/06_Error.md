...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `RESULT_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `RESULT_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L442` |
| 2 | Endpoint business/error code | DIRECT | `APPLICATION_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `APPLICATION_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L442` |
| 3 | Endpoint business/error code | DIRECT | `SIGNATURE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `SIGNATURE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L442` |
