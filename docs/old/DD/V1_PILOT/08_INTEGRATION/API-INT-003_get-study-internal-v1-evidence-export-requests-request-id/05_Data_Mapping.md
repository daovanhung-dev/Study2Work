...
| `requestId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | chỉ trạng thái xử lý yêu cầu | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Work.
...
- Endpoint input contract: → chỉ trạng thái xử lý yêu cầu.

<a id="s04"></a>
### S04. Execute source-defined processing

> Liên kết bên gọi/yêu cầu; đối soát dự phòng, không thăm dò nhanh hơn 30 giây
