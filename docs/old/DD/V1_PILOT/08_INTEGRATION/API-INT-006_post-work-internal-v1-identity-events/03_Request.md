...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/internal/v1/identity-events` |
...
| ---: | --- | --- | --- |
| 1 | Lô CloudEvents đã ký <=100 | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Lô CloudEvents đã ký <=100
