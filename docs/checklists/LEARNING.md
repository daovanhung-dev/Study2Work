...
|---|---|---|---|---|---|
| `LEARNING-F01` | Feature | `NOT_STARTED` | `2026-07-01` | `docs/DD/LEARNING/` | Placement/baseline intake and path assignment. |
| `LEARNING-F02` | Feature | `NOT_STARTED` | `2026-07-01` | `docs/DD/LEARNING/` | Learning path, stage, module, lesson content. |
...
| ID | Status | Updated | Link | Evidence |
|---|---|---|---|---|
| `LEARNING-TEST-STATUS` | `NOT_STARTED` | `2026-07-01` | `tests/` | No test command or test evidence yet. |
