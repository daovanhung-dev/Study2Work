...
Do not add removed non-Study APIs here unless a separate approved BD/DD expands scope.
...
| `LEARN-BOOKMARK-001` | LEARNING | PUT | `/api/v1/lessons/{lessonId}/bookmark` | Student | Toggle or upsert a lesson bookmark idempotently. | Enforce bookmark uniqueness `(user_id, lesson_id)` and enrollment visibility. | `bookmark`; idempotent write. | `02_activity/06_Tien_do_bookmark_comment_live.puml`, `04_sequence/07_Bookmark_Comment_Live.puml` | `DRAFT` | 80% |
| `LEARN-COMMENT-001` | LEARNING | POST | `/api/v1/lessons/{lessonId}/comments` | Student/Mentor | Create a lesson discussion comment. | Comment owner, lesson visibility, moderation status and safe content validation. | `lesson_comment`, `audit_log`; may publish moderation/notification event. | `02_activity/06_Tien_do_bookmark_comment_live.puml`, `04_sequence/07_Bookmark_Comment_Live.puml` | `DRAFT` | 80% |
| `LEARN-LIVE-001` | LEARNING | GET | `/api/v1/live-sessions` | Student/Mentor | List live sessions within learner or mentor scope. | Enrollment/scope filtering, pagination, visibility of meeting URL. | `live_session`, `learning_path_enrollment`; read-only. | `02_activity/06_Tien_do_bookmark_comment_live.puml`, `04_sequence/07_Bookmark_Comment_Live.puml` | `DRAFT` | 80% |
...
| `PROJECT-SPRINT-001` | PROJECT | POST | `/api/v1/projects/{projectId}/sprints` | Student/Mentor | Create a sprint within a project/team scope. | Project/team scope, sprint date/status policy and audit. | `sprint`, `audit_log`. | `02_activity/12_Sprint_task_worklog.puml`, `04_sequence/14_Sprint_Task.puml` | `DRAFT` | 80% |
| `PROJECT-TASK-001` | PROJECT | POST | `/api/v1/projects/{projectId}/tasks` | Student/Mentor | Create a project task within project/sprint boundary. | Enforce `BR-PROJECT-003`; assignee/team scope and sprint boundary. | `task`, `audit_log`; may publish `TaskAssigned`. | `02_activity/12_Sprint_task_worklog.puml`, `04_sequence/14_Sprint_Task.puml` | `DRAFT` | 80% |
...
| `ADMIN-CONTENT-001` | ADMIN | POST | `/api/v1/admin/learning-paths` | Admin | Create or modify the learning content tree. | Enforce `BR-ADMIN-001`; content publish state, audit, no student access to draft content. | `learning_path`, `module`, `lesson`, `audit_log`; publish `LearningContentPublished` if applicable. | `02_activity/16_Admin_content_rubric_publish.puml`, `04_sequence/19_Admin_Content_Rubric.puml` | `DRAFT` | 80% |
| `ADMIN-RUBRIC-001` | ADMIN | POST | `/api/v1/admin/rubrics` | Admin | Create, version or publish a rubric. | Rubric versioning, criterion completeness, weights, publish audit. | `rubric`, `rubric_criterion`, `audit_log`. | `02_activity/16_Admin_content_rubric_publish.puml`, `04_sequence/19_Admin_Content_Rubric.puml` | `DRAFT` | 80% |
| `ADMIN-MENTOR-001` | ADMIN | PATCH | `/api/v1/admin/mentors/{mentorId}/scope` | Admin | Assign mentor scope for learner/team/project review access. | Enforce `BR-ADMIN-001`, mentor scope boundaries and audit. | `mentor_profile`, `audit_log`; affects mentor authorization scope. | `02_activity/15_Admin_user_mentor_scope.puml`, `04_sequence/20_Admin_Mentor_Scope.puml` | `DRAFT` | 80% |

## 5.1 Canonical API DD Evidence

| API | DD path | Status | Completion | Worklog | Open questions |
|---|---|---|---:|---|---|
| `AUTH-REGISTER-001` | `docs/api-dd/auth/auth-register-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AUTH-REGISTER-001-OQ-001 |
| `AUTH-LOGIN-001` | `docs/api-dd/auth/auth-login-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AUTH-LOGIN-001-OQ-001 |
| `AUTH-VERIFY-001` | `docs/api-dd/auth/auth-verify-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AUTH-VERIFY-001-OQ-001 |
| `AUTH-OAUTH-001` | `docs/api-dd/auth/auth-oauth-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AUTH-OAUTH-001-OQ-001, AUTH-OAUTH-001-OQ-002 |
| `AUTH-REFRESH-001` | `docs/api-dd/auth/auth-refresh-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AUTH-REFRESH-001-OQ-001 |
| `AUTH-LOGOUT-001` | `docs/api-dd/auth/auth-logout-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AUTH-LOGOUT-001-OQ-001 |
| `USER-PROFILE-001` | `docs/api-dd/user/user-profile-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | USER-PROFILE-001-OQ-001 |
| `USER-PROFILE-002` | `docs/api-dd/user/user-profile-002/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | USER-PROFILE-002-OQ-001 |
| `USER-SKILL-001` | `docs/api-dd/user/user-skill-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | USER-SKILL-001-OQ-001 |
| `LEARN-PATH-001` | `docs/api-dd/learn/learn-path-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-PATH-001-OQ-001 |
| `LEARN-PATH-002` | `docs/api-dd/learn/learn-path-002/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-PATH-002-OQ-001 |
| `LEARN-PLACEMENT-001` | `docs/api-dd/learn/learn-placement-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-PLACEMENT-001-OQ-001, LEARN-PLACEMENT-001-OQ-003 |
| `LEARN-LESSON-001` | `docs/api-dd/learn/learn-lesson-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-LESSON-001-OQ-001 |
| `LEARN-PROGRESS-001` | `docs/api-dd/learn/learn-progress-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-PROGRESS-001-OQ-001 |
| `LEARN-BOOKMARK-001` | `docs/api-dd/learn/learn-bookmark-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-BOOKMARK-001-OQ-001 |
| `LEARN-COMMENT-001` | `docs/api-dd/learn/learn-comment-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-COMMENT-001-OQ-001, LEARN-COMMENT-001-OQ-003 |
| `LEARN-LIVE-001` | `docs/api-dd/learn/learn-live-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-LIVE-001-OQ-001 |
| `LEARN-QUIZ-001` | `docs/api-dd/assess/learn-quiz-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | LEARN-QUIZ-001-OQ-001 |
| `ASSESS-SUBMISSION-001` | `docs/api-dd/assess/assess-submission-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | ASSESS-SUBMISSION-001-OQ-001 |
| `ASSESS-GRADE-001` | `docs/api-dd/assess/assess-grade-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | ASSESS-GRADE-001-OQ-001 |
| `MENTOR-REVIEW-001` | `docs/api-dd/mentor/mentor-review-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | MENTOR-REVIEW-001-OQ-001 |
| `MENTOR-REVIEW-002` | `docs/api-dd/mentor/mentor-review-002/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | MENTOR-REVIEW-002-OQ-001 |
| `SKILL-MATRIX-001` | `docs/api-dd/assess/skill-matrix-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | SKILL-MATRIX-001-OQ-001 |
| `PROJECT-TEAM-001` | `docs/api-dd/project/project-team-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-TEAM-001-OQ-001 |
| `PROJECT-TEAM-002` | `docs/api-dd/project/project-team-002/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-TEAM-002-OQ-001 |
| `PROJECT-SPRINT-001` | `docs/api-dd/project/project-sprint-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-SPRINT-001-OQ-001 |
| `PROJECT-TASK-001` | `docs/api-dd/project/project-task-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-TASK-001-OQ-001, PROJECT-TASK-001-OQ-003 |
| `PROJECT-TASK-002` | `docs/api-dd/project/project-task-002/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-TASK-002-OQ-001 |
| `PROJECT-PR-001` | `docs/api-dd/project/project-pr-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-PR-001-OQ-001 |
| `PROJECT-SUBMIT-001` | `docs/api-dd/project/project-submit-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | PROJECT-SUBMIT-001-OQ-001 |
| `AI-ROADMAP-001` | `docs/api-dd/ai/ai-roadmap-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AI-ROADMAP-001-OQ-001 |
| `AI-CODE-001` | `docs/api-dd/ai/ai-code-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | AI-CODE-001-OQ-001 |
| `ADMIN-CONTENT-001` | `docs/api-dd/admin/admin-content-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | ADMIN-CONTENT-001-OQ-001, ADMIN-CONTENT-001-OQ-003 |
| `ADMIN-RUBRIC-001` | `docs/api-dd/admin/admin-rubric-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | ADMIN-RUBRIC-001-OQ-001 |
| `ADMIN-MENTOR-001` | `docs/api-dd/admin/admin-mentor-001/` | `DRAFT` | 80% | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` | ADMIN-MENTOR-001-OQ-001 |
