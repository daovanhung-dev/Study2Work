...
|---|---|---|---|---|---|
| `ASSESSMENT-F01` | Feature | `NOT_STARTED` | `2026-07-01` | `docs/DD/ASSESSMENT/` | Quiz attempts and scoring snapshots. |
| `ASSESSMENT-F02` | Feature | `NOT_STARTED` | `2026-07-01` | `docs/DD/ASSESSMENT/` | Assignment/lab/code submissions and versioning. |
| `ASSESSMENT-F03` | Feature | `NOT_STARTED` | `2026-07-01` | `docs/DD/ASSESSMENT/` | Auto grading and safe result persistence. |
...
| ID | Status | Updated | Link | Evidence |
|---|---|---|---|---|
| `ASSESSMENT-TEST-STATUS` | `NOT_STARTED` | `2026-07-01` | `tests/` | No test command or test evidence yet. |
