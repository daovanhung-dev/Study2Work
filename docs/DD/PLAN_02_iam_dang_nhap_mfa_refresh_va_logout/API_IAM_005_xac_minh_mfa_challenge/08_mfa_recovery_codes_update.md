---
title: "mfa_recovery_codes UPDATE"
order: 8
...
- `Recovery-code success branch.`

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `consumed_at` | `consumed_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
