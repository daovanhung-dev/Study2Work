...
| 5 | `actor_id` | `actor_id` | `uuid NULL` | `N/A` | `N/A` | `N` | `` | `Authenticated actor ID hoặc NULL` | `Authenticated actor ID hoặc NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
...
| 13 | `expires_at` | `expires_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Retention from API/global policy` | `Retention from API/global policy` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
