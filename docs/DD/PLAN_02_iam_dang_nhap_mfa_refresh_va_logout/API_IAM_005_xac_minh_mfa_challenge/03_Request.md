...
|---|---|
| HTTP method | `POST` |
| URI | `/api/v1/auth/mfa/challenges/{challengeId}/verify` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | MFA challenge ID | `challengeId` | `uuid` | `Yes` | `N/A` | `N/A` | `UUID v7` | `N/A` | `N/A` | Challenge thuộc user đang xác minh. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Mã TOTP hoặc recovery code | `SOURCE_REQUIRED` | `string` | `Yes` | `N/A` | `N/A` | `Unicode/JSON` | `TOTP 6 số hoặc recovery code` | `N/A` | `N/A` | Tên field vật lý chưa được contract định nghĩa. [SOURCE_REQUIRED] | `05_Data_Mapping.md#1-validate-data-input` |
