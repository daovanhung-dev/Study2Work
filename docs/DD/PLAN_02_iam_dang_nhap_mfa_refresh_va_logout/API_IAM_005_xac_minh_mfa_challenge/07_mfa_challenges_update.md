...
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `attempt_count` | `attempt_count` | `integer NOT NULL DEFAULT 0` | `N/A` | `N/A` | `Y` | `` | `Increment on invalid code` | `Increment on invalid code` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `verified_at` | `verified_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp on success` | `current_timestamp on success` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 3 | `invalidated_at` | `invalidated_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp when consumed/failed terminal` | `current_timestamp when consumed/failed terminal` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
