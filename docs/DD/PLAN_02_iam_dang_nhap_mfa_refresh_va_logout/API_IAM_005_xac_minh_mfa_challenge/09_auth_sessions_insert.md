...
| 5 | `user_id` | `user_id` | `uuid NOT NULL` | `N/A` | `N/A` | `Y` | `` | `mfa_challenges.user_id` | `mfa_challenges.user_id` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
...
| 7 | `session_epoch` | `session_epoch` | `bigint NOT NULL` | `N/A` | `N/A` | `Y` | `` | `SOURCE_REQUIRED — Q-01` | `SOURCE_REQUIRED — Q-01` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
