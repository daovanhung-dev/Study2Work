...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `STEP_UP_REQUIRED` | Branch `STEP_UP_REQUIRED` theo endpoint source | `403` | `STEP_UP_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
