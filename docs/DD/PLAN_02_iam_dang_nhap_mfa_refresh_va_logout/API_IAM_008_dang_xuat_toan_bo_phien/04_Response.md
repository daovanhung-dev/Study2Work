...
| 7 | `data.revokedSessionCount` | Số session bị thu hồi | `revokedSessionCount` | `integer` | `No` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Count affected rows | N/A | [DERIVED] |
