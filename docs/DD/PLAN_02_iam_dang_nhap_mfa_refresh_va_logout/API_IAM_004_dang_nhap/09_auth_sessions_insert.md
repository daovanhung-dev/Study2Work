...
- `Non-MFA branch or after MFA completion.`
...
| 6 | `status` | `status` | `session_status NOT NULL DEFAULT 'ACTIVE'` | `N/A` | `N/A` | `Y` | `` | `ACTIVE` | `ACTIVE` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 7 | `session_epoch` | `session_epoch` | `bigint NOT NULL` | `N/A` | `N/A` | `Y` | `` | `SOURCE_REQUIRED — relation with authVersion unresolved` | `SOURCE_REQUIRED — relation with authVersion unresolved` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 8 | `device_name` | `device_name` | `varchar(120) NULL` | `N/A` | `N/A` | `N` | `` | `request.deviceLabel when provided` | `request.deviceLabel when provided` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 9 | `last_seen_at` | `last_seen_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 10 | `expires_at` | `expires_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Session expiry policy` | `Session expiry policy` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 11 | `revoked_at` | `revoked_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `NULL` | `NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 12 | `revoke_reason` | `revoke_reason` | `varchar(100) NULL` | `N/A` | `N/A` | `N` | `` | `NULL` | `NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
