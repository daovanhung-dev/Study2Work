...
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `failed_count` | `failed_count` | `integer NOT NULL DEFAULT 0` | `N/A` | `N/A` | `Y` | `` | `Increment/reset according to password verification branch` | `Increment/reset according to password verification branch` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `locked_until` | `locked_until` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `Set by lock policy or NULL` | `Set by lock policy or NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
...
| 4 | `row_version` | `row_version` | `bigint NOT NULL DEFAULT 1` | `N/A` | `N/A` | `Y` | `` | `row_version + 1` | `row_version + 1` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
