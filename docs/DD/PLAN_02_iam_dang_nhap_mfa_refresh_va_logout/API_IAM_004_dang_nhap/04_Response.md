...
| 7 | `data.accessToken` | Access token | `accessToken` | `string` | `Yes` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Signed ES256 token | N/A | Exact field schema DERIVED. [DERIVED] |
| 8 | `data.refreshToken` | Refresh token | `refreshToken` | `string` | `Yes` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Opaque rotating token | N/A | Transport/location SOURCE_REQUIRED. [DERIVED] |
| 9 | `data.mfaChallengeId` | MFA challenge ID | `mfaChallengeId` | `string` | `Yes` | `mfa_challenges` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Nhánh privileged; exact response name SOURCE_REQUIRED. [DERIVED] |
...
```json
{
  ...
  "data": {
    "accessToken": "access-token-redacted",
    "refreshToken": "refresh-token-redacted",
    "mfaChallengeId": "0198a4c0-2d18-7a42-a82a-32f56e93bd11"
  },
  "meta": {},
