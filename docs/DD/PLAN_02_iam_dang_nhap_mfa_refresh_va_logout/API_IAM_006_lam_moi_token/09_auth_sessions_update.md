...
- `Reuse branch; all family sessions in scope.`

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `status` | `status` | `session_status NOT NULL DEFAULT 'ACTIVE'` | `N/A` | `N/A` | `Y` | `` | `COMPROMISED` | `COMPROMISED` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
...
| 3 | `revoke_reason` | `revoke_reason` | `varchar(100) NULL` | `N/A` | `N/A` | `N` | `` | `REFRESH_TOKEN_REUSE_DETECTED` | `REFRESH_TOKEN_REUSE_DETECTED` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
