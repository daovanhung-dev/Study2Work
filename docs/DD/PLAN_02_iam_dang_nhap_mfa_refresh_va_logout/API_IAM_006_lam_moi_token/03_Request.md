...
| 2 | Refresh credential | `SOURCE_REQUIRED` | `Yes` | `opaque token` | Contract cho phép refresh cookie/token nhưng chưa khóa location/field name. | `05_Data_Mapping.md#1-validate-data-input` |
