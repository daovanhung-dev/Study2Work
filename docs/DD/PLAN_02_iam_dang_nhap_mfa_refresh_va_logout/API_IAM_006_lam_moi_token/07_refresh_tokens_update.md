...
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `status` | `status` | `token_status NOT NULL DEFAULT 'ACTIVE'` | `N/A` | `N/A` | `Y` | `` | `CONSUMED or REVOKED by branch` | `CONSUMED or REVOKED by branch` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `rotated_to_id` | `rotated_to_id` | `uuid NULL` | `N/A` | `N/A` | `N` | `` | `New child token ID on success` | `New child token ID on success` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 3 | `consumed_at` | `consumed_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp on success` | `current_timestamp on success` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 4 | `reuse_detected_at` | `reuse_detected_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp on reuse` | `current_timestamp on reuse` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
