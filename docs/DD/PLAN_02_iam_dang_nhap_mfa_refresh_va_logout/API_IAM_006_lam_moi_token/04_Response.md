...
| 7 | `data.accessToken` | Access token | `accessToken` | `string` | `No` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Signed ES256 token | N/A | [DERIVED] |
| 8 | `data.refreshToken` | Refresh token | `refreshToken` | `string` | `No` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | New opaque child token | N/A | [DERIVED] |
...
{
  "success": false,
  "businessCode": "REFRESH_TOKEN_INVALID",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
