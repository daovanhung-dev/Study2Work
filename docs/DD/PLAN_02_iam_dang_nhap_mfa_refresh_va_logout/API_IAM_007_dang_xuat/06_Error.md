...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `TOKEN_INVALID` | Branch `TOKEN_INVALID` theo endpoint source | `401` | `TOKEN_INVALID` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
