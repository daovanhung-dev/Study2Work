...
| 2 | Access token | `Authorization` | `Yes` | `Bearer token` | Xác định current session. | `05_Data_Mapping.md#1-validate-data-input` |
| 3 | Current refresh credential | `SOURCE_REQUIRED` | `No` | `cookie/token` | Location chưa được khóa. | `05_Data_Mapping.md#1-validate-data-input` |
