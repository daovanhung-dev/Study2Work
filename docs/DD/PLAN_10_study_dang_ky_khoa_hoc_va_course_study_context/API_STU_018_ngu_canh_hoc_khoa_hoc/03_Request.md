...
|---|---|
| HTTP method | `GET` |
| URI | `/api/v1/courses/{courseId}/study` |
...
| No | Logical name | Physical name | Type | Required | Min | Max | Format | Valid values | Default | Description | Data Mapping reference |
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | Enrollment ID | `enrollmentId` | `uuid` | `No` | `N/A` | `N/A` | `UUID v7` | `N/A` | `N/A` | Dùng để disambiguate version. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
