...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `COURSE_NOT_ENROLLED` | Branch `COURSE_NOT_ENROLLED` theo endpoint source | `404` | `COURSE_NOT_ENROLLED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Business/Auth | `○` | `ENROLLMENT_VERSION_AMBIGUOUS` | Branch `ENROLLMENT_VERSION_AMBIGUOUS` theo endpoint source | `409` | `ENROLLMENT_VERSION_AMBIGUOUS` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
| 3 | Validation | `○` | `courseId` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `No` | Generic code chưa có endpoint catalog |
| 4 | System error | `-` | `database/dependency` | Lỗi hệ thống không ánh xạ được sang business error | `500` | `INTERNAL_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#42-loi-he-thong` | `No` | Không lộ chi tiết nội bộ |
