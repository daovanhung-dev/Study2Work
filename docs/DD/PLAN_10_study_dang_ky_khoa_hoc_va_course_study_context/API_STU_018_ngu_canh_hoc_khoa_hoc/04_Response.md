...
| 4 | `data` | Data | `data` | `object` | `Yes` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Object/array/null mapping | Theo endpoint | [DIRECT] |
...
| 7 | `data.enrollmentId` | Enrollment ID | `enrollmentId` | `string` | `No` | `course_enrollments` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.courseVersionId` | Pinned version | `courseVersionId` | `string` | `No` | `course_enrollments` | `course_version_id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.curriculum` | Pinned curriculum | `curriculum` | `array<object>` | `No` | `chapters` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] if none | [DERIVED] |
| 10 | `data.access` | Access context | `access` | `object` | `No` | `course_enrollments` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [SOURCE_REQUIRED] |
| 11 | `data.progress` | Progress | `progress` | `object` | `Yes` | `progress_snapshots` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [SOURCE_REQUIRED] |
...
```json
{
  ...
  "data": {
    "enrollmentId": "0198a4c0-2d18-7a42-a82a-32f56e93bd36",
    "courseVersionId": "0198a4c0-2d18-7a42-a82a-32f56e93bd37",
    "curriculum": [],
    "access": {},
    "progress": null
  },
...
{
  "success": false,
  "businessCode": "COURSE_NOT_ENROLLED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
