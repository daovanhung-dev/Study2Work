...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `INVALID_FILTER` | Branch `INVALID_FILTER` theo endpoint source | `400` | `INVALID_FILTER` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
