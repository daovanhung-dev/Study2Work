...
| Purpose | `Page/status/source → exact-version enrollments/progress` |
...
- Contract summary: R enrollment + course version + snapshot using`(user,status,updated_at)`; no substitution current version.
- Vận hành: Private.
