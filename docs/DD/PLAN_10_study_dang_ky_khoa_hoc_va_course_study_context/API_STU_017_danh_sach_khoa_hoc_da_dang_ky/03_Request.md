...
|---|---|
| HTTP method | `GET` |
| URI | `/api/v1/me/course-enrollments` |
...
| 3 | Enrollment status | `status` | `string` | `No` | `N/A` | `N/A` | `N/A` | `ENROLLED\|IN_PROGRESS\|COMPLETED` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 4 | Enrollment source | `source` | `string` | `No` | `N/A` | `N/A` | `N/A` | `STANDALONE\|PRIMARY_PATH\|ADMIN` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
