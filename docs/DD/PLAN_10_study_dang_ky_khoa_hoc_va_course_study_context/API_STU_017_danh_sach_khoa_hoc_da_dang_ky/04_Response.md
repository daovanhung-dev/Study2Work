...
| 9 | `data[].status` | Status | `status` | `string` | `No` | `course_enrollments` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 10 | `data[].source` | Source | `source` | `string` | `No` | `course_enrollments` | `source_type` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
