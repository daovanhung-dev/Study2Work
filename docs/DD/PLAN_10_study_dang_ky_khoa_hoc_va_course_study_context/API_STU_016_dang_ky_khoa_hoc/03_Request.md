...
|---|---|
| HTTP method | `POST` |
| URI | `/api/v1/courses/{courseId}/enrollments` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | Stable course ID | `courseId` | `uuid` | `Yes` | `N/A` | `N/A` | `UUID v7` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Explicit published version ID | `courseVersionId` | `uuid` | `No` | `N/A` | `N/A` | `Unicode/JSON` | `UUID v7` | `N/A` | `N/A` | Q-13: contract chưa chốt location. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Enrollment source | `source` | `string` | `No` | `N/A` | `N/A` | `Unicode/JSON` | `N/A` | `STANDALONE\|PRIMARY_PATH\|ADMIN` | `N/A` | Q-13: chưa chốt client gửi hay server resolve. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
...
```json
{
  "courseVersionId": "0198a4c0-2d18-7a42-a82a-32f56e93bd99",
  "source": "example"
}
```
