...
| 8 | `data.courseVersionId` | Pinned course version | `courseVersionId` | `string` | `No` | `course_enrollments` | `course_version_id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.status` | Enrollment status | `status` | `string` | `No` | `course_enrollments` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 10 | `data.source` | Enrollment source | `source` | `string` | `No` | `course_enrollments` | `source_type` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
...
```json
{
  ...
  "data": {
    "enrollmentId": "0198a4c0-2d18-7a42-a82a-32f56e93bd32",
    "courseVersionId": "0198a4c0-2d18-7a42-a82a-32f56e93bd33",
    "status": "ENROLLED",
    "source": "STANDALONE"
  },
  "meta": {},
...
{
  "success": false,
  "businessCode": "COURSE_NOT_PUBLISHED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
