...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `COURSE_NOT_PUBLISHED` | Branch `COURSE_NOT_PUBLISHED` theo endpoint source | `409` | `COURSE_NOT_PUBLISHED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Business/Auth | `○` | `ENROLLMENT_CONFLICT` | Branch `ENROLLMENT_CONFLICT` theo endpoint source | `409` | `ENROLLMENT_CONFLICT` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
| 3 | Validation | `○` | `courseId` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `Yes` | Generic code chưa có endpoint catalog |
