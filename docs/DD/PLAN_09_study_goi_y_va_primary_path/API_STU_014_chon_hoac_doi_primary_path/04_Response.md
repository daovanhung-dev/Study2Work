...
| 7 | `data.periodId` | New active period ID | `periodId` | `string` | `No` | `primary_path_periods` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.pathVersionId` | Path version ID | `pathVersionId` | `string` | `No` | `primary_path_periods` | `path_version_id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.nextSwitchAllowedAt` | Next switch allowed | `nextSwitchAllowedAt` | `string` | `No` | `primary_path_periods` | `started_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | +168h UTC | N/A | [DIRECT] |
...
```json
{
  ...
  "data": {
    "periodId": "0198a4c0-2d18-7a42-a82a-32f56e93bd28",
    "pathVersionId": "0198a4c0-2d18-7a42-a82a-32f56e93bd29",
    "nextSwitchAllowedAt": "2026-08-09T08:00:00Z"
  },
  "meta": {},
