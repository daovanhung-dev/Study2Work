...
|---|---|---|---|
| `study_db` | `principal/resource scope` | `Learner active + onboarding completed` | Không dùng frontend guard làm hàng rào bảo mật |
...
### 2.3. Query `TBL-STU-008 — path_recommendation_runs`

| Target table | Column get | Chú thích | Remarks |
|---|---|---|---|
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.id` | `id` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.learner_id` | `learner_id` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.onboarding_submission_id` | `onboarding_submission_id` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.algorithm_version` | `algorithm_version` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.ranked_path_version_ids` | `ranked_path_version_ids` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.reason_snapshot` | `reason_snapshot` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.generated_at` | `generated_at` | `DIRECT` |
| `path_recommendation_runs AS t_pathreco` | `t_pathreco.expires_at` | `expires_at` | `DIRECT` |

**WHERE / predicate cho `path_recommendation_runs`**
...
### 2.5. Query `TBL-STU-009 — learning_paths`
