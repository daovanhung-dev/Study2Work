...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `ONBOARDING_REQUIRED` | Branch `ONBOARDING_REQUIRED` theo endpoint source | `409` | `ONBOARDING_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
