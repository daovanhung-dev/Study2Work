...
| 7 | `data[].pathVersionId` | Path version ID | `pathVersionId` | `string` | `No` | `path_recommendation_runs` | `ranked_path_version_ids` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Expand ordered UUID array | N/A | [DERIVED] |
| 8 | `data[].scoreBand` | Score band | `scoreBand` | `string` | `No` | `path_recommendation_runs` | `reason_snapshot` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-10 schema not fixed. [SOURCE_REQUIRED] |
| 9 | `data[].reasons` | Reasons | `reasons` | `array<string>` | `No` | `path_recommendation_runs` | `reason_snapshot` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-10 schema not fixed. [SOURCE_REQUIRED] |
| 10 | `data[].stale` | Stale flag | `stale` | `boolean` | `No` | `learning_path_versions` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | True when recommended version no longer publishable/current per policy | N/A | [DERIVED] |
...
{
  "success": false,
  "businessCode": "ONBOARDING_REQUIRED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
