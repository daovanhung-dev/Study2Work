...
| 7 | `data[].periodId` | Period ID | `periodId` | `string` | `No` | `primary_path_periods` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
...
| 9 | `data[].startedAt` | Started at | `startedAt` | `string` | `No` | `primary_path_periods` | `started_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | ISO-8601 UTC | N/A | [DERIVED] |
| 10 | `data[].endedAt` | Ended at | `endedAt` | `string` | `Yes` | `primary_path_periods` | `ended_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | ISO-8601 UTC | N/A | [DIRECT] |
| 11 | `data[].endReason` | Change reason | `endReason` | `string` | `Yes` | `primary_path_periods` | `end_reason` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
