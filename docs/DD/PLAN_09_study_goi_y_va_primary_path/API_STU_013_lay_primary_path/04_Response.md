...
| 7 | `data.activePeriod` | Active period | `activePeriod` | `object` | `Yes` | `primary_path_periods` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | null when no active period | [DERIVED] |
| 8 | `data.pathVersionId` | Pinned path version | `pathVersionId` | `string` | `Yes` | `primary_path_periods` | `path_version_id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.progress` | Progress | `progress` | `object` | `Yes` | `progress_snapshots` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [SOURCE_REQUIRED] |
| 10 | `data.nextSwitchAllowedAt` | Next switch allowed | `nextSwitchAllowedAt` | `string` | `Yes` | `primary_path_periods` | `started_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | +168h UTC except rule exemptions | N/A | [DIRECT] |
