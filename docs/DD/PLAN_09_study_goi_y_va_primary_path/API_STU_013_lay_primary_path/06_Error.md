...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | System error | `-` | `database/dependency` | Lỗi hệ thống không ánh xạ được sang business error | `500` | `INTERNAL_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#42-loi-he-thong` | `No` | Không lộ chi tiết nội bộ |
