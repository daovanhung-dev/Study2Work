...
| 2 | Idempotency key | `Idempotency-Key` | `Yes` | `UUID/random` | DIRECT | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Reset token | `token` | `string` | `Yes` | `32` | `512` | `Unicode/JSON` | `opaque token` | `N/A` | `N/A` | Chỉ lưu hash. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Mật khẩu mới | `newPassword` | `string` | `Yes` | `12` | `128` | `Unicode/JSON` | `password` | `N/A` | `N/A` | Argon2id; history check còn Q-02. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
