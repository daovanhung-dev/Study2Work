...
### 2.1. Query `TBL-IAM-005 — password_reset_tokens`
...
### 2.3. Query `TBL-IAM-003 — password_credentials`
...
- `UPDATE password_credentials`: refer [08_password_credentials_update.md](./08_password_credentials_update.md).
...
- `UPDATE users`: refer [11_users_update.md](./11_users_update.md).
- `INSERT idempotency_keys`: refer [12_idempotency_keys_insert.md](./12_idempotency_keys_insert.md).
- `INSERT security_audit_events`: refer [13_security_audit_events_insert.md](./13_security_audit_events_insert.md).
- `INSERT outbox_events`: refer [14_outbox_events_insert.md](./14_outbox_events_insert.md).

### 3.4. Parameters

| Param | Giá trị | Remarks |
|---|---|---|
| `password_reset_tokens.status` | `CONSUMED` | `DIRECT` |
| `password_reset_tokens.consumed_at` | `current_timestamp` | `DIRECT` |
| `password_credentials.password_hash` | `Argon2id(request.newPassword)` | `DIRECT` |
| `password_credentials.algorithm` | `ARGON2ID` | `DIRECT` |
| `password_credentials.parameters` | `Approved Argon2id parameters JSON` | `DIRECT` |
...
| `auth_sessions.revoke_reason` | `PASSWORD_RESET` | `DIRECT` |
