...
| 3 | `parameters` | `parameters` | `jsonb NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Approved Argon2id parameters JSON` | `Approved Argon2id parameters JSON` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
