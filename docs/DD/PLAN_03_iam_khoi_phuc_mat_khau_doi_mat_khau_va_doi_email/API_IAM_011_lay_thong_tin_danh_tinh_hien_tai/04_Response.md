...
| 7 | `data.id` | User ID | `id` | `string` | `No` | `users` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 8 | `data.status` | Account status | `status` | `string` | `No` | `users` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 9 | `data.displayName` | Display name | `displayName` | `string` | `Yes` | `users` | `display_name` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 10 | `data.roles` | Global roles | `roles` | `array<string>` | `No` | `roles` | `code` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] nếu không có | [DERIVED] |
| 11 | `data.agreements` | Agreements | `agreements` | `array<object>` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] nếu không có | Q-03. [SOURCE_REQUIRED] |
...
```json
{
  ...
  "data": {
    "id": "0198a4c0-2d18-7a42-a82a-32f56e93bd12",
    "status": "ACTIVE",
...
{
  "success": false,
  "businessCode": "ACCOUNT_NOT_ACTIVE",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
