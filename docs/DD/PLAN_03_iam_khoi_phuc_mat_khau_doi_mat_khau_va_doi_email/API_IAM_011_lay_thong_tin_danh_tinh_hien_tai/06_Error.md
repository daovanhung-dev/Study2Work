...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `ACCOUNT_NOT_ACTIVE` | Branch `ACCOUNT_NOT_ACTIVE` theo endpoint source | `403` | `ACCOUNT_NOT_ACTIVE` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
