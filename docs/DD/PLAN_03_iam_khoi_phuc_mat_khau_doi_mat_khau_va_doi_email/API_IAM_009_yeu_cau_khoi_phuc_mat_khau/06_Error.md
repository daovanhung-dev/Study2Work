...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Validation | `○` | `email` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `Yes` | Generic code chưa có endpoint catalog |
| 2 | System error | `-` | `database/dependency` | Lỗi hệ thống không ánh xạ được sang business error | `500` | `INTERNAL_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#42-loi-he-thong` | `Yes` | Không lộ chi tiết nội bộ |
