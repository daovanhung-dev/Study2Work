...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Email | `email` | `string` | `Yes` | `3` | `320` | `Unicode/JSON` | `email` | `N/A` | `N/A` | Luôn trả accepted, không tiết lộ account tồn tại. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
