...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Mật khẩu hiện tại | `currentPassword` | `string` | `Yes` | `12` | `128` | `Unicode/JSON` | `password` | `N/A` | `N/A` | Tên vật lý suy dẫn từ contract. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Mật khẩu mới | `newPassword` | `string` | `Yes` | `12` | `128` | `Unicode/JSON` | `password` | `N/A` | `N/A` | Tên vật lý suy dẫn từ contract. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
...
```json
{
  "currentPassword": "REDACTED-EXAMPLE-PASSWORD",
  "newPassword": "REDACTED-EXAMPLE-PASSWORD"
}
```
