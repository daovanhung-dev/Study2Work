...
| 2 | Business/Auth | `○` | `EMAIL_ALREADY_REGISTERED` | Branch `EMAIL_ALREADY_REGISTERED` theo endpoint source | `409` | `EMAIL_ALREADY_REGISTERED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
| 3 | Validation | `○` | `token` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `Yes` | Generic code chưa có endpoint catalog |
| 4 | System error | `-` | `database/dependency` | Lỗi hệ thống không ánh xạ được sang business error | `500` | `INTERNAL_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#42-loi-he-thong` | `Yes` | Không lộ chi tiết nội bộ |
