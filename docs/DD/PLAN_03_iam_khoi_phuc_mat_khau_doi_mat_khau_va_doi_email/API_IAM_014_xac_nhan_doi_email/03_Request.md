...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Email-change token | `token` | `string` | `Yes` | `32` | `512` | `Unicode/JSON` | `opaque token` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
