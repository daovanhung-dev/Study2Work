...
- `Both new and old email rows in same transaction.`

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `is_primary` | `is_primary` | `boolean NOT NULL DEFAULT true` | `N/A` | `N/A` | `Y` | `` | `true for verified new email; false for old primary` | `true for verified new email; false for old primary` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `verified_at` | `verified_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp for new email` | `current_timestamp for new email` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 3 | `replaced_at` | `replaced_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp for old primary` | `current_timestamp for old primary` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
