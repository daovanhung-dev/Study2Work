...
| 7 | `data.email` | Email mới | `email` | `string` | `No` | `user_emails` | `email_ciphertext` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Decrypt only at response boundary if policy allows | N/A | Exact response field SOURCE_REQUIRED. [SOURCE_REQUIRED] |
