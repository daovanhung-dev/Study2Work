...
- Contract summary: Unique normalized email; create hashed EMAIL_CHANGE token; old email remains login identity.
...
- Idempotency; delivery + audit; 3/ngày
