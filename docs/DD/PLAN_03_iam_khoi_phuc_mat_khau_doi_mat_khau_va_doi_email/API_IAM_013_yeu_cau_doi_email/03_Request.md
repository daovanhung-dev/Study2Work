...
|---|---|
| HTTP method | `POST` |
| URI | `/api/v1/me/email-change-requests` |
...
| 4 | Step-up proof | `SOURCE_REQUIRED` | `Yes` | `recent MFA/password` | Claim/header chưa được định nghĩa. | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Email mới | `newEmail` | `string` | `Yes` | `3` | `320` | `Unicode/JSON` | `email` | `N/A` | `N/A` | Tên vật lý suy dẫn từ contract. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
