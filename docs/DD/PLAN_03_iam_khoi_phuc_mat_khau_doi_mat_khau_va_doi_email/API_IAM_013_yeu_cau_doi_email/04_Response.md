...
| 7 | `data.expiresAt` | Thời điểm hết hạn | `expiresAt` | `string` | `No` | `email_verification_tokens` | `expires_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | ISO-8601 UTC | N/A | [DERIVED] |
...
{
  "success": false,
  "businessCode": "EMAIL_ALREADY_REGISTERED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
