...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Câu trả lời onboarding | `answers` | `object` | `Yes` | `N/A` | `N/A` | `Unicode/JSON` | `allowlisted schema-versioned object` | `N/A` | `N/A` | Q-09: questionnaire/draft storage chưa có schema. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
