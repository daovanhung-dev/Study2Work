...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `ONBOARDING_ANSWER_INVALID` | Branch `ONBOARDING_ANSWER_INVALID` theo endpoint source | `400` | `ONBOARDING_ANSWER_INVALID` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
...
| 3 | Validation | `○` | `answers` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `Yes` | Generic code chưa có endpoint catalog |
