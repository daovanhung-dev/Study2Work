...
| 7 | `data.savedDraft` | Saved onboarding draft | `savedDraft` | `object` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09. [SOURCE_REQUIRED] |
| 8 | `data.status` | Status | `status` | `string` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09. [SOURCE_REQUIRED] |
| 9 | `data.version` | Version | `version` | `integer` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09. [SOURCE_REQUIRED] |
...
{
  "success": false,
  "businessCode": "ONBOARDING_ANSWER_INVALID",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
