...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `VERSION_CONFLICT` | Branch `VERSION_CONFLICT` theo endpoint source | `412` | `VERSION_CONFLICT` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Business/Auth | `○` | `SKILL_NOT_FOUND` | Branch `SKILL_NOT_FOUND` theo endpoint source | `404` | `SKILL_NOT_FOUND` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
