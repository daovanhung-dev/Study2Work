...
| 7 | `data.profile` | Updated profile | `profile` | `object` | `No` | `learner_profiles` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-08. [SOURCE_REQUIRED] |
