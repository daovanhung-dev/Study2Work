...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `ONBOARDING_INCOMPLETE` | Branch `ONBOARDING_INCOMPLETE` theo endpoint source | `409` | `ONBOARDING_INCOMPLETE` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
