...
| 7 | `data.completedRecord` | Completed onboarding record | `completedRecord` | `object` | `No` | `onboarding_submissions` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Mutation model conflicts with immutable schema. [DERIVED] |
| 8 | `data.recommendationRunId` | Recommendation run ID | `recommendationRunId` | `string` | `No` | `path_recommendation_runs` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
...
```json
{
  ...
  "data": {
    "completedRecord": {},
    "recommendationRunId": "0198a4c0-2d18-7a42-a82a-32f56e93bd26"
  },
  "meta": {},
...
{
  "success": false,
  "businessCode": "ONBOARDING_INCOMPLETE",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
