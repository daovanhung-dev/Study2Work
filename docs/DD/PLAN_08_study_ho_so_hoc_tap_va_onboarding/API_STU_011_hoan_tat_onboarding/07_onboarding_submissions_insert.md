...
- `Q-09 conflict must be resolved.`
...
| 4 | `schema_version` | `schema_version` | `integer NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Current schema version SOURCE_REQUIRED` | `Current schema version SOURCE_REQUIRED` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 5 | `answers` | `answers` | `jsonb NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Completed answer snapshot` | `Completed answer snapshot` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 6 | `submitted_at` | `submitted_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 7 | `supersedes_id` | `supersedes_id` | `uuid NULL` | `N/A` | `N/A` | `N` | `` | `Previous current record or NULL` | `Previous current record or NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 8 | `is_current` | `is_current` | `boolean NOT NULL DEFAULT true` | `N/A` | `N/A` | `Y` | `` | `true` | `true` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
