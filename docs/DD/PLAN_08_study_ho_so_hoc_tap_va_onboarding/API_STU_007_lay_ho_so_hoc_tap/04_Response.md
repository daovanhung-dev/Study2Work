...
| 7 | `data.profile` | Study profile | `profile` | `object` | `No` | `learner_profiles` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-08 field mapping conflict. [SOURCE_REQUIRED] |
| 8 | `data.onboardingStatus` | Onboarding status | `onboardingStatus` | `string` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09 storage gap. [SOURCE_REQUIRED] |
| 9 | `data.visibility` | Visibility | `visibility` | `string` | `No` | `learner_profiles` | `profile_visibility` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
...
```json
{
  ...
  "data": {
    "profile": {},
    "onboardingStatus": "SOURCE_REQUIRED",
    "visibility": "PRIVATE"
  },
  "meta": {},
...
{
  "success": false,
  "businessCode": "STUDY_PROJECTION_UNAVAILABLE",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
