...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `STUDY_PROJECTION_UNAVAILABLE` | Branch `STUDY_PROJECTION_UNAVAILABLE` theo endpoint source | `503` | `STUDY_PROJECTION_UNAVAILABLE` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | System error | `-` | `database/dependency` | Lỗi hệ thống không ánh xạ được sang business error | `500` | `INTERNAL_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#42-loi-he-thong` | `No` | Không lộ chi tiết nội bộ |
