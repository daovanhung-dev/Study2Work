...
| 7 | `data.questionSchema` | Question schema | `questionSchema` | `object` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09 questionnaire config missing. [SOURCE_REQUIRED] |
| 8 | `data.savedAnswers` | Saved answers | `savedAnswers` | `object` | `No` | `onboarding_submissions` | `answers` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.status` | Onboarding status | `status` | `string` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09. [SOURCE_REQUIRED] |
| 10 | `data.version` | Version | `version` | `integer` | `No` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-09. [SOURCE_REQUIRED] |
