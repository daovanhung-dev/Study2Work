...
|---:|---|---|---:|---|---|---|
| 1 | N/A | `N/A` | `No` | `N/A` | N/A — Không có header nghiệp vụ bổ sung. | `N/A` |
...
| 3 | Từ khóa | `q` | `string` | `No` | `0` | `200` | `Unicode text` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 4 | Kỹ năng | `skill` | `string` | `No` | `N/A` | `N/A` | `skill filter` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 5 | Cấp độ | `level` | `string` | `No` | `N/A` | `N/A` | `N/A` | `BEGINNER\|INTERMEDIATE\|ADVANCED` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
