...
| 8 | `data[].slug` | Slug | `slug` | `string` | `No` | `courses` | `slug` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
...
| 10 | `data[].level` | Level | `level` | `string` | `No` | `course_versions` | `level` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 11 | `data[].independentlyEnrollable` | Standalone flag | `independentlyEnrollable` | `boolean` | `No` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Fixed true in V1 | N/A | [DIRECT] |
