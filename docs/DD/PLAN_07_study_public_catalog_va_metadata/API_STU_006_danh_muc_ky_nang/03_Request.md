...
| No | Logical name | Physical name | Type | Required | Min | Max | Format | Valid values | Default | Description | Data Mapping reference |
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | Từ khóa | `q` | `string` | `No` | `0` | `200` | `Unicode text` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Trang | `page` | `integer` | `No` | `1` | `N/A` | `integer` | `N/A` | `1` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 3 | Kích thước trang | `pageSize` | `integer` | `No` | `1` | `100` | `integer` | `N/A` | `20` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
