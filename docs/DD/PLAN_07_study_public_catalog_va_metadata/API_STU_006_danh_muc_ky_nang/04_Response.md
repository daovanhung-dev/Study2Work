...
| 7 | `data[].id` | Skill ID | `id` | `string` | `No` | `study_skills` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data[].code` | Skill code | `code` | `string` | `No` | `study_skills` | `code` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data[].name` | Skill name | `name` | `string` | `No` | `study_skills` | `name` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
