...
| 7 | `data.lessonId` | Lesson ID | `lessonId` | `string` | `No` | `lessons` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.title` | Title | `title` | `string` | `No` | `lessons` | `title` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 9 | `data.blocks` | Sanitized blocks | `blocks` | `array<object>` | `No` | `content_blocks` | `content_json` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Sanitized | [] if none | [DERIVED] |
| 10 | `data.resources` | Resources | `resources` | `array<object>` | `No` | `file_objects` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Signed URL <=10 minutes when applicable | [] if none | [DERIVED] |
...
```json
{
  ...
  "data": {
    "lessonId": "0198a4c0-2d18-7a42-a82a-32f56e93bd24",
    "title": "Bài học mẫu",
    "blocks": [],
    "resources": []
  },
...
{
  "success": false,
  "businessCode": "SAMPLE_NOT_AVAILABLE",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
