...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `SAMPLE_NOT_AVAILABLE` | Branch `SAMPLE_NOT_AVAILABLE` theo endpoint source | `404` | `SAMPLE_NOT_AVAILABLE` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Validation | `○` | `lessonId` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `No` | Generic code chưa có endpoint catalog |
| 3 | System error | `-` | `database/dependency` | Lỗi hệ thống không ánh xạ được sang business error | `500` | `INTERNAL_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#42-loi-he-thong` | `No` | Không lộ chi tiết nội bộ |
