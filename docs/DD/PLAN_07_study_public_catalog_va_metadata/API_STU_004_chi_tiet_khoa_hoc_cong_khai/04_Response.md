...
| 7 | `data.courseId` | Course ID | `courseId` | `string` | `No` | `courses` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.courseVersionId` | Current version ID | `courseVersionId` | `string` | `No` | `course_versions` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.title` | Title | `title` | `string` | `No` | `course_versions` | `title` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
| 10 | `data.curriculum` | Curriculum preview | `curriculum` | `array<object>` | `No` | `chapters` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] if none | [DERIVED] |
| 11 | `data.learnerState` | Learner state | `learnerState` | `object` | `Yes` | `course_enrollments` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | null for anonymous/not enrolled | [DERIVED] |
...
```json
{
  ...
  "data": {
    "courseId": "0198a4c0-2d18-7a42-a82a-32f56e93bd22",
    "courseVersionId": "0198a4c0-2d18-7a42-a82a-32f56e93bd23",
