...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `COURSE_NOT_FOUND` | Branch `COURSE_NOT_FOUND` theo endpoint source | `404` | `COURSE_NOT_FOUND` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Validation | `○` | `slug` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `No` | Generic code chưa có endpoint catalog |
