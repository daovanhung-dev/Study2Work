...
| 8 | `data.pathVersionId` | Path version ID | `pathVersionId` | `string` | `No` | `learning_path_versions` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
...
| 10 | `data.courses` | Pinned courses | `courses` | `array<object>` | `No` | `path_course_items` | `course_version_id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] if none | [DERIVED] |
| 11 | `data.prerequisites` | Prerequisites | `prerequisites` | `array<object>` | `No` | `course_prerequisites` | `prerequisite_course_version_id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] if none | Q-14 candidate table. [DERIVED] |
...
```json
{
  ...
  "data": {
    "pathId": "0198a4c0-2d18-7a42-a82a-32f56e93bd19",
    "pathVersionId": "0198a4c0-2d18-7a42-a82a-32f56e93bd20",
