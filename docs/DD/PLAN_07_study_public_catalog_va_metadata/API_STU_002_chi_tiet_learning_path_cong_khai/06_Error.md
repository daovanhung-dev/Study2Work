...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `PATH_NOT_FOUND` | Branch `PATH_NOT_FOUND` theo endpoint source | `404` | `PATH_NOT_FOUND` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `No` | HTTP/message chưa có nguồn thì giữ TBD |
