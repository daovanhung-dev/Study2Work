...
| Purpose | `Slug → current published version, pinned course versions, prerequisites` |
...
- Contract summary: Join stable path/current version/composition by unique slug; old enrollment context never substituted.
- Vận hành: CDN 60s.
