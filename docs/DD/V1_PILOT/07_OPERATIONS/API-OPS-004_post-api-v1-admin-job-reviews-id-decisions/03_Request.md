...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/job-reviews/{id}/decisions` |
...
| ---: | --- | --- | --- |
| 1 | Chấp thuận/từ chối/yêu cầu đổi, mã lý do/chính sách | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Chấp thuận/từ chối/yêu cầu đổi, mã lý do/chính sách, `If-Match` → hồ sơ
