...
| Chấp thuận/từ chối/yêu cầu đổi, mã lý do/chính sách | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-OPS-002`.
...
- Endpoint input contract: Chấp thuận/từ chối/yêu cầu đổi, mã lý do/chính sách, `If-Match` → hồ sơ.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thêm quyết định; chấp thuận không xuất bản cho đến API-WRK-047; từ chối đưa việc làm về chính sách bản nháp
