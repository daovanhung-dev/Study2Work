...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/break-glass-sessions` |
...
| ---: | --- | --- | --- |
| 1 | ID phiếu, phạm vi, tối đa 60 phút, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID phiếu, phạm vi, tối đa 60 phút, lý do → phiên nâng quyền
