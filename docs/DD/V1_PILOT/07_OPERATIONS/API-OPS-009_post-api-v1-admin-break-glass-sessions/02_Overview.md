...
| Module | `Operations` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/break-glass-sessions` |
| Purpose | phiên nâng quyền |
| Consumer/Actor | Người ứng phó sự cố được chỉ định + MFA phần cứng/gần đây |
| Authentication | Người ứng phó sự cố được chỉ định + MFA phần cứng/gần đây |
| Authorization | Người ứng phó sự cố được chỉ định + MFA phần cứng/gần đây |
...
| Side effects | Khóa lặp; cảnh báo bảo mật ngay; kiểm toán đầy đủ lệnh/dữ liệu |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L430` — endpoint contract.
...
- [OQ-OPS-MISSING-READ-CONTRACTS](../../OPEN_QUESTIONS.md#oq-ops-missing-read-contracts).
