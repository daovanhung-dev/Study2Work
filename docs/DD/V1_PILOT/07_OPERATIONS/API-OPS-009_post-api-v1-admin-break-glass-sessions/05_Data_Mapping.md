...
format: "markdown"
dd_id: "API-OPS-009"
api_name: "POST /api/v1/admin/break-glass-sessions"
...
| ID phiếu, phạm vi, tối đa 60 phút, lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phiên nâng quyền | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người ứng phó sự cố được chỉ định + MFA phần cứng/gần đây.
...
- Endpoint input contract: ID phiếu, phạm vi, tối đa 60 phút, lý do → phiên nâng quyền.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chính sách phê duyệt: người phê duyệt thứ hai trừ khi công bố `SEV-1`; thông tin xác thực theo thời hạn; không thay đổi vai trò ngầm

- Operations/observability contract: Khóa lặp; cảnh báo bảo mật ngay; kiểm toán đầy đủ lệnh/dữ liệu
