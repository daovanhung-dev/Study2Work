...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `BREAK_GLASS_APPROVAL_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `BREAK_GLASS_APPROVAL_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L430` |
| 2 | Endpoint business/error code | DIRECT | `INCIDENT_TICKET_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `INCIDENT_TICKET_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L430` |
