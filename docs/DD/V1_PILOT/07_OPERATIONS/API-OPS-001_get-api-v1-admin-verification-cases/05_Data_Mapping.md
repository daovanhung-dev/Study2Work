...
format: "markdown"
dd_id: "API-OPS-001"
api_name: "GET /api/v1/admin/verification-cases"
...
| Trang/loại/trạng thái/tuổi | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ doanh nghiệp/trường đại học | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-OPS-001` + MFA.
...
- Endpoint input contract: Trang/loại/trạng thái/tuổi → hồ sơ doanh nghiệp/trường đại học.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn Work DB có chỉ mục loại/trạng thái/thời điểm nộp; truy cập tài liệu riêng qua URL có chữ ký

- Operations/observability contract: Không lưu đệm; kiểm toán
