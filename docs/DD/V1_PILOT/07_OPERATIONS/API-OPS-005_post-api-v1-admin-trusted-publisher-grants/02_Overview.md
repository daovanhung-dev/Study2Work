...
| Module | `Operations` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/trusted-publisher-grants` |
| Purpose | cấp quyền |
| Consumer/Actor | `PERM-OPS-003` + MFA gần đây |
| Authentication | `PERM-OPS-003` + MFA gần đây |
| Authorization | `PERM-OPS-003` + MFA gần đây |
...
| Side effects | Khóa lặp; sự kiện/kiểm toán bảo mật |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L426` — endpoint contract.
