...
format: "markdown"
dd_id: "API-OPS-008"
api_name: "POST /api/v1/admin/audit-exports"
...
| Cùng bộ lọc, lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | xuất mã hóa bất đồng bộ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Quyền xuất + xác minh tăng cường.
...
- Endpoint input contract: Cùng bộ lọc, lý do → xuất mã hóa bất đồng bộ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chụp bộ lọc/quyền; tải xuống có chữ ký ngắn hạn; hình mờ; lưu giữ 7 ngày

- Operations/observability contract: Khóa lặp; kiểm toán xuất bất biến
