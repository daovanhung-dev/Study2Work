...
| Module | `Operations` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/verification-cases/{id}/decisions` |
| Purpose | quyết định |
| Consumer/Actor | `PERM-OPS-001`, không phải người nộp |
| Authentication | `PERM-OPS-001`, không phải người nộp |
| Authorization | `PERM-OPS-001`, không phải người nộp |
...
| Side effects | Khóa lặp; kiểm toán/thông báo rủi ro cao |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L423` — endpoint contract.
