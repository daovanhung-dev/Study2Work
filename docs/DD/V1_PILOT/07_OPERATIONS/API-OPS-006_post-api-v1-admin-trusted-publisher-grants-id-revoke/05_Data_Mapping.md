...
format: "markdown"
dd_id: "API-OPS-006"
api_name: "POST /api/v1/admin/trusted-publisher-grants/{id}/revoke"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | đã thu hồi | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-OPS-003` + MFA.
...
- Endpoint input contract: Lý do → đã thu hồi.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thêm thu hồi; từ chối ngay các lần xuất bản sau; nội dung cũ vẫn giữ cùng kiểm toán

- Operations/observability contract: Khóa lặp; cảnh báo/sự kiện
