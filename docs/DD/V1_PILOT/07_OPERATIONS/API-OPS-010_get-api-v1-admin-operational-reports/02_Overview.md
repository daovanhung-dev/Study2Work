...
| Module | `Operations` |
| Method | `GET` |
| Endpoint | `/api/v1/admin/operational-reports` |
| Purpose | chỉ số tổng hợp + độ mới |
| Consumer/Actor | Quyền báo cáo theo miền |
| Authentication | Quyền báo cáo theo miền |
| Authorization | Quyền báo cáo theo miền |
...
| Side effects | Bộ nhớ đệm 5 phút; kiểm toán truy cập |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L431` — endpoint contract.
