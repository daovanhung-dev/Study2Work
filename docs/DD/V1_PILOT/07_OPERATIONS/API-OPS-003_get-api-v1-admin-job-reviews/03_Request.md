...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái/rủi ro/tuổi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái/rủi ro/tuổi → hàng đợi duyệt việc làm
