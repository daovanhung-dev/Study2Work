...
format: "markdown"
dd_id: "API-OPS-003"
api_name: "GET /api/v1/admin/job-reviews"
...
| Trang/trạng thái/rủi ro/tuổi | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hàng đợi duyệt việc làm | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/trạng thái/rủi ro/tuổi → hàng đợi duyệt việc làm.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc hồ sơ/bản sửa đổi việc làm/kiểm tra tự động; tối thiểu hóa dữ liệu tổ chức
