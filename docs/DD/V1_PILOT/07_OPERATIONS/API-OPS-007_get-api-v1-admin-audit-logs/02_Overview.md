...
| Purpose | luồng đã che dữ liệu |
| Consumer/Actor | Quyền kiểm toán theo phạm vi + MFA |
| Authentication | Quyền kiểm toán theo phạm vi + MFA |
| Authorization | Quyền kiểm toán theo phạm vi + MFA |
...
| Side effects | Không lưu đệm; mọi truy vấn/xuất đều kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L428` — endpoint contract.
