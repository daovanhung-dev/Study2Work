...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | trạng thái người học thuộc danh sách cho phép cho mục đích đã chấp thuận | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
