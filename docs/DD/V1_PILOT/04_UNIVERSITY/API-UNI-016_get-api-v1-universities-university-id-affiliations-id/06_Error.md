...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CONSENT_REQUIRED` | As specified by API catalog. | `403` | `CONSENT_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L360` |
| 2 | Endpoint business/error code | DIRECT | `AFFILIATION_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `AFFILIATION_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L360` |
