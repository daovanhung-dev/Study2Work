...
format: "markdown"
dd_id: "API-UNI-007"
api_name: "DELETE /api/v1/me/university-affiliations/{affiliationId}/consent"
...
| `affiliationId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Mục đích/tất cả, lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | đã rút | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học đã liên kết + xác minh tăng cường.
...
- Endpoint input contract: Mục đích/tất cả, lý do → đã rút.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thêm sự kiện rút; từ chối ngay mọi truy cập cá nhân trong tương lai; giữ dữ kiện lịch sử tổng hợp đã ẩn danh

- Operations/observability contract: Khóa lặp; sự kiện/kiểm toán riêng tư
