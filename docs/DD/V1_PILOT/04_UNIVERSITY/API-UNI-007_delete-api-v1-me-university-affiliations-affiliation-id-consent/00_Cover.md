...
| API ID | `API-UNI-007` |
| API name | `DELETE /api/v1/me/university-affiliations/{affiliationId}/consent` |
| HTTP method | `DELETE` |
| Endpoint | `/api/v1/me/university-affiliations/{affiliationId}/consent` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L351`.
