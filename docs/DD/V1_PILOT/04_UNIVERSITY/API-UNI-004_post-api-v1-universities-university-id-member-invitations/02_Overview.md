...
| Purpose | lời mời |
| Consumer/Actor | `PERM-UNI-003` + MFA |
| Authentication | `PERM-UNI-003` + MFA |
| Authorization | `PERM-UNI-003` + MFA |
...
| Side effects | Khóa lặp; kiểm toán/giao nhận |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L348` — endpoint contract.
