...
format: "markdown"
dd_id: "API-UNI-004"
api_name: "POST /api/v1/universities/{universityId}/member-invitations"
...
| Email, vai trò, hết hạn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-UNI-003` + MFA.
...
- Endpoint input contract: Email, vai trò, hết hạn → lời mời.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm chỗ ngồi/chủ sở hữu cuối cùng và vai trò tổ chức

- Operations/observability contract: Khóa lặp; kiểm toán/giao nhận
