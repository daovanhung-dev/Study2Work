...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SEAT_LIMIT_REACHED` | As specified by API catalog. | `SOURCE_REQUIRED` | `SEAT_LIMIT_REACHED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L348` |
| 2 | Endpoint business/error code | DIRECT | `ROLE_NOT_ALLOWED` | As specified by API catalog. | `SOURCE_REQUIRED` | `ROLE_NOT_ALLOWED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L348` |
