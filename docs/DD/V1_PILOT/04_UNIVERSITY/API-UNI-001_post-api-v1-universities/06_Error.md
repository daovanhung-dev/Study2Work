...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `UNIVERSITY_DUPLICATE` | As specified by API catalog. | `SOURCE_REQUIRED` | `UNIVERSITY_DUPLICATE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L345` |
| 2 | Endpoint business/error code | DIRECT | `LEGAL_INFO_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `LEGAL_INFO_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L345` |
