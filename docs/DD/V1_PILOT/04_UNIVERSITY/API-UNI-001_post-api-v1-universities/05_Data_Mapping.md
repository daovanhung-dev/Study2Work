...
format: "markdown"
dd_id: "API-UNI-001"
api_name: "POST /api/v1/universities"
...
| Thông tin pháp lý/hồ sơ/liên hệ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Đại diện đã xác thực.
...
- Endpoint input contract: Thông tin pháp lý/hồ sơ/liên hệ → tổ chức `PENDING_VERIFICATION` + tư cách thành viên chủ sở hữu.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX chuẩn hóa mã cơ sở; chặn trùng; tạo tư cách thành viên
