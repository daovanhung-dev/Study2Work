...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `INVITATION_EXPIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `INVITATION_EXPIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L350` |
| 2 | Endpoint business/error code | DIRECT | `CONSENT_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `CONSENT_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L350` |
