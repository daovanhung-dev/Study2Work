...
| Purpose | quan hệ đối tác `PROPOSED` |
| Consumer/Actor | `PERM-UNI-022` |
| Authentication | `PERM-UNI-022` |
| Authorization | `PERM-UNI-022` |
...
| Side effects | Xử lý lặp an toàn; kiểm toán/thông báo |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L356` — endpoint contract.
