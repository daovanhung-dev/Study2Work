...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PARTNERSHIP_EXISTS` | As specified by API catalog. | `SOURCE_REQUIRED` | `PARTNERSHIP_EXISTS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L356` |
| 2 | Endpoint business/error code | DIRECT | `SCOPE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `SCOPE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L356` |
