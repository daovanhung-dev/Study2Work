...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/partnerships` |
...
| ---: | --- | --- | --- |
| 1 | ID doanh nghiệp, phạm vi, ngày tháng | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID doanh nghiệp, phạm vi, ngày tháng → quan hệ đối tác `PROPOSED`
