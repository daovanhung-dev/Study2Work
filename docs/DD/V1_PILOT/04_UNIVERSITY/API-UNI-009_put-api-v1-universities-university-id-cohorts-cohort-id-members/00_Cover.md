...
| API ID | `API-UNI-009` |
| API name | `PUT /api/v1/universities/{universityId}/cohorts/{cohortId}/members` |
| HTTP method | `PUT` |
| Endpoint | `/api/v1/universities/{universityId}/cohorts/{cohortId}/members` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L353`.
