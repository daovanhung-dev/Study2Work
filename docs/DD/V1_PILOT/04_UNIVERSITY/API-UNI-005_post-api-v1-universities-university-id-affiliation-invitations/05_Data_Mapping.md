...
format: "markdown"
dd_id: "API-UNI-005"
api_name: "POST /api/v1/universities/{universityId}/affiliation-invitations"
...
| `universityId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Email/hàm băm sinh viên hoặc lô <=500, mã sinh viên, hết hạn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lời mời | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-010`.
...
- Endpoint input contract: Email/hàm băm sinh viên hoặc lô <=500, mã sinh viên, hết hạn → lời mời.

<a id="s04"></a>
### S04. Execute source-defined processing

> Lưu đích giao nhận mã hóa + hàm băm; chưa tạo liên kết cho đến khi người học chấp thuận; lô trả kết quả theo từng hàng

- Operations/observability contract: Khóa lặp; kiểm toán; giới hạn tần suất/lô
