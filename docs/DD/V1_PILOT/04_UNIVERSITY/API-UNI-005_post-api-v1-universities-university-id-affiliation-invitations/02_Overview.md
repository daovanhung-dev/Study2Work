...
| Purpose | lời mời |
| Consumer/Actor | `PERM-UNI-010` |
| Authentication | `PERM-UNI-010` |
| Authorization | `PERM-UNI-010` |
...
| Side effects | Khóa lặp; kiểm toán; giới hạn tần suất/lô |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L349` — endpoint contract.
