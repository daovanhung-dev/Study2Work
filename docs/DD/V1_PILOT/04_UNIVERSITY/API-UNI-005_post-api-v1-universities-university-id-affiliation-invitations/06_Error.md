...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `AFFILIATION_EXISTS` | As specified by API catalog. | `SOURCE_REQUIRED` | `AFFILIATION_EXISTS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L349` |
| 2 | Endpoint business/error code | DIRECT | `BATCH_TOO_LARGE` | As specified by API catalog. | `SOURCE_REQUIRED` | `BATCH_TOO_LARGE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L349` |
