...
| API ID | `API-UNI-005` |
| API name | `POST /api/v1/universities/{universityId}/affiliation-invitations` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/universities/{universityId}/affiliation-invitations` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L349`.
