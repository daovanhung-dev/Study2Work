...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/internship-programs` |
...
| ---: | --- | --- | --- |
| 1 | Chương trình, ngày tháng, điều kiện, doanh nghiệp đối tác | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Chương trình, ngày tháng, điều kiện, doanh nghiệp đối tác → chương trình `DRAFT`
