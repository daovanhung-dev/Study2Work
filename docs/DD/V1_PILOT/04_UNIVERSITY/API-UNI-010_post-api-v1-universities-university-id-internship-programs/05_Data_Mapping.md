...
format: "markdown"
dd_id: "API-UNI-010"
api_name: "POST /api/v1/universities/{universityId}/internship-programs"
...
| Chương trình, ngày tháng, điều kiện, doanh nghiệp đối tác | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | chương trình `DRAFT` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-020`.
...
- Endpoint input contract: Chương trình, ngày tháng, điều kiện, doanh nghiệp đối tác → chương trình `DRAFT`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm liên kết tổ chức/đối tác; quy tắc có cấu trúc
