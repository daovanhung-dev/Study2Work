...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PARTNER_NOT_ACTIVE` | As specified by API catalog. | `SOURCE_REQUIRED` | `PARTNER_NOT_ACTIVE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L354` |
| 2 | Endpoint business/error code | DIRECT | `PROGRAM_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `PROGRAM_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L354` |
