...
| Purpose | giới thiệu |
| Consumer/Actor | `PERM-UNI-023` + đồng ý người học đang hoạt động |
| Authentication | `PERM-UNI-023` + đồng ý người học đang hoạt động |
| Authorization | `PERM-UNI-023` + đồng ý người học đang hoạt động |
...
| Side effects | Khóa lặp; kiểm toán/thông báo riêng tư |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L358` — endpoint contract.
