...
format: "markdown"
dd_id: "API-UNI-014"
api_name: "POST /api/v1/universities/{universityId}/referrals"
...
| Liên kết, việc làm đã xuất bản, ghi chú | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | giới thiệu | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-UNI-023` + đồng ý người học đang hoạt động.
...
- Endpoint input contract: Liên kết, việc làm đã xuất bản, ghi chú → giới thiệu.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm lại mục đích đồng ý `JOB_REFERRAL`; giới thiệu không ứng tuyển hoặc mở trò chuyện; ứng viên tự chọn ứng tuyển

- Operations/observability contract: Khóa lặp; kiểm toán/thông báo riêng tư
