...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/referrals` |
...
| ---: | --- | --- | --- |
| 1 | Liên kết, việc làm đã xuất bản, ghi chú | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Liên kết, việc làm đã xuất bản, ghi chú → giới thiệu
