...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PARTNERSHIP_VERSION_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `PARTNERSHIP_VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L357` |
| 2 | Endpoint business/error code | DIRECT | `PERMISSION_DENIED` | As specified by API catalog. | `403` | `PERMISSION_DENIED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L357` |
