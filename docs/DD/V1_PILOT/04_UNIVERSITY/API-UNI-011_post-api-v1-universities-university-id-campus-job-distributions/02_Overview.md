...
| Purpose | phân phối |
| Consumer/Actor | `PERM-UNI-021` |
| Authentication | `PERM-UNI-021` |
| Authorization | `PERM-UNI-021` |
...
| Side effects | Khóa lặp; hộp thư đi thông báo |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L355` — endpoint contract.
