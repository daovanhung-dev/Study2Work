...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/verification-submissions` |
...
| ---: | --- | --- | --- |
| 1 | Dữ liệu pháp lý + tài liệu | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Dữ liệu pháp lý + tài liệu `CLEAN` → hồ sơ
