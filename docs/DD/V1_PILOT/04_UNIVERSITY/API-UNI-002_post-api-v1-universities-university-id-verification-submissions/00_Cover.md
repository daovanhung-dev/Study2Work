...
| API ID | `API-UNI-002` |
| API name | `POST /api/v1/universities/{universityId}/verification-submissions` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/universities/{universityId}/verification-submissions` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L346`.
