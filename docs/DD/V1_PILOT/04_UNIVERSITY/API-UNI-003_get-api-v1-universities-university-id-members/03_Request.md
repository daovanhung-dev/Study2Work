...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/universities/{universityId}/members` |
...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái/vai trò | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái/vai trò → thành viên
