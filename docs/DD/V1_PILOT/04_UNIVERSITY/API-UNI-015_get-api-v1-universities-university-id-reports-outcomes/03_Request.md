...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/universities/{universityId}/reports/outcomes` |
...
| ---: | --- | --- | --- |
| 1 | Ngày/nhóm/chương trình/chiều dữ liệu | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Ngày/nhóm/chương trình/chiều dữ liệu → chỉ số tổng hợp
