...
| Purpose | chỉ số tổng hợp |
| Consumer/Actor | `PERM-UNI-030` |
| Authentication | `PERM-UNI-030` |
| Authorization | `PERM-UNI-030` |
...
| Side effects | Riêng tư; kiểm toán truy vấn; xuất bất đồng bộ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L359` — endpoint contract.
