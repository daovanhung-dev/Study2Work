...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `COHORT_CODE_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `COHORT_CODE_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L352` |
| 2 | Endpoint business/error code | DIRECT | `DATE_RANGE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `DATE_RANGE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L352` |
