...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/universities/{universityId}/cohorts` |
...
| ---: | --- | --- | --- |
| 1 | Tên, mã, ngày tháng, tiêu chí | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Tên, mã, ngày tháng, tiêu chí → nhóm
