...
| API ID | `API-UNI-008` |
| API name | `POST /api/v1/universities/{universityId}/cohorts` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/universities/{universityId}/cohorts` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L352`.
