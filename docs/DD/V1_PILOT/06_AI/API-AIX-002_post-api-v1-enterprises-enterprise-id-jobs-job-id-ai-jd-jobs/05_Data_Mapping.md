...
| Bản sửa đổi nháp, phần/phong cách yêu cầu | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Người biên tập việc làm + quyền sử dụng.
...
- Endpoint input contract: Bản sửa đổi nháp, phần/phong cách yêu cầu → tác vụ bất đồng bộ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện tổ chức; loại dữ liệu tổ chức/người dùng bị ẩn; chụp JD; tạo tác vụ
