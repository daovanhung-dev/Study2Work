...
| Module | `AI` |
| Method | `PUT` |
| Endpoint | `/api/v1/admin/ai/model-configs/{configId}` |
| Purpose | cấu hình có phiên bản |
| Consumer/Actor | `PERM-AIX-002` + MFA |
| Authentication | `PERM-AIX-002` + MFA |
| Authorization | `PERM-AIX-002` + MFA |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L412` — endpoint contract.
