...
| Module | `AI` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/ai/kill-switch` |
| Purpose | trạng thái |
| Consumer/Actor | `PERM-AIX-001` + MFA gần đây |
| Authentication | `PERM-AIX-001` + MFA gần đây |
| Authorization | `PERM-AIX-001` + MFA gần đây |
...
| Side effects | Khóa lặp; cảnh báo/kiểm toán bảo mật |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L411` — endpoint contract.
