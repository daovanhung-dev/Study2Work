...
format: "markdown"
dd_id: "API-AIX-007"
api_name: "POST /api/v1/admin/ai/kill-switch"
...
| Phạm vi/nhà cung cấp/năng lực, vô hiệu hóa, lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-AIX-001` + MFA gần đây.
...
- Endpoint input contract: Phạm vi/nhà cung cấp/năng lực, vô hiệu hóa, lý do → trạng thái.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thêm trạng thái chính sách; tiến trình nền kiểm trước khi bắt đầu và trước khi lưu; tác vụ xếp hàng hủy/hoàn giữ chỗ quyền sử dụng

- Operations/observability contract: Khóa lặp; cảnh báo/kiểm toán bảo mật
