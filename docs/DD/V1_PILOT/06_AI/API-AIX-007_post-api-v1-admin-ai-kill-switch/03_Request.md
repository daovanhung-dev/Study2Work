...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/ai/kill-switch` |
...
| ---: | --- | --- | --- |
| 1 | Phạm vi/nhà cung cấp/năng lực, vô hiệu hóa, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phạm vi/nhà cung cấp/năng lực, vô hiệu hóa, lý do → trạng thái
