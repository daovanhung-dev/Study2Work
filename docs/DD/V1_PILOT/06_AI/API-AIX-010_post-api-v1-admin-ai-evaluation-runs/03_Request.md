...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/ai/evaluation-runs` |
...
| ---: | --- | --- | --- |
| 1 | Phiên bản cấu hình/lời nhắc/tập đánh giá | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phiên bản cấu hình/lời nhắc/tập đánh giá → lượt chạy bất đồng bộ
