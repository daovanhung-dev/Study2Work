...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | tác vụ bất đồng bộ | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
{
  "success": false,
  "businessCode": "AI_INPUT_INCOMPLETE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
