...
format: "markdown"
dd_id: "API-AIX-003"
api_name: "POST /api/v1/enterprises/{enterpriseId}/applications/{applicationId}/ai-match-explanations"
...
| Phiên bản ảnh chụp việc làm/đơn ứng tuyển | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tác vụ bất đồng bộ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Nhà tuyển dụng được phân công + `PERM-WRK-070`.
...
- Endpoint input contract: Phiên bản ảnh chụp việc làm/đơn ứng tuyển → tác vụ bất đồng bộ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chỉ dùng ảnh chụp đơn và tiêu chí việc làm thuộc danh sách cho phép; loại rõ tên, tuổi/ngày sinh, giới tính, ảnh, độ chi tiết địa chỉ, chỉ dấu uy tín trường, liên hệ, minh chứng; lưu danh mục đặc trưng tất định

- Operations/observability contract: Khóa lặp; truy cập/kiểm toán; 10/giờ/thành viên
