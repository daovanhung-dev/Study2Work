...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/ai-match-explanations` |
...
| ---: | --- | --- | --- |
| 1 | Phiên bản ảnh chụp việc làm/đơn ứng tuyển | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phiên bản ảnh chụp việc làm/đơn ứng tuyển → tác vụ bất đồng bộ
