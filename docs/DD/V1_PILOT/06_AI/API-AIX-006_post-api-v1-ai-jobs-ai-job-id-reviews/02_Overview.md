...
| Module | `AI` |
| Method | `POST` |
| Endpoint | `/api/v1/ai-jobs/{aiJobId}/reviews` |
| Purpose | lượt duyệt |
| Consumer/Actor | Người được quyền là con người |
| Authentication | Người được quyền là con người |
| Authorization | Người được quyền là con người |
...
| Side effects | Khóa lặp; kiểm toán bất biến; sự kiện chỉ số chất lượng |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L410` — endpoint contract.
