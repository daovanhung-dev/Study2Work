...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `AI_JOB_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `AI_JOB_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L409` |
| 2 | Endpoint business/error code | DIRECT | `AI_OUTPUT_BLOCKED` | As specified by API catalog. | `422` | `AI_OUTPUT_BLOCKED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L409` |
