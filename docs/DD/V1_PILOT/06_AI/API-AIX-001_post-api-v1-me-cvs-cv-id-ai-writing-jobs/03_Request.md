...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/cvs/{cvId}/ai-writing-jobs` |
...
| ---: | --- | --- | --- |
| 1 | Bản sửa đổi, phần, mục tiêu, văn bản nguồn <=10k, ngôn ngữ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Bản sửa đổi, phần, mục tiêu, văn bản nguồn <=10k, ngôn ngữ → tác vụ bất đồng bộ
