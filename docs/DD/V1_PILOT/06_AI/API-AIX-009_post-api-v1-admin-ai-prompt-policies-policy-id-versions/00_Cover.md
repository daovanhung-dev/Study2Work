...
| API ID | `API-AIX-009` |
| API name | `POST /api/v1/admin/ai/prompt-policies/{policyId}/versions` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/admin/ai/prompt-policies/{policyId}/versions` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L413`.
