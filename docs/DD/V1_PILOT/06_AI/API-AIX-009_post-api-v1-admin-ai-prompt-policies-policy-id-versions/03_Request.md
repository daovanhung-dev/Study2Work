...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/ai/prompt-policies/{policyId}/versions` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `policyId` | `policyId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Mẫu/lược đồ/trường loại trừ/chính sách an toàn/ngưỡng đánh giá | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Mẫu/lược đồ/trường loại trừ/chính sách an toàn/ngưỡng đánh giá → phiên bản bất biến
