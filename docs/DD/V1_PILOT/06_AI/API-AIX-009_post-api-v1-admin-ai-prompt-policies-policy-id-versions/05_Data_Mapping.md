...
format: "markdown"
dd_id: "API-AIX-009"
api_name: "POST /api/v1/admin/ai/prompt-policies/{policyId}/versions"
...
| `policyId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Mẫu/lược đồ/trường loại trừ/chính sách an toàn/ngưỡng đánh giá | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phiên bản bất biến | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-AIX-003`.
...
- Endpoint input contract: Mẫu/lược đồ/trường loại trừ/chính sách an toàn/ngưỡng đánh giá → phiên bản bất biến.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm danh sách biến cho phép và trường loại trừ bắt buộc; chạy đánh giá trước khi đủ điều kiện kích hoạt
