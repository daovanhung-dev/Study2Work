...
| Purpose | đơn ứng tuyển |
| Consumer/Actor | Nhà tuyển dụng được phân công + quyền chuyển trạng thái |
| Authentication | Nhà tuyển dụng được phân công + quyền chuyển trạng thái |
| Authorization | Nhà tuyển dụng được phân công + quyền chuyển trạng thái |
...
| Side effects | Khóa lặp; kiểm toán trước/sau; thông báo; trò chuyện chỉ đọc khi kết thúc |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L326` — endpoint contract.
