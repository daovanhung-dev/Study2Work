...
| `fromVersion` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| trạng thái đích, lý do, thang chấm/tuyên bố quyết định | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Nhà tuyển dụng được phân công + quyền chuyển trạng thái.
...
- Endpoint input contract: `fromVersion`, trạng thái đích, lý do, thang chấm/tuyên bố quyết định → đơn ứng tuyển.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa đơn ứng tuyển; áp dụng máy trạng thái và hiện vật bắt buộc; thêm lịch sử/quyết định bất biến; tác nhân con người bắt buộc cho `OFFERED`/`HIRED`/`REJECTED`; AI không thể gọi

- Operations/observability contract: Khóa lặp; kiểm toán trước/sau; thông báo; trò chuyện chỉ đọc khi kết thúc
