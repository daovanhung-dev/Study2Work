...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CV_NOT_PUBLISHED` | As specified by API catalog. | `SOURCE_REQUIRED` | `CV_NOT_PUBLISHED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L246` |
