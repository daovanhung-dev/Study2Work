...
| Purpose | hồ sơ công khai/bản xem trước hồ sơ năng lực đã che dữ liệu |
| Consumer/Actor | `PERM-WRK-020` |
| Authentication | `PERM-WRK-020` |
| Authorization | `PERM-WRK-020` |
...
| Side effects | Kiểm toán truy cập; riêng tư, không lưu |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L320` — endpoint contract.
