...
format: "markdown"
dd_id: "API-WRK-052"
api_name: "GET /api/v1/enterprises/{enterpriseId}/candidate-searches/{candidatePublicId}"
...
| `candidatePublicId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ công khai/bản xem trước hồ sơ năng lực đã che dữ liệu | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-020`.
...
- Endpoint input contract: → hồ sơ công khai/bản xem trước hồ sơ năng lực đã che dữ liệu.

<a id="s04"></a>
### S04. Execute source-defined processing

> Phân giải ID công khai luân chuyển trong phạm vi tổ chức; kiểm lại đồng ý tại CSDL, không bao giờ lộ email/điện thoại/CV/minh chứng

- Operations/observability contract: Kiểm toán truy cập; riêng tư, không lưu
