...
format: "markdown"
dd_id: "API-WRK-003"
api_name: "GET /api/v1/enterprises/{enterpriseSlug}"
...
| `enterpriseSlug` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ nhà tuyển dụng công khai đã xác minh + việc làm đã xuất bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Slug → hồ sơ nhà tuyển dụng công khai đã xác minh + việc làm đã xuất bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc bản chiếu tổ chức công khai; không bao giờ trả thành viên, thanh toán hoặc tài liệu xác minh

- Operations/observability contract: CDN 5 phút
