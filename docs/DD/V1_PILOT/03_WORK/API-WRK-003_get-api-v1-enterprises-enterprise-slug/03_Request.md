...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/enterprises/{enterpriseSlug}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `enterpriseSlug` | `enterpriseSlug` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
> Slug → hồ sơ nhà tuyển dụng công khai đã xác minh + việc làm đã xuất bản
