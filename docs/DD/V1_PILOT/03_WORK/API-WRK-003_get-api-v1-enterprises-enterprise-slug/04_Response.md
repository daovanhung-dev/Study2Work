...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | hồ sơ nhà tuyển dụng công khai đã xác minh + việc làm đã xuất bản | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> hồ sơ nhà tuyển dụng công khai đã xác minh + việc làm đã xuất bản
...
{
  "success": false,
  "businessCode": "ENTERPRISE_NOT_FOUND",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
