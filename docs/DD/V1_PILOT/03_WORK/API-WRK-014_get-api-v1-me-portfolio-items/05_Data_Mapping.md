...
format: "markdown"
dd_id: "API-WRK-014"
api_name: "GET /api/v1/me/portfolio-items"
...
| Trang/loại | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | mục hồ sơ năng lực | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/loại → mục hồ sơ năng lực.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc theo chủ sở hữu/thứ tự
