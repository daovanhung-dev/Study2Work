...
| Purpose | biên nhận |
| Consumer/Actor | Người tham gia |
| Authentication | Người tham gia |
| Authorization | Người tham gia |
...
| Side effects | Lặp an toàn; sự kiện biên nhận WebSocket |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L271` — endpoint contract.
