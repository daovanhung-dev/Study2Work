...
| API ID | `API-WRK-033` |
| API name | `POST /api/v1/applications/{id}/conversation/read-receipts` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/applications/{id}/conversation/read-receipts` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L271`.
