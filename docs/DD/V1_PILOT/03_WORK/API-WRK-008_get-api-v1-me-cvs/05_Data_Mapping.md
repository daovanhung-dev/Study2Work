...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | siêu dữ liệu CV/phiên bản mặc định/đã xuất bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang → siêu dữ liệu CV/phiên bản mặc định/đã xuất bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc các hàng CV ổn định và phiên bản theo chủ sở hữu; không có URL công khai
