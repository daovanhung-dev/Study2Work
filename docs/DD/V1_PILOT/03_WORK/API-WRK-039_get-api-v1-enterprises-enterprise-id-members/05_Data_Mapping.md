...
format: "markdown"
dd_id: "API-WRK-039"
api_name: "GET /api/v1/enterprises/{enterpriseId}/members"
...
| Trang/trạng thái/vai trò | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thành viên | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-003`.
...
- Endpoint input contract: Trang/trạng thái/vai trò → thành viên.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chỉ mục ghép `(enterprise_id,status,created_at)`; chỉ hiển thị tối thiểu thông tin liên hệ

- Operations/observability contract: Riêng tư; kiểm toán truy cập
