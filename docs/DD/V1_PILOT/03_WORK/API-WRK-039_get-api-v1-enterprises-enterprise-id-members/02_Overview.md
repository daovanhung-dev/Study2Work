...
| Purpose | thành viên |
| Consumer/Actor | `PERM-WRK-003` |
| Authentication | `PERM-WRK-003` |
| Authorization | `PERM-WRK-003` |
...
| Side effects | Riêng tư; kiểm toán truy cập |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L295` — endpoint contract.
