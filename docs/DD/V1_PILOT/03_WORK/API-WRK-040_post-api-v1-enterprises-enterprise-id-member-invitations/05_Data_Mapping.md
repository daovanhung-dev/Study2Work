...
| Email, vai trò tổ chức, hết hạn <=7 ngày | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Email, vai trò tổ chức, hết hạn <=7 ngày → lời mời.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm giới hạn chỗ ngồi/vai trò; lưu hàm băm email + đích giao nhận mã hóa; mỗi email có một lời mời đang hoạt động

- Operations/observability contract: Khóa lặp; hộp thư đi giao nhận/kiểm toán
