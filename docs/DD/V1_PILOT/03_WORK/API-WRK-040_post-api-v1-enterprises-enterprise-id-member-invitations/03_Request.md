...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/member-invitations` |
...
| ---: | --- | --- | --- |
| 1 | Email, vai trò tổ chức, hết hạn <=7 ngày | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Email, vai trò tổ chức, hết hạn <=7 ngày → lời mời
