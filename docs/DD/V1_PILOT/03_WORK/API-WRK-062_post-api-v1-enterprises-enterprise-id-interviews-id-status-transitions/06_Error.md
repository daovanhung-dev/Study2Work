...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `INVALID_INTERVIEW_TRANSITION` | As specified by API catalog. | `SOURCE_REQUIRED` | `INVALID_INTERVIEW_TRANSITION` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L337` |
| 2 | Endpoint business/error code | DIRECT | `INTERVIEW_TOO_EARLY` | As specified by API catalog. | `SOURCE_REQUIRED` | `INTERVIEW_TOO_EARLY` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L337` |
