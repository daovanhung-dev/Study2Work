...
| API ID | `API-WRK-062` |
| API name | `POST /api/v1/enterprises/{enterpriseId}/interviews/{id}/status-transitions` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/interviews/{id}/status-transitions` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L337`.
