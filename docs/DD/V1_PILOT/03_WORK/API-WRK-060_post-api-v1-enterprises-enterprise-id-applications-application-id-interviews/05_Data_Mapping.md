...
format: "markdown"
dd_id: "API-WRK-060"
api_name: "POST /api/v1/enterprises/{enterpriseId}/applications/{applicationId}/interviews"
...
| `enterpriseId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| `applicationId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Bắt đầu/kết thúc UTC, múi giờ, ID người tham gia nội bộ, hình thức/văn bản cuộc họp, hạn phản hồi ứng viên | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lịch phỏng vấn v1 | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Nhà tuyển dụng được phân công + `PERM-WRK-040`.
...
- Endpoint input contract: Bắt đầu/kết thúc UTC, múi giờ, ID người tham gia nội bộ, hình thức/văn bản cuộc họp, hạn phản hồi ứng viên → lịch phỏng vấn v1.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm đơn chưa kết thúc và người tham gia cùng tổ chức; cảnh báo trùng lịch không chặn; tạo phỏng vấn/lịch/sự kiện; không tích hợp Google/MS

- Operations/observability contract: Khóa lặp; hộp thư đi ICS/thông báo; kiểm toán
