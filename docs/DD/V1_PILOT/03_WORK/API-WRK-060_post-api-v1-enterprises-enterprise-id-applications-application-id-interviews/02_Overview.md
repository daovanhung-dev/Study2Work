...
| Module | `Work` |
| Method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/interviews` |
| Purpose | lịch phỏng vấn v1 |
| Consumer/Actor | Nhà tuyển dụng được phân công + `PERM-WRK-040` |
| Authentication | Nhà tuyển dụng được phân công + `PERM-WRK-040` |
| Authorization | Nhà tuyển dụng được phân công + `PERM-WRK-040` |
...
| Side effects | Khóa lặp; hộp thư đi ICS/thông báo; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L335` — endpoint contract.
