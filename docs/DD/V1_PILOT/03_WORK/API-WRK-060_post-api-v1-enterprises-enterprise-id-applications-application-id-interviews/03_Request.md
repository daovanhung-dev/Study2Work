...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/interviews` |
...
| ---: | --- | --- | --- |
| 1 | Bắt đầu/kết thúc UTC, múi giờ, ID người tham gia nội bộ, hình thức/văn bản cuộc họp, hạn phản hồi ứng viên | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Bắt đầu/kết thúc UTC, múi giờ, ID người tham gia nội bộ, hình thức/văn bản cuộc họp, hạn phản hồi ứng viên → lịch phỏng vấn v1
