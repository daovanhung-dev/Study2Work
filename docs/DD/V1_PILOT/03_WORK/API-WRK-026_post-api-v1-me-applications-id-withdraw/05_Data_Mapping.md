...
format: "markdown"
dd_id: "API-WRK-026"
api_name: "POST /api/v1/me/applications/{id}/withdraw"
...
| Lý do/danh mục | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | `WITHDRAWN` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Lý do/danh mục → `WITHDRAWN`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa đơn ứng tuyển; chỉ cho phép trước `HIRED` hoặc trạng thái kết thúc; thêm sự kiện ATS; đặt cuộc hội thoại chỉ đọc; hủy phỏng vấn qua hộp thư đi

- Operations/observability contract: Khóa lặp bắt buộc; thông báo/kiểm toán
