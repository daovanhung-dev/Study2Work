...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/applications/{id}/withdraw` |
...
| ---: | --- | --- | --- |
| 1 | Lý do/danh mục | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Lý do/danh mục → `WITHDRAWN`
