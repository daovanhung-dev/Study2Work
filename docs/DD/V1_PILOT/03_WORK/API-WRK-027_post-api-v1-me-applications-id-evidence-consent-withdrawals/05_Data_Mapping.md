...
format: "markdown"
dd_id: "API-WRK-027"
api_name: "POST /api/v1/me/applications/{id}/evidence-consent-withdrawals"
...
| ID minh chứng hoặc tất cả, lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thời điểm ẩn | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chủ sở hữu + xác minh tăng cường.
...
- Endpoint input contract: ID minh chứng hoặc tất cả, lý do → thời điểm ẩn.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thêm sự kiện rút đồng ý; ẩn ngay các ảnh chụp đã chọn; hộp thư đi làm mới giao diện nhà tuyển dụng; ảnh chụp vẫn được mã hóa để kiểm toán/lưu giữ nhưng không thể truy cập

- Operations/observability contract: Khóa lặp; kiểm toán/sự kiện riêng tư
