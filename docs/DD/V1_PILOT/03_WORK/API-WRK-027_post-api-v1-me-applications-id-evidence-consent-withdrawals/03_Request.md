...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/applications/{id}/evidence-consent-withdrawals` |
...
| ---: | --- | --- | --- |
| 1 | ID minh chứng hoặc tất cả, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID minh chứng hoặc tất cả, lý do → thời điểm ẩn
