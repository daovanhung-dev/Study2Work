...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `EVIDENCE_NOT_SELECTED` | As specified by API catalog. | `SOURCE_REQUIRED` | `EVIDENCE_NOT_SELECTED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L265` |
| 2 | Endpoint business/error code | DIRECT | `CONSENT_ALREADY_WITHDRAWN` | As specified by API catalog. | `SOURCE_REQUIRED` | `CONSENT_ALREADY_WITHDRAWN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L265` |
