...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `JOB_NOT_ACCEPTING_APPLICATIONS` | As specified by API catalog. | `SOURCE_REQUIRED` | `JOB_NOT_ACCEPTING_APPLICATIONS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L260` |
| 2 | Endpoint business/error code | DIRECT | `APPLICATION_ALREADY_EXISTS` | As specified by API catalog. | `409` | `APPLICATION_ALREADY_EXISTS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L260` |
| 3 | Endpoint business/error code | DIRECT | `PROFILE_REQUIREMENT_FAILED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PROFILE_REQUIREMENT_FAILED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L260` |
