...
| Purpose | điều kiện đủ, câu hỏi, bản sửa đổi hiện hành, CV mặc định, trạng thái tích hợp minh chứng |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L260` — endpoint contract.
