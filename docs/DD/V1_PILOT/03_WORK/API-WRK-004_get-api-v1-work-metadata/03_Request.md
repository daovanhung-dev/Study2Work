...
| ---: | --- | --- | --- |
| 1 | Nhóm tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Nhóm tùy chọn → kỹ năng, ngành, địa điểm, hình thức làm việc/tuyển dụng
