...
| Purpose | kỹ năng, ngành, địa điểm, hình thức làm việc/tuyển dụng |
...
| Side effects | Bộ nhớ đệm 10 phút, ETag |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L232` — endpoint contract.
