...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | phiên bản lịch bất biến mới | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
{
  "success": false,
  "businessCode": "INTERVIEW_VERSION_CONFLICT",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
