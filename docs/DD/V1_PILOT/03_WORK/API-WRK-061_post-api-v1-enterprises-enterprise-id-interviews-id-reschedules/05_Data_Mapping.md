...
format: "markdown"
dd_id: "API-WRK-061"
api_name: "POST /api/v1/enterprises/{enterpriseId}/interviews/{id}/reschedules"
...
| `scheduleVersion` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| hiện hành, khung giờ/lý do mới | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phiên bản lịch bất biến mới | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Nhà tuyển dụng được phân công.
...
- Endpoint input contract: `scheduleVersion` hiện hành, khung giờ/lý do mới → phiên bản lịch bất biến mới.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa phỏng vấn; thay thế lịch hiện hành; tăng phiên bản; xác nhận của ứng viên đặt lại thành `PENDING`

- Operations/observability contract: Khóa lặp; `SEQUENCE` ICS/thông báo/kiểm toán
