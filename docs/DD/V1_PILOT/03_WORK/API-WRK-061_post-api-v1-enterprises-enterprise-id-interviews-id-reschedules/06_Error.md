...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `INTERVIEW_VERSION_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `INTERVIEW_VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L336` |
| 2 | Endpoint business/error code | DIRECT | `INTERVIEW_TERMINAL` | As specified by API catalog. | `SOURCE_REQUIRED` | `INTERVIEW_TERMINAL` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L336` |
