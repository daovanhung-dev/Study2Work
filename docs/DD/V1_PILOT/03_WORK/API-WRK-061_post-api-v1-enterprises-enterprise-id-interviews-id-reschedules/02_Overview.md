...
| Module | `Work` |
| Method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/interviews/{id}/reschedules` |
| Purpose | phiên bản lịch bất biến mới |
| Consumer/Actor | Nhà tuyển dụng được phân công |
| Authentication | Nhà tuyển dụng được phân công |
| Authorization | Nhà tuyển dụng được phân công |
...
| Side effects | Khóa lặp; `SEQUENCE` ICS/thông báo/kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L336` — endpoint contract.
