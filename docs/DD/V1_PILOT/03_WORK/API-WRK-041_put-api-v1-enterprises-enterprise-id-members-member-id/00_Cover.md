...
| API ID | `API-WRK-041` |
| API name | `PUT /api/v1/enterprises/{enterpriseId}/members/{memberId}` |
| HTTP method | `PUT` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/members/{memberId}` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L297`.
