...
| Purpose | tư cách thành viên |
| Consumer/Actor | `PERM-WRK-004` + MFA |
| Authentication | `PERM-WRK-004` + MFA |
| Authorization | `PERM-WRK-004` + MFA |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L297` — endpoint contract.
