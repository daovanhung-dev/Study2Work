...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/interviews/{id}/responses` |
...
| ---: | --- | --- | --- |
| 1 | Phiên bản lịch; xác nhận, từ chối hoặc yêu cầu đổi lịch; khung giờ thay thế/lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phiên bản lịch; xác nhận, từ chối hoặc yêu cầu đổi lịch; khung giờ thay thế/lý do → phỏng vấn
