...
| Purpose | bản nháp |
| Consumer/Actor | Tác giả/`PERM-WRK-011` |
| Authentication | Tác giả/`PERM-WRK-011` |
| Authorization | Tác giả/`PERM-WRK-011` |
...
| Side effects | Tự lưu; kiểm toán chênh lệch; chưa lập chỉ mục đến khi xuất bản |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L306` — endpoint contract.
