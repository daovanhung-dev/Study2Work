...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `FILE_NOT_CLEAN` | As specified by API catalog. | `409` | `FILE_NOT_CLEAN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L294` |
| 2 | Endpoint business/error code | DIRECT | `VERIFICATION_ALREADY_PENDING` | As specified by API catalog. | `SOURCE_REQUIRED` | `VERIFICATION_ALREADY_PENDING` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L294` |
