...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/verification-submissions` |
...
| ---: | --- | --- | --- |
| 1 | Thông tin pháp lý, ID tài liệu riêng tư , sự đồng ý | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Thông tin pháp lý, ID tài liệu riêng tư `CLEAN`, sự đồng ý → hồ sơ `SUBMITTED`
