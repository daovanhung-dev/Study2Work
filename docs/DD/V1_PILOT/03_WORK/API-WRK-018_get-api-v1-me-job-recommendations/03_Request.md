...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/me/job-recommendations` |
...
| ---: | --- | --- | --- |
| 1 | Trang/bộ lọc | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/bộ lọc → gợi ý tự nhiên có giải thích + tài trợ gắn nhãn riêng
