...
| Module | `Work` |
| Method | `GET` |
| Endpoint | `/api/v1/me/job-recommendations` |
| Purpose | gợi ý tự nhiên có giải thích + tài trợ gắn nhãn riêng |
| Consumer/Actor | Ứng viên |
| Authentication | Ứng viên |
| Authorization | Ứng viên |
...
| Side effects | Bộ nhớ đệm riêng tư 15 phút, làm mới khi hồ sơ/việc làm đổi |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L251` — endpoint contract.
