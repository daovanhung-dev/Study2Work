...
format: "markdown"
dd_id: "API-WRK-018"
api_name: "GET /api/v1/me/job-recommendations"
...
| Trang/bộ lọc | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | gợi ý tự nhiên có giải thích + tài trợ gắn nhãn riêng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/bộ lọc → gợi ý tự nhiên có giải thích + tài trợ gắn nhãn riêng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc việc làm đang hoạt động/bản chiếu kỹ năng hồ sơ/ảnh chụp đối sánh; loại trường nhạy cảm/được bảo vệ; chèn tài trợ riêng

- Operations/observability contract: Bộ nhớ đệm riêng tư 15 phút, làm mới khi hồ sơ/việc làm đổi
