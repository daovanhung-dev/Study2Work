...
format: "markdown"
dd_id: "API-WRK-048"
api_name: "POST /api/v1/enterprises/{enterpriseId}/jobs/{jobId}/pause"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | `PAUSED` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Lý do, `If-Match` → `PAUSED`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX chuyển hợp lệ `PUBLISHED→PAUSED`; gỡ công khai/chỉ mục bất đồng bộ nhưng điều kiện API ẩn ngay
