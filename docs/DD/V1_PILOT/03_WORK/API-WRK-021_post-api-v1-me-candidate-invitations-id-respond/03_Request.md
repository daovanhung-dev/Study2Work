...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/candidate-invitations/{id}/respond` |
...
| ---: | --- | --- | --- |
| 1 | /, lý do tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> `ACCEPTED`/`DECLINED`, lý do tùy chọn → lời mời; chấp thuận chỉ trả URL ứng tuyển
