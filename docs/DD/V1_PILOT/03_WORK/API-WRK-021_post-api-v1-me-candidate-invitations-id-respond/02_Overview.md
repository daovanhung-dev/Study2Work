...
| Purpose | lời mời; chấp thuận chỉ trả URL ứng tuyển |
| Consumer/Actor | Người được mời |
| Authentication | Người được mời |
| Authorization | Người được mời |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L254` — endpoint contract.
