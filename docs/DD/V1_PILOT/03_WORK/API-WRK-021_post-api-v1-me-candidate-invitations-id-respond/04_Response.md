...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | lời mời; chấp thuận chỉ trả URL ứng tuyển | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> lời mời; chấp thuận chỉ trả URL ứng tuyển
...
{
  "success": false,
  "businessCode": "INVITATION_EXPIRED",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
