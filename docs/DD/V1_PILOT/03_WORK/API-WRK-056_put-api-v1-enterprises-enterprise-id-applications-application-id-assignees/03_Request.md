...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/assignees` |
...
| ---: | --- | --- | --- |
| 1 | ID thành viên đang hoạt động | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID thành viên đang hoạt động, `If-Match` → phân công
