...
format: "markdown"
dd_id: "API-WRK-037"
api_name: "PATCH /api/v1/enterprises/{enterpriseId}"
...
| Trường công khai/liên hệ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-WRK-001`.
...
- Endpoint input contract: Trường công khai/liên hệ, `If-Match` → hồ sơ.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX điều kiện tổ chức; trường pháp lý sau khi đã xác minh cần hồ sơ xác minh mới

- Operations/observability contract: Khóa lặp; kiểm toán trước/sau
