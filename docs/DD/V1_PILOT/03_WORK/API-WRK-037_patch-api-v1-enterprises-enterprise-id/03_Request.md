...
| ---: | --- |
| HTTP method | `PATCH` |
| URI | `/api/v1/enterprises/{enterpriseId}` |
...
| ---: | --- | --- | --- |
| 1 | Trường công khai/liên hệ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trường công khai/liên hệ, `If-Match` → hồ sơ
