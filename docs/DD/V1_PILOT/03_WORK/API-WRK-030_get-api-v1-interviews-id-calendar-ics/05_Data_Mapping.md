...
format: "markdown"
dd_id: "API-WRK-030"
api_name: "GET /api/v1/interviews/{id}/calendar.ics"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tệp lịch ICS hiện hành | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người tham gia phỏng vấn; cho phép liên kết có chữ ký dùng một lần.
...
- Endpoint input contract: → tệp lịch ICS hiện hành.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm quyền người tham gia; tạo UID ổn định và `SEQUENCE` theo phiên bản lịch; không tích hợp OAuth lịch ngoài

- Operations/observability contract: Riêng tư, không lưu; kiểm toán truy cập
