...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CV_REVISION_NOT_EDITABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `CV_REVISION_NOT_EDITABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L243` |
| 2 | Endpoint business/error code | DIRECT | `VERSION_CONFLICT` | As specified by API catalog. | `412` | `VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L243` |
