...
format: "markdown"
dd_id: "API-WRK-019"
api_name: "PUT /api/v1/me/saved-jobs/{jobId}"
...
| `saved` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
...
- Endpoint input contract: `saved` → trạng thái.

<a id="s04"></a>
### S04. Execute source-defined processing

> Cập nhật chèn/xóa liên kết trình bày theo chủ sở hữu/việc làm; việc làm kết thúc vẫn có thể được lưu kèm trạng thái
