...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CANDIDATE_NOT_SEARCHABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `CANDIDATE_NOT_SEARCHABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L321` |
| 2 | Endpoint business/error code | DIRECT | `INVITATION_EXISTS` | As specified by API catalog. | `SOURCE_REQUIRED` | `INVITATION_EXISTS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L321` |
| 3 | Endpoint business/error code | DIRECT | `ENTITLEMENT_INSUFFICIENT` | As specified by API catalog. | `409` | `ENTITLEMENT_INSUFFICIENT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L321` |
