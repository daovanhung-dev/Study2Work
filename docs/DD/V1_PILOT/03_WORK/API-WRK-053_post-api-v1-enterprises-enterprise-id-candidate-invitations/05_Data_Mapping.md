...
| ID công khai ứng viên, việc làm đã xuất bản, tin nhắn <=1000 | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-WRK-021`.
...
- Endpoint input contract: ID công khai ứng viên, việc làm đã xuất bản, tin nhắn <=1000 → lời mời.

<a id="s04"></a>
### S04. Execute source-defined processing

> Phân giải ứng viên đã đồng ý; kiểm việc làm cùng tổ chức đang nhận đơn; tạo lời mời mở duy nhất ứng viên/việc làm/tổ chức; không tạo trò chuyện/đơn ứng tuyển

- Operations/observability contract: Khóa lặp; trừ quyền sử dụng lời mời; thông báo/kiểm toán
