...
| ---: | --- | --- | --- |
| 1 | Tên pháp lý/công khai, ID thuế, liên hệ, điều khoản | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Tên pháp lý/công khai, ID thuế, liên hệ, điều khoản → tổ chức `PENDING_VERIFICATION` + tư cách thành viên chủ sở hữu
