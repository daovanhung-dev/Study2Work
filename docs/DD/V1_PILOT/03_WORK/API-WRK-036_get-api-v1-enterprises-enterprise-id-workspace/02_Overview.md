...
| Purpose | hồ sơ tổ chức, xác minh, quyền của mình, gói/giới hạn |
| Consumer/Actor | Thành viên đang hoạt động |
| Authentication | Thành viên đang hoạt động |
| Authorization | Thành viên đang hoạt động |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L292` — endpoint contract.
