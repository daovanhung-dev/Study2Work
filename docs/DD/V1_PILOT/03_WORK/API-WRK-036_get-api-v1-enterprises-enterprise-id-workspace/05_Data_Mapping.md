...
format: "markdown"
dd_id: "API-WRK-036"
api_name: "GET /api/v1/enterprises/{enterpriseId}/workspace"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ tổ chức, xác minh, quyền của mình, gói/giới hạn | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Thành viên đang hoạt động.
...
- Endpoint input contract: → hồ sơ tổ chức, xác minh, quyền của mình, gói/giới hạn.

<a id="s04"></a>
### S04. Execute source-defined processing

> Mọi truy vấn có điều kiện tổ chức+tư cách thành viên đang hoạt động
