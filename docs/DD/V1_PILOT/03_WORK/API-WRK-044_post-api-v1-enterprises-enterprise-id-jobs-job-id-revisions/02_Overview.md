...
| Purpose | bản sửa đổi `DRAFT` |
| Consumer/Actor | `PERM-WRK-011` |
| Authentication | `PERM-WRK-011` |
| Authorization | `PERM-WRK-011` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L305` — endpoint contract.
