...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `DRAFT_ALREADY_EXISTS` | As specified by API catalog. | `SOURCE_REQUIRED` | `DRAFT_ALREADY_EXISTS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L305` |
| 2 | Endpoint business/error code | DIRECT | `BASE_REVISION_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `BASE_REVISION_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L305` |
