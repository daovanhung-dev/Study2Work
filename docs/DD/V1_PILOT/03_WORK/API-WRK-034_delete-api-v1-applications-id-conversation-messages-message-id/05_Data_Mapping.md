...
format: "markdown"
dd_id: "API-WRK-034"
api_name: "DELETE /api/v1/applications/{id}/conversation/messages/{messageId}"
...
| `messageId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản ghi che | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Tác giả tin nhắn trong 15 phút hoặc người kiểm duyệt.
...
- Endpoint input contract: Lý do → bản ghi che.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX giữ sự kiện/hàm băm nội dung/trình tự bất biến, ẩn thân văn bản khỏi lượt đọc thông thường; người kiểm duyệt phải có lý do

- Operations/observability contract: Lặp an toàn; sự kiện/kiểm toán kiểm duyệt
