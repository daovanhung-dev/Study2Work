...
| Module | `Work` |
| Method | `DELETE` |
| Endpoint | `/api/v1/applications/{id}/conversation/messages/{messageId}` |
| Purpose | bản ghi che |
| Consumer/Actor | Tác giả tin nhắn trong 15 phút hoặc người kiểm duyệt |
| Authentication | Tác giả tin nhắn trong 15 phút hoặc người kiểm duyệt |
| Authorization | Tác giả tin nhắn trong 15 phút hoặc người kiểm duyệt |
...
| Side effects | Lặp an toàn; sự kiện/kiểm toán kiểm duyệt |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L272` — endpoint contract.
