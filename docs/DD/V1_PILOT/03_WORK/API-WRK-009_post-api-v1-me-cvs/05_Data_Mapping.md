...
| Tên, ID mẫu, ngôn ngữ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | CV + bản sửa đổi `DRAFT` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Tên, ID mẫu, ngôn ngữ → CV + bản sửa đổi `DRAFT`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm hạn mức/quyền sử dụng; tạo CV/bản sửa đổi ổn định với các phần đã định kiểu rỗng
