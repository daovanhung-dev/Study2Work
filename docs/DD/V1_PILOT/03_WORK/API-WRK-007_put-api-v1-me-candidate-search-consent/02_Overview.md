...
| Module | `Work` |
| Method | `PUT` |
| Endpoint | `/api/v1/me/candidate-search-consent` |
| Purpose | trạng thái |
| Consumer/Actor | Ứng viên + xác minh tăng cường khi cho phép |
| Authentication | Ứng viên + xác minh tăng cường khi cho phép |
| Authorization | Ứng viên + xác minh tăng cường khi cho phép |
...
| Side effects | Khóa lặp; kiểm toán đồng ý; SLO gỡ chỉ mục <=5 phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L240` — endpoint contract.
