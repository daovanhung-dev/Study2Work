...
| Purpose | `PUBLISHED` |
| Consumer/Actor | `PERM-WRK-013`; cấp tin cậy hoặc duyệt đã chấp thuận |
| Authentication | `PERM-WRK-013`; cấp tin cậy hoặc duyệt đã chấp thuận |
| Authorization | `PERM-WRK-013`; cấp tin cậy hoặc duyệt đã chấp thuận |
...
| Side effects | Khóa lặp; hộp thư đi xuất bản/lập chỉ mục tìm kiếm/kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L308` — endpoint contract.
