...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/enterprises/{enterpriseId}/applications` |
...
| ---: | --- | --- | --- |
| 1 | Trang/việc làm/trạng thái/người được giao/ngày/ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/việc làm/trạng thái/người được giao/ngày/`q` → hàng ATS
