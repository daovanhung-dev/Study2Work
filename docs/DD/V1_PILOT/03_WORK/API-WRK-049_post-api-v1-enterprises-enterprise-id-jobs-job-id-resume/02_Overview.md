...
| Purpose | `PUBLISHED` |
| Consumer/Actor | `PERM-WRK-013` |
| Authentication | `PERM-WRK-013` |
| Authorization | `PERM-WRK-013` |
...
| Side effects | Khóa lặp; kiểm toán/chỉ mục |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L310` — endpoint contract.
