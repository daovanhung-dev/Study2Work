...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | lịch sử và bản ghi che theo thứ tự | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> lịch sử và bản ghi che theo thứ tự
...
{
  "success": false,
  "businessCode": "CONVERSATION_NOT_AVAILABLE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
