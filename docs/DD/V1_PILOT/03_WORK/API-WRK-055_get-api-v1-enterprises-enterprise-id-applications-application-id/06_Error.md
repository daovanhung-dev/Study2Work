...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `APPLICATION_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `APPLICATION_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L323` |
| 2 | Endpoint business/error code | DIRECT | `EVIDENCE_ACCESS_WITHDRAWN` | As specified by API catalog. | `SOURCE_REQUIRED` | `EVIDENCE_ACCESS_WITHDRAWN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L323` |
