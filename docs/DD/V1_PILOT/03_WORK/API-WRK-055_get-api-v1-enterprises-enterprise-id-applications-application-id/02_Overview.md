...
| Module | `Work` |
| Method | `GET` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}` |
| Purpose | ảnh chụp bất biến, câu trả lời, lịch sử, trạng thái minh chứng, phỏng vấn/trò chuyện; chỉ có liên hệ sau khi ứng tuyển |
| Consumer/Actor | Nhà tuyển dụng được phân công hoặc `PERM-WRK-031` |
| Authentication | Nhà tuyển dụng được phân công hoặc `PERM-WRK-031` |
| Authorization | Nhà tuyển dụng được phân công hoặc `PERM-WRK-031` |
...
| Side effects | Kiểm toán truy cập PII; không lưu |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L323` — endpoint contract.
