...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | ảnh chụp bất biến, câu trả lời, lịch sử, trạng thái minh chứng, phỏng vấn/trò chuyện; chỉ có liên hệ sau khi ứng tuyển | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> ảnh chụp bất biến, câu trả lời, lịch sử, trạng thái minh chứng, phỏng vấn/trò chuyện; chỉ có liên hệ sau khi ứng tuyển
