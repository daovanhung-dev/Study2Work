...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái/ngày | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái/ngày → thẻ đơn ứng tuyển
