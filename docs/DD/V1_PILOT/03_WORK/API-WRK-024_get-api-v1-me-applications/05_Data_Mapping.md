...
format: "markdown"
dd_id: "API-WRK-024"
api_name: "GET /api/v1/me/applications"
...
| Trang/trạng thái/ngày | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thẻ đơn ứng tuyển | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/trạng thái/ngày → thẻ đơn ứng tuyển.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn `(candidate_id,status,submitted_at desc)` + ảnh chụp việc làm bất biến
