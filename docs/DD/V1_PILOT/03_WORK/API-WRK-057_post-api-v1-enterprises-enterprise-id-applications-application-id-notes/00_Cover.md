...
| API ID | `API-WRK-057` |
| API name | `POST /api/v1/enterprises/{enterpriseId}/applications/{applicationId}/notes` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/notes` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L325`.
