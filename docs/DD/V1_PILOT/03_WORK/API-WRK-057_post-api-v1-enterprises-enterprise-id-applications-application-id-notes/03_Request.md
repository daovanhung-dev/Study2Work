...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/notes` |
...
| ---: | --- | --- | --- |
| 1 | Văn bản <=5000, mức hiển thị , tệp sạch tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Văn bản <=5000, mức hiển thị `INTERNAL`, tệp sạch tùy chọn → ghi chú
