...
format: "markdown"
dd_id: "API-WRK-020"
api_name: "GET /api/v1/me/candidate-invitations"
...
| Trang/trạng thái | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Trang/trạng thái → lời mời.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn ứng viên/trạng thái/thời điểm tạo; lời mời có việc làm/tổ chức của nhà tuyển dụng nhưng không tạo cuộc trò chuyện
