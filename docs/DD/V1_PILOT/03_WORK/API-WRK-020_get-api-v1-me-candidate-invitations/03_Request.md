...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/me/candidate-invitations` |
...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái → lời mời
