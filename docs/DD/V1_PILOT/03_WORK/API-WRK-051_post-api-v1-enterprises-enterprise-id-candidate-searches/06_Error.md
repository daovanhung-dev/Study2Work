...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SEARCH_ENTITLEMENT_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `SEARCH_ENTITLEMENT_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L319` |
| 2 | Endpoint business/error code | DIRECT | `FILTER_NOT_ALLOWED` | As specified by API catalog. | `SOURCE_REQUIRED` | `FILTER_NOT_ALLOWED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L319` |
| 3 | Endpoint business/error code | DIRECT | `CONSENT_INDEX_LAG` | As specified by API catalog. | `SOURCE_REQUIRED` | `CONSENT_INDEX_LAG` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L319` |
