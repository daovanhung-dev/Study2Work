...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/candidate-searches` |
...
| ---: | --- | --- | --- |
| 1 | Bộ lọc/từ khóa/trang | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Bộ lọc/từ khóa/trang → ứng viên đã che dữ liệu + giải thích đối sánh tự nhiên; hồ sơ tài trợ riêng/gắn nhãn
