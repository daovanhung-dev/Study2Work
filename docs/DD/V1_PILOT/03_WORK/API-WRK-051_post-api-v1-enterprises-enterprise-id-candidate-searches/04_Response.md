...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | ứng viên đã che dữ liệu + giải thích đối sánh tự nhiên; hồ sơ tài trợ riêng/gắn nhãn | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> ứng viên đã che dữ liệu + giải thích đối sánh tự nhiên; hồ sơ tài trợ riêng/gắn nhãn
...
{
  "success": false,
  "businessCode": "SEARCH_ENTITLEMENT_REQUIRED",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
