...
| Bản sửa đổi/phiên bản, tuyên bố, quyền | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | `REVIEW_PENDING` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-012`.
...
- Endpoint input contract: Bản sửa đổi/phiên bản, tuyên bố, quyền → `REVIEW_PENDING`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm tính đầy đủ, tổ chức đã xác minh, quyền sử dụng; thêm hồ sơ duyệt; vòng đời ổn định `REVIEW_PENDING`

- Operations/observability contract: Khóa lặp; hộp thư đi người duyệt/kiểm toán
