...
format: "markdown"
dd_id: "API-WRK-042"
api_name: "GET /api/v1/enterprises/{enterpriseId}/jobs"
...
| Trang/vòng đời//chủ sở hữu | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | việc làm/bản sửa đổi hiện hành | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-010`.
...
- Endpoint input contract: Trang/vòng đời/`q`/chủ sở hữu → việc làm/bản sửa đổi hiện hành.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện tổ chức + `(enterprise_id,lifecycle,updated_at)`

- Operations/observability contract: Riêng tư
