...
| ---: | --- | --- | --- |
| 1 | Trang/vòng đời//chủ sở hữu | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/vòng đời/`q`/chủ sở hữu → việc làm/bản sửa đổi hiện hành
