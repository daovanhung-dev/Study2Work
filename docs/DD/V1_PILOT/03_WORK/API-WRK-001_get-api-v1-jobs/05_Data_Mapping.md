...
| `workMode` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| `employmentType` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| Trang, , địa điểm, , , kinh nghiệm, kỹ năng, khoảng lương, sắp xếp | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thẻ việc làm có nhãn | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Công khai.
...
- Endpoint input contract: Trang, `q`, địa điểm, `workMode`, `employmentType`, kinh nghiệm, kỹ năng, khoảng lương, sắp xếp → thẻ việc làm có nhãn.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chỉ đọc bản sửa đổi bất biến hiện hành `PUBLISHED`, bản chiếu công khai doanh nghiệp, khuyến mãi đang hoạt động; FTS/trigram cùng chỉ mục lọc. Điểm tự nhiên tính riêng; vị trí tài trợ được chèn và gắn nhãn, không đổi điểm

- Operations/observability contract: CDN 60 giây; ETag; giới hạn ẩn danh
