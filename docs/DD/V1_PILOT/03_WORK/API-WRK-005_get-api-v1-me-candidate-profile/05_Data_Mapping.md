...
format: "markdown"
dd_id: "API-WRK-005"
api_name: "GET /api/v1/me/candidate-profile"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ, độ hoàn thiện, trạng thái/phiên bản riêng tư/tìm kiếm | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → hồ sơ, độ hoàn thiện, trạng thái/phiên bản riêng tư/tìm kiếm.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc hồ sơ/kỹ năng/kinh nghiệm/học vấn ứng viên; thông tin liên hệ vẫn ở Identity và không được sao chép vào tài liệu tìm kiếm
