...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `jobSlug` | `jobSlug` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
> Slug → bản sửa đổi đã xuất bản, doanh nghiệp, thời hạn, nhãn tài trợ
