...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `VERSION_CONFLICT` | As specified by API catalog. | `412` | `VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L249` |
| 2 | Endpoint business/error code | DIRECT | `PORTFOLIO_ITEM_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `PORTFOLIO_ITEM_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L249` |
