...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/applications/{applicationId}/offers` |
...
| ---: | --- | --- | --- |
| 1 | Đề nghị có cấu trúc, hết hạn, tài liệu sạch | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Đề nghị có cấu trúc, hết hạn, tài liệu sạch → ảnh chụp `OFFERED`
