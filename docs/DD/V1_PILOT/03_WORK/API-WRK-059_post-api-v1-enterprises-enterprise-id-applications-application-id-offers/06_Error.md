...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `OFFER_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `OFFER_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L327` |
| 2 | Endpoint business/error code | DIRECT | `INVALID_APPLICATION_TRANSITION` | As specified by API catalog. | `409` | `INVALID_APPLICATION_TRANSITION` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L327` |
