...
| Purpose | ảnh chụp `OFFERED` |
| Consumer/Actor | `PERM-WRK-034` + được phân công |
| Authentication | `PERM-WRK-034` + được phân công |
| Authorization | `PERM-WRK-034` + được phân công |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L327` — endpoint contract.
