...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/me/cvs/{cvId}/exports` |
...
| ---: | --- | --- | --- |
| 1 | Định dạng PDF, phiên bản mẫu | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Định dạng PDF, phiên bản mẫu → tác vụ xuất bất đồng bộ
