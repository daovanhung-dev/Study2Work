...
| API ID | `API-WRK-043` |
| API name | `POST /api/v1/enterprises/{enterpriseId}/jobs` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/enterprises/{enterpriseId}/jobs` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L304`.
