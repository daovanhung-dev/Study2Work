...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `ENTERPRISE_NOT_VERIFIED` | As specified by API catalog. | `SOURCE_REQUIRED` | `ENTERPRISE_NOT_VERIFIED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L304` |
| 2 | Endpoint business/error code | DIRECT | `JOB_QUOTA_EXCEEDED` | As specified by API catalog. | `SOURCE_REQUIRED` | `JOB_QUOTA_EXCEEDED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L304` |
