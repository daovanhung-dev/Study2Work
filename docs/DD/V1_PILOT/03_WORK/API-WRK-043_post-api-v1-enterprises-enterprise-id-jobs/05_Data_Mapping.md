...
format: "markdown"
dd_id: "API-WRK-043"
api_name: "POST /api/v1/enterprises/{enterpriseId}/jobs"
...
| Tiêu đề, chủ sở hữu, JD có cấu trúc đầu tiên | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | việc làm ổn định + bản sửa đổi `DRAFT` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-011`.
...
- Endpoint input contract: Tiêu đề, chủ sở hữu, JD có cấu trúc đầu tiên → việc làm ổn định + bản sửa đổi `DRAFT`.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm tổ chức đã xác minh/quyền sử dụng; tạo việc làm/bản sửa đổi ổn định; làm sạch nội dung
