...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SEARCH_CONSENT_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `SEARCH_CONSENT_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L385` |
| 2 | Endpoint business/error code | DIRECT | `PROMOTION_ENTITLEMENT_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PROMOTION_ENTITLEMENT_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L385` |
