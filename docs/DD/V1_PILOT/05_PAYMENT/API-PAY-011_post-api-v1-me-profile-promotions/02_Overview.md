...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/me/profile-promotions` |
| Purpose | quảng bá hồ sơ tài trợ |
| Consumer/Actor | Ứng viên đã cho phép + quyền sử dụng |
| Authentication | Ứng viên đã cho phép + quyền sử dụng |
| Authorization | Ứng viên đã cho phép + quyền sử dụng |
...
| Side effects | Khóa lặp; kiểm toán/đồng ý |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L385` — endpoint contract.
