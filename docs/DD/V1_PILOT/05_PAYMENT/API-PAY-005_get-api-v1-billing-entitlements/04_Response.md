...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | số dư/cấp quyền/hết hạn | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
