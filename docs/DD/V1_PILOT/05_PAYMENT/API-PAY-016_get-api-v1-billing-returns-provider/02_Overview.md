...
| Module | `Payment` |
| Method | `GET` |
| Endpoint | `/api/v1/billing/returns/{provider}` |
| Purpose | tải tin trang trạng thái đã làm sạch |
| Consumer/Actor | Chuyển hướng trình duyệt |
| Authentication | Chuyển hướng trình duyệt |
| Authorization | Chuyển hướng trình duyệt |
...
| Side effects | Không cấp quyền sử dụng; không lưu |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L395` — endpoint contract.
