...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | tải tin trang trạng thái đã làm sạch | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> tải tin trang trạng thái đã làm sạch
...
{
  "success": false,
  "businessCode": "RETURN_REFERENCE_INVALID",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
