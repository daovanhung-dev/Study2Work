...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `RETURN_REFERENCE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `RETURN_REFERENCE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L395` |
