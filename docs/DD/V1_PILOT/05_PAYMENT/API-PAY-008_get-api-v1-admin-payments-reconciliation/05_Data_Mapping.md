...
| Trang/nhà cung cấp/ngày/trạng thái | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hàng đợi sai lệch | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-PAY-001` + MFA.
...
- Endpoint input contract: Trang/nhà cung cấp/ngày/trạng thái → hàng đợi sai lệch.

<a id="s04"></a>
### S04. Execute source-defined processing

> Nối sự kiện nhà cung cấp/đơn hàng/lượt thử/sổ cái theo chỉ mục khóa đơn nhà cung cấp

- Operations/observability contract: Không lưu đệm; mọi lần xuất đều kiểm toán
