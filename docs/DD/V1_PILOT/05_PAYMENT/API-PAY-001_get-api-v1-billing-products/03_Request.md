...
| ---: | --- | --- | --- |
| 1 | Đối tượng / | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Đối tượng `CANDIDATE`/`ENTERPRISE` → sản phẩm/giá/quyền lợi còn hiệu lực
