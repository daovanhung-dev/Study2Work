...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/webhooks/momo` |
| Purpose | xác nhận theo yêu cầu nhà cung cấp |
| Consumer/Actor | Chữ ký MoMo/IP là lớp phòng thủ bổ sung |
| Authentication | Chữ ký MoMo/IP là lớp phòng thủ bổ sung |
| Authorization | Chữ ký MoMo/IP là lớp phòng thủ bổ sung |
...
| Side effects | Khóa lặp webhook/kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L394` — endpoint contract.
