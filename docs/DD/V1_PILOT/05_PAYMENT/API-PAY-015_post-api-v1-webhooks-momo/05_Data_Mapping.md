...
format: "markdown"
dd_id: "API-PAY-015"
api_name: "POST /api/v1/webhooks/momo"
...
| JSON gốc đúng theo nhà cung cấp | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Chữ ký MoMo/IP là lớp phòng thủ bổ sung.
...
- Endpoint input contract: JSON gốc đúng theo nhà cung cấp → xác nhận theo yêu cầu nhà cung cấp.

<a id="s04"></a>
### S04. Execute source-defined processing

> Cùng bất biến; kiểm chữ ký và đối tác/đơn/yêu cầu/số tiền; sự kiện nhà cung cấp duy nhất; xử lý bất đồng bộ

- Operations/observability contract: Khóa lặp webhook/kiểm toán
