...
| ---: | --- | --- | --- |
| 1 | JSON gốc đúng theo nhà cung cấp | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> JSON gốc đúng theo nhà cung cấp → xác nhận theo yêu cầu nhà cung cấp
