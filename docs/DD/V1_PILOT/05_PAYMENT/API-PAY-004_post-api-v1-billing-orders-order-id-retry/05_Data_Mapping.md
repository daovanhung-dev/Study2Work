...
format: "markdown"
dd_id: "API-PAY-004"
api_name: "POST /api/v1/billing/orders/{orderId}/retry"
...
| `orderId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Nhà cung cấp tùy chọn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lượt thử mới | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Chủ sở hữu/thành viên lập hóa đơn.
...
- Endpoint input contract: Nhà cung cấp tùy chọn → lượt thử mới.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa đơn hàng; chỉ khi chưa thanh toán/chưa hết hạn; tạo lượt thử nhà cung cấp mới; phản hồi cũ chỉ quyết toán đơn khi số tiền/đơn hợp lệ và chưa có lượt nào quyết toán
