...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `ORDER_NOT_RETRYABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `ORDER_NOT_RETRYABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L378` |
| 2 | Endpoint business/error code | DIRECT | `ORDER_ALREADY_SETTLED` | As specified by API catalog. | `409` | `ORDER_ALREADY_SETTLED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L378` |
