...
format: "markdown"
dd_id: "API-PAY-013"
api_name: "POST /api/v1/promotions/{promotionId}/clicks"
...
> Như lượt hiển thị; danh sách đích chuyển hướng cho phép; thêm lượt nhấp

- Operations/observability contract: `202`; khử trùng lặp/giới hạn tần suất
