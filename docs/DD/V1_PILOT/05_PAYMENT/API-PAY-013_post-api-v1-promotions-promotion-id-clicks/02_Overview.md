...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/promotions/{promotionId}/clicks` |
...
| Side effects | `202`; khử trùng lặp/giới hạn tần suất |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L387` — endpoint contract.
