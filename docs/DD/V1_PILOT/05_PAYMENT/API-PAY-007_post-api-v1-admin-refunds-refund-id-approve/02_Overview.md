...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/refunds/{refundId}/approve` |
| Purpose | hoàn tiền đang xử lý |
| Consumer/Actor | `PERM-PAY-002` + MFA gần đây, không phải người yêu cầu |
| Authentication | `PERM-PAY-002` + MFA gần đây, không phải người yêu cầu |
| Authorization | `PERM-PAY-002` + MFA gần đây, không phải người yêu cầu |
...
| Side effects | Khóa lặp bắt buộc; kiểm toán tài chính bất biến |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L381` — endpoint contract.
...
- [OQ-PAY-ENTITLEMENT-HOLD](../../OPEN_QUESTIONS.md#oq-pay-entitlement-hold).
