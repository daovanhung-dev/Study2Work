...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/billing/refund-requests` |
| Purpose | yêu cầu |
| Consumer/Actor | Người mua/thành viên lập hóa đơn của tổ chức |
| Authentication | Người mua/thành viên lập hóa đơn của tổ chức |
| Authorization | Người mua/thành viên lập hóa đơn của tổ chức |
...
| Side effects | Xử lý lặp an toàn; kiểm toán rủi ro cao/hàng đợi tài chính |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L380` — endpoint contract.
