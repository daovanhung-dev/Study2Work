...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/billing/refund-requests` |
...
| ---: | --- | --- | --- |
| 1 | Đơn hàng, số tiền <= có thể hoàn, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Đơn hàng, số tiền <= có thể hoàn, lý do → yêu cầu
