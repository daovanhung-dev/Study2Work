...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/enterprises/{enterpriseId}/promotions` |
...
| ---: | --- | --- | --- |
| 1 | Loại , việc làm, tín dụng ngân sách, ngày tháng | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Loại `SPONSORED_JOB`, việc làm, tín dụng ngân sách, ngày tháng → quảng bá
