...
| Loại , việc làm, tín dụng ngân sách, ngày tháng | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | quảng bá | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-WRK-060` + quyền sử dụng.
...
- Endpoint input contract: Loại `SPONSORED_JOB`, việc làm, tín dụng ngân sách, ngày tháng → quảng bá.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm việc làm đã xuất bản, chính sách nhãn, giữ quyền sử dụng; trường điểm tự nhiên không có trong mô hình ghi
