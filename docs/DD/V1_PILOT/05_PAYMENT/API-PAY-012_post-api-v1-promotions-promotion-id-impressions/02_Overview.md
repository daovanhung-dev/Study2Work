...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/promotions/{promotionId}/impressions` |
| Purpose | đã tiếp nhận |
| Consumer/Actor | Ứng dụng khách công khai có mã vị trí đã ký |
| Authentication | Ứng dụng khách công khai có mã vị trí đã ký |
| Authorization | Ứng dụng khách công khai có mã vị trí đã ký |
...
| Side effects | `202`; giới hạn tần suất cao |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L386` — endpoint contract.
...
- [OQ-PAY-PROMOTION-METRICS](../../OPEN_QUESTIONS.md#oq-pay-promotion-metrics).
