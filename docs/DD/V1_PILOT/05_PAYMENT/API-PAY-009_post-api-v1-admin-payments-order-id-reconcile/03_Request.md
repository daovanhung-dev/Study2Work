...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/payments/{orderId}/reconcile` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `orderId` | `orderId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Tham chiếu minh chứng nhà cung cấp, thao tác /, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Tham chiếu minh chứng nhà cung cấp, thao tác `REQUERY`/`MARK_REVIEWED`, lý do → vụ việc
