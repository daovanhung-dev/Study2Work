...
| Purpose | vụ việc |
| Consumer/Actor | `PERM-PAY-003` + MFA |
| Authentication | `PERM-PAY-003` + MFA |
| Authorization | `PERM-PAY-003` + MFA |
...
| Side effects | Khóa lặp; kiểm toán tài chính |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L383` — endpoint contract.
