...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `PAYMENT_AMOUNT_MISMATCH` | As specified by API catalog. | `202` | `PAYMENT_AMOUNT_MISMATCH` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L393` |
