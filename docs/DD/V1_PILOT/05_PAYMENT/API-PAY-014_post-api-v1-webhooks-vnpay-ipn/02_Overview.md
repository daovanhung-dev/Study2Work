...
| Module | `Payment` |
| Method | `POST` |
| Endpoint | `/api/v1/webhooks/vnpay/ipn` |
| Purpose | xác nhận theo yêu cầu nhà cung cấp |
| Consumer/Actor | Chữ ký VNPAY/danh sách IP là lớp phòng thủ bổ sung |
| Authentication | Chữ ký VNPAY/danh sách IP là lớp phòng thủ bổ sung |
| Authorization | Chữ ký VNPAY/danh sách IP là lớp phòng thủ bổ sung |
...
| Side effects | Khóa lặp webhook; hàm băm gốc/kiểm toán; không xác thực người dùng |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L393` — endpoint contract.
