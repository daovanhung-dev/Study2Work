...
| Phiên bản sản phẩm/giá, số lượng, nhà cung cấp VNPAY/MOMO, ngữ cảnh tổ chức tùy chọn, danh sách đường dẫn trả về cho phép | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | đơn hàng + chuyển hướng/liên kết sâu của nhà cung cấp | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Ứng viên hoặc thành viên lập hóa đơn tổ chức.
...
- Endpoint input contract: Phiên bản sản phẩm/giá, số lượng, nhà cung cấp VNPAY/MOMO, ngữ cảnh tổ chức tùy chọn, danh sách đường dẫn trả về cho phép → đơn hàng + chuyển hướng/liên kết sâu của nhà cung cấp.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm giá/đối tượng/quyền; tính số tiền ở máy chủ; tạo đơn/lượt thử `CREATED`, khóa lặp/hộp thư đi. Gọi bộ điều hợp sau cam kết; cập nhật đơn/lượt thử `PENDING` trong TX tiếp theo

- Operations/observability contract: Khóa lặp bắt buộc; kiểm toán; 10/giờ
