...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | đơn hàng + chuyển hướng/liên kết sâu của nhà cung cấp | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> đơn hàng + chuyển hướng/liên kết sâu của nhà cung cấp
...
{
  "success": false,
  "businessCode": "PRICE_VERSION_STALE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
