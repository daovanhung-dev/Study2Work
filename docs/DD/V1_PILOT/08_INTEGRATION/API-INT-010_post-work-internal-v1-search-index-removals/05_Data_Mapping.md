...
format: "markdown"
dd_id: "API-INT-010"
api_name: "POST work /internal/v1/search-index-removals"
...
| ID ứng viên/ID sự kiện đồng ý/hạn chót | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | kết quả | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Tiến trình nền riêng tư Work.
...
- Endpoint input contract: ID ứng viên/ID sự kiện đồng ý/hạn chót → kết quả.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm đồng ý tại CSDL; xóa tài liệu tìm kiếm; khử trùng lặp; cảnh báo nếu >5 phút
