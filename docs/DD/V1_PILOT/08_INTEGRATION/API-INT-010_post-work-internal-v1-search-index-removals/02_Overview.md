...
| Method | `POST` |
| Endpoint | `/internal/v1/search-index-removals` |
| Purpose | kết quả |
| Consumer/Actor | Tiến trình nền riêng tư Work |
| Authentication | mTLS/service identity |
| Authorization | Tiến trình nền riêng tư Work |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L448` — endpoint contract.
