...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SEARCH_BACKEND_UNAVAILABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `SEARCH_BACKEND_UNAVAILABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L448` |
| 2 | Endpoint business/error code | DIRECT | `DLQ` | As specified by API catalog. | `SOURCE_REQUIRED` | `DLQ` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L448` |
