...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/internal/v1/progress-rebuild-jobs` |
...
| ---: | --- | --- | --- |
| 1 | ID người học/đích/lý do/kiểm toán nguồn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID người học/đích/lý do/kiểm toán nguồn → tác vụ
