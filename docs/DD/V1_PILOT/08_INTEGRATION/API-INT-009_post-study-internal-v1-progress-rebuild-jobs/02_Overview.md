...
| Purpose | tác vụ |
| Consumer/Actor | Chỉ tiến trình nền/dịch vụ quản trị Study |
| Authentication | mTLS/service identity |
| Authorization | Chỉ tiến trình nền/dịch vụ quản trị Study |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L447` — endpoint contract.
