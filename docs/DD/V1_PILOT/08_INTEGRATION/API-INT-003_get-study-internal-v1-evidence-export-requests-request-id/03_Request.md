...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/internal/v1/evidence-export-requests/{requestId}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `requestId` | `requestId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
