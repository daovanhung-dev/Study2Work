...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CALLBACK_DISABLED` | As specified by API catalog. | `SOURCE_REQUIRED` | `CALLBACK_DISABLED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L446` |
| 2 | Endpoint business/error code | DIRECT | `SIGNATURE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `SIGNATURE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L446` |
