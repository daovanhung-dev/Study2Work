...
| Consumer/Actor | Nhà cung cấp đã cấu hình khi bộ điều hợp phản hồi được bật |
| Authentication | mTLS/service identity |
| Authorization | Nhà cung cấp đã cấu hình khi bộ điều hợp phản hồi được bật |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L446` — endpoint contract.
