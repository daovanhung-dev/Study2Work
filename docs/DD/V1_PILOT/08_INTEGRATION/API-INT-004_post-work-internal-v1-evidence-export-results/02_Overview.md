...
| Consumer/Actor | JWT dịch vụ Study + chữ ký tách rời |
| Authentication | mTLS/service identity |
| Authorization | JWT dịch vụ Study + chữ ký tách rời |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L442` — endpoint contract.
