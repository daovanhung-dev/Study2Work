...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | trạng thái/`authVersion`/vai trò/hàm băm email/phiên bản tối thiểu | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> trạng thái/`authVersion`/vai trò/hàm băm email/phiên bản tối thiểu
...
{
  "success": false,
  "businessCode": "SUBJECT_NOT_FOUND",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
