...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SUBJECT_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `SUBJECT_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L439` |
| 2 | Endpoint business/error code | DIRECT | `SERVICE_NOT_AUTHORIZED` | As specified by API catalog. | `SOURCE_REQUIRED` | `SERVICE_NOT_AUTHORIZED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L439` |
