...
| `revokedAt` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| `eventId` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| Minh chứng/phiên bản//mã lý do an toàn/ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Study.
...
- Endpoint input contract: Minh chứng/phiên bản/`revokedAt`/mã lý do an toàn/`eventId` → đã tiếp nhận.

<a id="s04"></a>
### S04. Execute source-defined processing

> Khử trùng lặp sự kiện; đặt mọi ảnh chụp đơn ứng tuyển khớp là `REVOKED`/ẩn; thêm lịch sử, thông báo ứng viên/nhà tuyển dụng mà không khuyến nghị tiêu cực
