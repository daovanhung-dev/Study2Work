...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SIGNATURE_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `SIGNATURE_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L440` |
| 2 | Endpoint business/error code | DIRECT | `REPLAY_DETECTED` | As specified by API catalog. | `SOURCE_REQUIRED` | `REPLAY_DETECTED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L440` |
| 3 | Endpoint business/error code | DIRECT | `REQUEST_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `REQUEST_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L440` |
