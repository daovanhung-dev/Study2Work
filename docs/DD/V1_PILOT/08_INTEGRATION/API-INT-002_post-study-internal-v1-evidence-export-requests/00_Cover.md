...
| API ID | `API-INT-002` |
| API name | `POST study /internal/v1/evidence-export-requests` |
| HTTP method | `POST` |
| Endpoint | `/internal/v1/evidence-export-requests` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L440`.
