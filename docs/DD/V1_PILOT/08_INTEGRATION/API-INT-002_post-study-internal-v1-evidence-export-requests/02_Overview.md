...
| Purpose | `202` |
| Consumer/Actor | JWT dịch vụ Work + chữ ký phần thân tách rời, `aud=study-internal` |
| Authentication | mTLS/service identity |
| Authorization | JWT dịch vụ Work + chữ ký phần thân tách rời, `aud=study-internal` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L440` — endpoint contract.
