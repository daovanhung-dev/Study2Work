...
format: "markdown"
dd_id: "API-IAM-015"
api_name: "GET /api/v1/me/sessions"
...
| Con trỏ | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | phiên đang hoạt động, cờ phiên hiện tại, thông tin thiết bị/IP khái quát | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Con trỏ → phiên đang hoạt động, cờ phiên hiện tại, thông tin thiết bị/IP khái quát.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc các phiên theo chỉ mục con trỏ `(user_id,last_seen_at,id)`; che địa chỉ IP

- Operations/observability contract: `private,no-store`
