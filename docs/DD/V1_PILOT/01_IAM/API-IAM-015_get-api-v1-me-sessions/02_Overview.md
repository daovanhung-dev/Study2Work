...
| Purpose | phiên đang hoạt động, cờ phiên hiện tại, thông tin thiết bị/IP khái quát |
...
| Side effects | `private,no-store` |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L101` — endpoint contract.
