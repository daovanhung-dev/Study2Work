...
| ---: | --- | --- | --- |
| 1 | Con trỏ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Con trỏ → phiên đang hoạt động, cờ phiên hiện tại, thông tin thiết bị/IP khái quát
