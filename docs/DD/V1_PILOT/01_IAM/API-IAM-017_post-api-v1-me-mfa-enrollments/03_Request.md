...
| ---: | --- | --- | --- |
| 1 | Phương thức ; nhãn thiết bị | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phương thức `TOTP`; nhãn thiết bị → bí mật và tải tin QR một lần, mã khôi phục một lần
