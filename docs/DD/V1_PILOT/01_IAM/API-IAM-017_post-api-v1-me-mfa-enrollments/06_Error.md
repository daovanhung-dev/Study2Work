...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `MFA_ALREADY_ENABLED` | As specified by API catalog. | `SOURCE_REQUIRED` | `MFA_ALREADY_ENABLED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L103` |
| 2 | Endpoint business/error code | DIRECT | `STEP_UP_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `STEP_UP_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L103` |
