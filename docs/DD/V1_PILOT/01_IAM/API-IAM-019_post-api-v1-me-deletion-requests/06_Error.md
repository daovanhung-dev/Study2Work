...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `LEGAL_HOLD_ACTIVE` | As specified by API catalog. | `SOURCE_REQUIRED` | `LEGAL_HOLD_ACTIVE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L105` |
| 2 | Endpoint business/error code | DIRECT | `STEP_UP_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `STEP_UP_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L105` |
