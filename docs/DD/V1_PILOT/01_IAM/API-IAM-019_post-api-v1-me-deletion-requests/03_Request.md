...
| ---: | --- | --- | --- |
| 1 | Văn bản xác nhận, lý do tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Văn bản xác nhận, lý do tùy chọn → `graceEndsAt`
