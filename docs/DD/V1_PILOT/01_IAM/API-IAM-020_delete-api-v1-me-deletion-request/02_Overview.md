...
| Purpose | `ACTIVE` |
| Consumer/Actor | Đã xác thực qua luồng khôi phục |
| Authentication | Đã xác thực qua luồng khôi phục |
| Authorization | Đã xác thực qua luồng khôi phục |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L106` — endpoint contract.
