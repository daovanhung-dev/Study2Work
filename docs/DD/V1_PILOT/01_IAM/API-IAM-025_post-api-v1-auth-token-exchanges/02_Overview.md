...
| Purpose | JWT 5 phút |
| Consumer/Actor | Đã xác thực và đang hoạt động |
| Authentication | Đã xác thực và đang hoạt động |
| Authorization | Đã xác thực và đang hoạt động |
...
| Side effects | Khóa lặp; kiểm toán bảo mật; 20/phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L221` — endpoint contract.
