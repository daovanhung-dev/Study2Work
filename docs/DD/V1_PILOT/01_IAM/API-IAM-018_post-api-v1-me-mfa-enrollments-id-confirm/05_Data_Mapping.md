...
format: "markdown"
dd_id: "API-IAM-018"
api_name: "POST /api/v1/me/mfa/enrollments/{id}/confirm"
...
| Mã TOTP | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | đăng ký đã kích hoạt | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Mã TOTP → đăng ký đã kích hoạt.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa đăng ký; xác minh, kích hoạt; lưu mã khôi phục đã băm; không bao giờ trả lại bí mật
