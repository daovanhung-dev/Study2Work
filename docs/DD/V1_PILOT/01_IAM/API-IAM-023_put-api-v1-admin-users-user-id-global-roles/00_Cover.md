...
| API ID | `API-IAM-023` |
| API name | `PUT /api/v1/admin/users/{userId}/global-roles` |
| HTTP method | `PUT` |
| Endpoint | `/api/v1/admin/users/{userId}/global-roles` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L109`.
