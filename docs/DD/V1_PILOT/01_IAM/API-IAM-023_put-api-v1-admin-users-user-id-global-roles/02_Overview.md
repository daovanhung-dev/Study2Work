...
| Purpose | vai trò/phiên bản |
| Consumer/Actor | `PERM-IAM-003` + MFA gần đây |
| Authentication | `PERM-IAM-003` + MFA gần đây |
| Authorization | `PERM-IAM-003` + MFA gần đây |
...
| Side effects | Khóa lặp; kiểm toán đầy đủ; không dùng bộ nhớ đệm |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L109` — endpoint contract.
