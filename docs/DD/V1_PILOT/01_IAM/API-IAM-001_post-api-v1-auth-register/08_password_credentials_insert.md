...
- [03_THIET_KE_CO_SO_DU_LIEU.md](../../../../BD/03_THIET_KE_CO_SO_DU_LIEU.md): `L117`.
- Endpoint source: `docs/BD/04_DAC_TA_API.md:L87`.

---
## Phụ lục đối chiếu template Markdown

- Template Markdown: `.agent/docs/dd/DD_API_Template_MD/08_password_credentials_insert.md`.
