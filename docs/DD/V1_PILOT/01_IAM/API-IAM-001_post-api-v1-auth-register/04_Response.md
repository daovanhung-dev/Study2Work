...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | người dùng chờ xác minh và `verificationExpiresAt` | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> người dùng chờ xác minh và `verificationExpiresAt`
