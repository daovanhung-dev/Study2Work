...
format: "markdown"
dd_id: "API-IAM-009"
api_name: "POST /api/v1/auth/forgot-password"
...
| luôn trả đã tiếp nhận | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: `email`; luôn trả đã tiếp nhận.

<a id="s04"></a>
### S04. Execute source-defined processing

> Nếu đủ điều kiện và hết thời gian chờ: thu hồi mã đặt lại cũ, tạo mã băm + giao nhận

- Operations/observability contract: Khử trùng lặp; 3/giờ/hàm băm email; kiểm toán không PII
