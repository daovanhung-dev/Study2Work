...
format: "markdown"
dd_id: "API-IAM-016"
api_name: "DELETE /api/v1/me/sessions/{sessionId}"
...
| `sessionId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
- Actor/authorization source: Đã xác thực + chủ sở hữu.
...
- Endpoint input contract: UUID → đã thu hồi.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX cập nhật theo điều kiện `id AND user_id`; thu hồi mã làm mới
