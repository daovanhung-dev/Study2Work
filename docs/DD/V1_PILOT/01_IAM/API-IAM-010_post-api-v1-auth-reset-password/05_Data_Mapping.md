...
| ---: | --- | --- | --- | --- | --- | --- | --- |
| Mã thông báo + mật khẩu mới | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Mã thông báo + mật khẩu mới → thành công.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX + L mã/người dùng; kiểm chính sách/lịch sử; cập nhật Argon2id; dùng mã; thu hồi mọi phiên; tăng `authVersion`

- Operations/observability contract: Xử lý lặp an toàn; sự kiện `identity.password.changed`; kiểm toán bảo mật
