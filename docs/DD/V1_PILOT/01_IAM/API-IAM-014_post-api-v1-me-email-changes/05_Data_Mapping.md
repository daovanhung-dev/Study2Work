...
format: "markdown"
dd_id: "API-IAM-014"
api_name: "POST /api/v1/me/email-changes"
...
| Mã thông báo | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | email mới | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Mã thông báo → email mới.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa người dùng/mã thông báo; kiểm lại tính duy nhất; cập nhật email/phiên bản; đánh dấu mã đã dùng; thu hồi các phiên khác; cập nhật bản chiếu qua hộp thư đi

- Operations/observability contract: Khóa lặp; `identity.email.changed`; kiểm toán
