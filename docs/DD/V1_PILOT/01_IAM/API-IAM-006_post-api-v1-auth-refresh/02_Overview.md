...
| Purpose | cặp mã mới |
| Consumer/Actor | Cookie/mã làm mới |
| Authentication | Cookie/mã làm mới |
| Authorization | Cookie/mã làm mới |
...
| Side effects | Không thử lại bằng mã cũ; sự kiện bảo mật `identity.refresh.reuse_detected`; 30/phút/phiên |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L92` — endpoint contract.
