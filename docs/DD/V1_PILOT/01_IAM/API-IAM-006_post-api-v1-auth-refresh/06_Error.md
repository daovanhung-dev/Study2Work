...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `REFRESH_TOKEN_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `REFRESH_TOKEN_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L92` |
| 2 | Endpoint business/error code | DIRECT | `SESSION_REVOKED` | As specified by API catalog. | `SOURCE_REQUIRED` | `SESSION_REVOKED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L92` |
| 3 | Endpoint business/error code | DIRECT | `REFRESH_TOKEN_REUSE_DETECTED` | As specified by API catalog. | `401` | `REFRESH_TOKEN_REUSE_DETECTED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L92` |
