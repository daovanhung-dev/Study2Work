...
| `password` | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Physical key direct; location/type not locked. |
| nhãn thiết bị | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | mã thông báo hoặc thử thách MFA | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: `email`, `password`, nhãn thiết bị → mã thông báo hoặc thử thách MFA.

<a id="s04"></a>
### S04. Execute source-defined processing

> R thông tin xác thực/người dùng bằng chỉ mục email chuẩn hóa duy nhất; kiểm hằng thời gian; TX cập nhật thất bại/khóa; nếu đặc quyền thì tạo thử thách một lần, nếu không thì tạo phiên + mã làm mới luân phiên

- Operations/observability contract: Kiểm toán bảo mật cả thành công/thất bại; tần suất như mục 2.3; sự kiện rủi ro đăng nhập nếu bất thường
