...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `CURRENT_PASSWORD_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `CURRENT_PASSWORD_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L98` |
| 2 | Endpoint business/error code | DIRECT | `PASSWORD_POLICY_FAILED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PASSWORD_POLICY_FAILED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L98` |
| 3 | Endpoint business/error code | DIRECT | `STEP_UP_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `STEP_UP_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L98` |
