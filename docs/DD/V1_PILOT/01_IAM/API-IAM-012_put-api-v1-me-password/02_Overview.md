...
| Purpose | thành công |
| Consumer/Actor | Đã xác thực + mật khẩu/MFA hiện tại |
| Authentication | Đã xác thực + mật khẩu/MFA hiện tại |
| Authorization | Đã xác thực + mật khẩu/MFA hiện tại |
...
| Side effects | Khóa lặp; sự kiện/kiểm toán đổi mật khẩu |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L98` — endpoint contract.
