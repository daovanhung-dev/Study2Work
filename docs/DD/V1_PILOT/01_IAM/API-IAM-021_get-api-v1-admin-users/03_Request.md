...
| ---: | --- | --- | --- |
| 1 | Trang/bộ lọc trạng thái/hàm băm email/vai trò | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/bộ lọc trạng thái/hàm băm email/vai trò → người dùng đã che dữ liệu
