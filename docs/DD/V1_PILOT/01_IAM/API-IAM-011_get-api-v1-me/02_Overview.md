...
| Method | `GET` |
| Endpoint | `/api/v1/me` |
| Purpose | tóm tắt danh tính, vai trò, thỏa thuận, trạng thái tài khoản |
...
| Side effects | `private,no-store`; 300/phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L97` — endpoint contract.
