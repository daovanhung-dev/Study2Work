...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tóm tắt danh tính, vai trò, thỏa thuận, trạng thái tài khoản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Không có đầu vào → tóm tắt danh tính, vai trò, thỏa thuận, trạng thái tài khoản.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc người dùng/vai trò/thỏa thuận theo khóa chính; không trả trường mật khẩu/mã thông báo

- Operations/observability contract: `private,no-store`; 300/phút
