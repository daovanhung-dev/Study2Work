...
| Method | `POST` |
| Endpoint | `/api/v1/me/email-change-requests` |
| Purpose | thời điểm hết hạn |
| Consumer/Actor | Đã xác thực + xác minh tăng cường |
| Authentication | Đã xác thực + xác minh tăng cường |
| Authorization | Đã xác thực + xác minh tăng cường |
...
| Side effects | Xử lý lặp an toàn; giao nhận + kiểm toán; 3/ngày |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L99` — endpoint contract.
