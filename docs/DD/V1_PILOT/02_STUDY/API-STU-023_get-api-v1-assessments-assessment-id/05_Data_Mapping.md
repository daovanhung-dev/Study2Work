...
format: "markdown"
dd_id: "API-STU-023"
api_name: "GET /api/v1/assessments/{assessmentId}"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | loại, hướng dẫn, giới hạn, thang chấm; bài trắc nghiệm không trả đáp án đúng | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học có quyền trong phạm vi.
...
- Endpoint input contract: → loại, hướng dẫn, giới hạn, thang chấm; bài trắc nghiệm không trả đáp án đúng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm đúng phạm vi vị trí/lần ghi danh; nối đúng một vị trí
