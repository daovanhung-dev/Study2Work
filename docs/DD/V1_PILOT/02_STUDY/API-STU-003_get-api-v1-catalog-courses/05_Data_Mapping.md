...
format: "markdown"
dd_id: "API-STU-003"
api_name: "GET /api/v1/catalog/courses"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | khóa học độc lập đã xuất bản | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang, `q`, kỹ năng, cấp độ → khóa học độc lập đã xuất bản.

<a id="s04"></a>
### S04. Execute source-defined processing

> Chỉ phiên bản khóa học hiện hành đã xuất bản; FTS/trigram; tại V1, cờ cho phép ghi danh độc lập luôn đúng
