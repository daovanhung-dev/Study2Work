...
| Purpose | điều chỉnh + ảnh chụp dựng lại |
| Consumer/Actor | `PERM-STU-010` + MFA |
| Authentication | `PERM-STU-010` + MFA |
| Authorization | `PERM-STU-010` + MFA |
...
| Side effects | Khóa lặp; sự kiện/kiểm toán bất biến |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L185` — endpoint contract.
