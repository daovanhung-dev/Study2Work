...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/learners/{learnerId}/progress-adjustments` |
...
| ---: | --- | --- | --- |
| 1 | Dữ kiện đích, giá trị đã sửa, lý do/minh chứng | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Dữ kiện đích, giá trị đã sửa, lý do/minh chứng, `If-Match` → điều chỉnh + ảnh chụp dựng lại
