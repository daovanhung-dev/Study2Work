...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/admin/assessment-reviews` |
...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái/loại/người được giao/tuổi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái/loại/người được giao/tuổi → hàng đợi
