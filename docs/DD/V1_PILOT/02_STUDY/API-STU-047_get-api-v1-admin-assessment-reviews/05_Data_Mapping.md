...
format: "markdown"
dd_id: "API-STU-047"
api_name: "GET /api/v1/admin/assessment-reviews"
...
| Trang/trạng thái/loại/người được giao/tuổi | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hàng đợi | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/trạng thái/loại/người được giao/tuổi → hàng đợi.

<a id="s04"></a>
### S04. Execute source-defined processing

> Phạm vi vai trò Study không theo tổ chức; chỉ mục trạng thái/người được giao/thời điểm tạo; chỉ lượt làm tệp `CLEAN`

- Operations/observability contract: Không dùng bộ nhớ đệm chung; chỉ kiểm toán xuất dữ liệu
