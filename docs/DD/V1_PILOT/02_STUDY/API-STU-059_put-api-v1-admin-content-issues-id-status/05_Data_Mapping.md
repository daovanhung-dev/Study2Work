...
format: "markdown"
dd_id: "API-STU-059"
api_name: "PUT /api/v1/admin/content-issues/{id}/status"
...
| Trạng thái, cách giải quyết | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | vấn đề | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-STU-005`.
...
- Endpoint input contract: Trạng thái, cách giải quyết, `If-Match` → vấn đề.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thêm sự kiện vấn đề + cập nhật bản chiếu; mở lại trạng thái kết thúc cần lý do
