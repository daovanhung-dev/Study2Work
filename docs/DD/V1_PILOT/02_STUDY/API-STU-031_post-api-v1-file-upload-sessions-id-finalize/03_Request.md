...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/file-upload-sessions/{id}/finalize` |
...
| ---: | --- | --- | --- |
| 1 | Mã kiểm tra/kích thước thực tế | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Mã kiểm tra/kích thước thực tế → tài sản `SCANNING`
