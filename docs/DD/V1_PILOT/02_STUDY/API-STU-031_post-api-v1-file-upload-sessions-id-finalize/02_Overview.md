...
| Purpose | tài sản `SCANNING` |
| Consumer/Actor | Chủ sở hữu lượt tải lên |
| Authentication | Chủ sở hữu lượt tải lên |
| Authorization | Chủ sở hữu lượt tải lên |
...
| Side effects | Khóa lặp; sự kiện `study.file.scan_requested` |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L161` — endpoint contract.
