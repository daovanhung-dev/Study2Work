...
| API ID | `API-STU-031` |
| API name | `POST /api/v1/file-upload-sessions/{id}/finalize` |
| HTTP method | `POST` |
| Endpoint | `/api/v1/file-upload-sessions/{id}/finalize` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L161`.
