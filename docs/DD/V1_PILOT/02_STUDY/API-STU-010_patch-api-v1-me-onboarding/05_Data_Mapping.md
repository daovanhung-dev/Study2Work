...
format: "markdown"
dd_id: "API-STU-010"
api_name: "PATCH /api/v1/me/onboarding"
...
| Câu trả lời từng phần thuộc danh sách cho phép | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản nháp đã lưu | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học đang hoạt động.
...
- Endpoint input contract: Câu trả lời từng phần thuộc danh sách cho phép, `If-Match` → bản nháp đã lưu.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa bản ghi; kiểm lược đồ/kiểu/khoảng giá trị; `NOT_STARTED→IN_PROGRESS`; tăng phiên bản

- Operations/observability contract: Khóa lặp tùy chọn; chỉ kiểm toán thay đổi danh mục
