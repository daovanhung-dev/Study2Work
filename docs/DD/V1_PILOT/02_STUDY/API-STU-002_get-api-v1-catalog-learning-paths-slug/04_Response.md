...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | phiên bản hiện hành đã xuất bản, các phiên bản khóa học được ghim, điều kiện tiên quyết | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> phiên bản hiện hành đã xuất bản, các phiên bản khóa học được ghim, điều kiện tiên quyết
