...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/catalog/learning-paths/{slug}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `slug` | `slug` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Slug | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Slug → phiên bản hiện hành đã xuất bản, các phiên bản khóa học được ghim, điều kiện tiên quyết
