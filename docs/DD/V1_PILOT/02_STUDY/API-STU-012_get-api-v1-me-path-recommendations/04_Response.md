...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | ba phiên bản lộ trình đầu, dải điểm/lý do/phiên bản lượt chạy | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> ba phiên bản lộ trình đầu, dải điểm/lý do/phiên bản lượt chạy
