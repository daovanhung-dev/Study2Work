...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `OVERRIDE_REASON_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `OVERRIDE_REASON_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L184` |
| 2 | Endpoint business/error code | DIRECT | `PATH_VERSION_NOT_PUBLISHED` | As specified by API catalog. | `SOURCE_REQUIRED` | `PATH_VERSION_NOT_PUBLISHED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L184` |
