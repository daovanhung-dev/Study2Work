...
| Module | `Study` |
| Method | `POST` |
| Endpoint | `/api/v1/admin/learners/{learnerId}/primary-path-overrides` |
| Purpose | kỳ |
| Consumer/Actor | `PERM-STU-009` + MFA |
| Authentication | `PERM-STU-009` + MFA |
| Authorization | `PERM-STU-009` + MFA |
...
| Side effects | Khóa lặp; sự kiện/kiểm toán rủi ro cao |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L184` — endpoint contract.
