...
| ---: | --- |
| HTTP method | `PATCH` |
| URI | `/api/v1/admin/content/{kind}/{id}/versions/{versionId}` |
...
| ---: | --- | --- | --- |
| 1 | Vá siêu dữ liệu/cấu trúc | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Vá siêu dữ liệu/cấu trúc, `If-Match` → bản nháp/phiên bản
