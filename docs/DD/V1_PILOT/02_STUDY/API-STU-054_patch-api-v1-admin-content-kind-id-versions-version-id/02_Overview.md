...
| Purpose | bản nháp/phiên bản |
| Consumer/Actor | Tác giả hoặc `PERM-STU-002` |
| Authentication | Tác giả hoặc `PERM-STU-002` |
| Authorization | Tác giả hoặc `PERM-STU-002` |
...
| Side effects | Nên dùng khóa lặp; kiểm toán chênh lệch; không lưu đệm |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L194` — endpoint contract.
