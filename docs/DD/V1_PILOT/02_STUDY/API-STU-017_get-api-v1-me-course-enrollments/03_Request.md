...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái/nguồn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái/nguồn → lần ghi danh/tiến độ đúng phiên bản
