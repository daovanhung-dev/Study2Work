...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | SOURCE_REQUIRED — endpoint row does not split input and output fields. | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> SOURCE_REQUIRED — endpoint row does not split input and output fields.
