...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/assessment-attempts/{attemptId}/reviews` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `attemptId` | `attemptId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Quyết định //, điểm thang chấm, phản hồi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Quyết định `PASSED`/`NEEDS_REVISION`/`FAILED`, điểm thang chấm, phản hồi, `If-Match`
