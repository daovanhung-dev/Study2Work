...
| Consumer/Actor | `PERM-STU-006` |
| Authentication | `PERM-STU-006` |
| Authorization | `PERM-STU-006` |
...
| Side effects | Khóa lặp bắt buộc; sự kiện duyệt/hoàn thành; kiểm toán đầy đủ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L183` — endpoint contract.
