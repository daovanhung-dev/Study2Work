...
| ---: | --- | --- | --- |
| 1 | Danh mục, tiêu đề <=200, nội dung <=5000, ID tệp đính kèm sạch | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Danh mục, tiêu đề <=200, nội dung <=5000, ID tệp đính kèm sạch → yêu cầu hỗ trợ
