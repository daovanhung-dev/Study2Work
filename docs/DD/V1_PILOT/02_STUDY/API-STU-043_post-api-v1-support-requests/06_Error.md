...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `DUPLICATE_OPEN_REQUEST` | As specified by API catalog. | `SOURCE_REQUIRED` | `DUPLICATE_OPEN_REQUEST` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L178` |
| 2 | Endpoint business/error code | DIRECT | `FILE_NOT_CLEAN` | As specified by API catalog. | `409` | `FILE_NOT_CLEAN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L178` |
