...
format: "markdown"
dd_id: "API-STU-011"
api_name: "POST /api/v1/me/onboarding/complete"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản ghi hoàn tất + ID lượt gợi ý | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: `If-Match` → bản ghi hoàn tất + ID lượt gợi ý.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm các câu trả lời bắt buộc; đặt `COMPLETED`; chụp câu trả lời; tạo lượt/mục gợi ý tất định

- Operations/observability contract: Khóa lặp bắt buộc; sự kiện `study.onboarding.completed`; kiểm toán
