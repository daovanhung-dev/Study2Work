...
| Purpose | bản ghi hoàn tất + ID lượt gợi ý |
| Consumer/Actor | Người học đang hoạt động |
| Authentication | Người học đang hoạt động |
| Authorization | Người học đang hoạt động |
...
| Side effects | Khóa lặp bắt buộc; sự kiện `study.onboarding.completed`; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L136` — endpoint contract.
...
- [OQ-STU-ONBOARDING](../../OPEN_QUESTIONS.md#oq-stu-onboarding).
