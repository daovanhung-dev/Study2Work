...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | minh chứng `ISSUED` của chính mình; mặc định không trả tệp bí mật | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> minh chứng `ISSUED` của chính mình; mặc định không trả tệp bí mật
...
{
  "success": false,
  "businessCode": "TOKEN_AUDIENCE_INVALID",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
