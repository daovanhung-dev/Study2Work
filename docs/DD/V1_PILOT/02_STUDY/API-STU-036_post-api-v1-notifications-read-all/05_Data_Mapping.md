...
format: "markdown"
dd_id: "API-STU-036"
api_name: "POST /api/v1/notifications/read-all"
...
| Thời điểm trước đó tùy chọn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: Người nhận.
...
- Endpoint input contract: Thời điểm trước đó tùy chọn → số lượng.

<a id="s04"></a>
### S04. Execute source-defined processing

> Cập nhật hàng loạt người nhận/chưa đọc bằng chỉ mục

- Operations/observability contract: Lặp an toàn
