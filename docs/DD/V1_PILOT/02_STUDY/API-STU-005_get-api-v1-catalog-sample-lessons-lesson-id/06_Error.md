...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SAMPLE_NOT_AVAILABLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `SAMPLE_NOT_AVAILABLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L130` |
