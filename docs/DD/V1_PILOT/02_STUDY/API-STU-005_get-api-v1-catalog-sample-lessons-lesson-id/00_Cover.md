...
| API ID | `API-STU-005` |
| API name | `GET /api/v1/catalog/sample-lessons/{lessonId}` |
| HTTP method | `GET` |
| Endpoint | `/api/v1/catalog/sample-lessons/{lessonId}` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L130`.
