...
| ---: | --- | --- | --- |
| 1 | Ma trận hoàn chỉnh thuộc danh sách cho phép | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Ma trận hoàn chỉnh thuộc danh sách cho phép, `If-Match` → tùy chọn
