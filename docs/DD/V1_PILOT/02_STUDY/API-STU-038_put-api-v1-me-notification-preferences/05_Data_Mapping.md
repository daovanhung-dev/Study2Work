...
format: "markdown"
dd_id: "API-STU-038"
api_name: "PUT /api/v1/me/notification-preferences"
...
| Ma trận hoàn chỉnh thuộc danh sách cho phép | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | tùy chọn | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người dùng.
...
- Endpoint input contract: Ma trận hoàn chỉnh thuộc danh sách cho phép, `If-Match` → tùy chọn.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX thay giá trị ghi đè; không được tắt danh mục bảo mật bắt buộc
