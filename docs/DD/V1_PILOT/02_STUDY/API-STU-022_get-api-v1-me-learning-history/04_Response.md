...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | dòng thời gian hoạt động bất biến | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> dòng thời gian hoạt động bất biến
...
{
  "success": false,
  "businessCode": "DATE_RANGE_TOO_LARGE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
