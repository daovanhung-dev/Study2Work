...
format: "markdown"
dd_id: "API-STU-019"
api_name: "GET /api/v1/lessons/{lessonId}/study"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | khối/nội dung đã làm sạch, cổng tiến độ và bài đánh giá nguyên tử | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học đã ghi danh vào phiên bản sở hữu.
...
- Endpoint input contract: → khối/nội dung đã làm sạch, cổng tiến độ và bài đánh giá nguyên tử.

<a id="s04"></a>
### S04. Execute source-defined processing

> Kiểm quyền qua lần ghi danh → phiên bản khóa học được ghim → bài học; ký URL tài nguyên khi cần
