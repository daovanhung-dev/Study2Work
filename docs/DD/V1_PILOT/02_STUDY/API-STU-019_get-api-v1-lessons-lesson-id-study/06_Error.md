...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `LESSON_NOT_ACCESSIBLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `LESSON_NOT_ACCESSIBLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L149` |
| 2 | Endpoint business/error code | DIRECT | `RESOURCE_NOT_CLEAN` | As specified by API catalog. | `SOURCE_REQUIRED` | `RESOURCE_NOT_CLEAN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L149` |
