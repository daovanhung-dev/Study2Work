...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | khối/nội dung đã làm sạch, cổng tiến độ và bài đánh giá nguyên tử | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> khối/nội dung đã làm sạch, cổng tiến độ và bài đánh giá nguyên tử
...
{
  "success": false,
  "businessCode": "LESSON_NOT_ACCESSIBLE",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
