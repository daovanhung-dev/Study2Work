...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | ảnh chụp bài học/khóa học/lộ trình | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> ảnh chụp bài học/khóa học/lộ trình
...
{
  "success": false,
  "businessCode": "PROGRESS_REGRESSION",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
