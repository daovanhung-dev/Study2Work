...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `EVIDENCE_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `EVIDENCE_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L215` |
| 2 | Endpoint business/error code | DIRECT | `EVIDENCE_REVOKED` | As specified by API catalog. | `SOURCE_REQUIRED` | `EVIDENCE_REVOKED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L215` |
