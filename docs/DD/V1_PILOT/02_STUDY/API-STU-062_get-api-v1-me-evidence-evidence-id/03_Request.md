...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/me/evidence/{evidenceId}` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `evidenceId` | `evidenceId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
