...
| Module | `Study` |
| Method | `GET` |
| Endpoint | `/api/v1/me/evidence/{evidenceId}` |
| Purpose | mô tả, nơi cấp, phiên bản, trạng thái cấp/thu hồi, trường an toàn để xem trước |
| Consumer/Actor | Cùng chủ thể |
| Authentication | Cùng chủ thể |
| Authorization | Cùng chủ thể |
...
| Side effects | Riêng tư, không lưu; kiểm toán |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L215` — endpoint contract.
