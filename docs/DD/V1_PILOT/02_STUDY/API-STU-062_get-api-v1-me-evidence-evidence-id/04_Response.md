...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | mô tả, nơi cấp, phiên bản, trạng thái cấp/thu hồi, trường an toàn để xem trước | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> mô tả, nơi cấp, phiên bản, trạng thái cấp/thu hồi, trường an toàn để xem trước
...
{
  "success": false,
  "businessCode": "EVIDENCE_NOT_FOUND",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
