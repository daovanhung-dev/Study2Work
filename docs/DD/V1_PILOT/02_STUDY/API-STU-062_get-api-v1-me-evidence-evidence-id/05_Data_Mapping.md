...
format: "markdown"
dd_id: "API-STU-062"
api_name: "GET /api/v1/me/evidence/{evidenceId}"
...
| `evidenceId` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | mô tả, nơi cấp, phiên bản, trạng thái cấp/thu hồi, trường an toàn để xem trước | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Cùng chủ thể.
...
- Endpoint input contract: → mô tả, nơi cấp, phiên bản, trạng thái cấp/thu hồi, trường an toàn để xem trước.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện đúng chủ sở hữu + ID; URL tệp có chữ ký riêng nếu minh chứng có hiện vật `CLEAN`

- Operations/observability contract: Riêng tư, không lưu; kiểm toán
