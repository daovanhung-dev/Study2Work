...
format: "markdown"
dd_id: "API-STU-034"
api_name: "GET /api/v1/notifications"
...
| Con trỏ, chưa đọc/loại | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thông báo | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học/nhân sự.
...
- Endpoint input contract: Con trỏ, chưa đọc/loại → thông báo.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn `(recipient_id,created_at desc,id)`; loại các hàng trình bày đã hết hạn/xóa

- Operations/observability contract: Riêng tư; dùng con trỏ
