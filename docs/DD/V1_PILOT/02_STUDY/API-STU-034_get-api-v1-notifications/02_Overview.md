...
| Purpose | thông báo |
| Consumer/Actor | Người học/nhân sự |
| Authentication | Người học/nhân sự |
| Authorization | Người học/nhân sự |
...
| Side effects | Riêng tư; dùng con trỏ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L169` — endpoint contract.
