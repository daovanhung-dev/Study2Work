...
format: "markdown"
dd_id: "API-STU-060"
api_name: "PUT /api/v1/admin/local-role-assignments/{userId}"
...
| Tập mã vai trò chính xác, phạm vi, hết hạn, lý do | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Actor/authorization source: `PERM-STU-011` + MFA.
...
- Endpoint input contract: Tập mã vai trò chính xác, phạm vi, hết hạn, lý do → phân công.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm phân tách nhiệm vụ; chính sách xung đột người xuất bản/người duyệt; thêm lịch sử phân công
