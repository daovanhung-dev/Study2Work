...
| API ID | `API-STU-060` |
| API name | `PUT /api/v1/admin/local-role-assignments/{userId}` |
| HTTP method | `PUT` |
| Endpoint | `/api/v1/admin/local-role-assignments/{userId}` |
| Version | `0.1` |
| Status | `Draft — Needs Confirmation` |
...
- Primary endpoint contract: `docs/BD/04_DAC_TA_API.md:L200`.
