...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/admin/local-role-assignments/{userId}` |
...
| ---: | --- | --- | --- |
| 1 | Tập mã vai trò chính xác, phạm vi, hết hạn, lý do | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Tập mã vai trò chính xác, phạm vi, hết hạn, lý do → phân công
