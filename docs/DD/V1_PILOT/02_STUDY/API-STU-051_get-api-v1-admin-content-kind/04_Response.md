...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | thực thể ổn định + phiên bản | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
{
  "success": false,
  "businessCode": "CONTENT_KIND_INVALID",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
