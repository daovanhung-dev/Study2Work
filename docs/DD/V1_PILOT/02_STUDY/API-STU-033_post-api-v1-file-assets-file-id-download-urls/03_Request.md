...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/file-assets/{fileId}/download-urls` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `fileId` | `fileId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | Cách trình bày mong muốn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Cách trình bày mong muốn → GET có chữ ký <=5 phút
