...
| Module | `Study` |
| Method | `POST` |
| Endpoint | `/api/v1/file-assets/{fileId}/download-urls` |
| Purpose | GET có chữ ký <=5 phút |
| Consumer/Actor | Chủ sở hữu hoặc người duyệt được cấp quyền rõ ràng |
| Authentication | Chủ sở hữu hoặc người duyệt được cấp quyền rõ ràng |
| Authorization | Chủ sở hữu hoặc người duyệt được cấp quyền rõ ràng |
...
| Side effects | Khóa lặp tùy chọn; 30/phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L163` — endpoint contract.
