...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/assessments/{assessmentId}/draft` |
...
| ---: | --- | --- | --- |
| 1 | Câu trả lời theo loại, ; văn bản <=20k; liên kết HTTPS <=2048; ID tệp sạch/của chủ sở hữu; ID lựa chọn trắc nghiệm hợp lệ | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Câu trả lời theo loại, `If-Match`; văn bản <=20k; liên kết HTTPS <=2048; ID tệp sạch/của chủ sở hữu; ID lựa chọn trắc nghiệm hợp lệ → bản nháp
