...
| Purpose | bản nháp |
| Consumer/Actor | Chủ sở hữu người học |
| Authentication | Chủ sở hữu người học |
| Authorization | Chủ sở hữu người học |
...
| Side effects | Khóa lặp tùy chọn; kiểm toán siêu dữ liệu, không kiểm toán nội dung câu trả lời |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L155` — endpoint contract.
