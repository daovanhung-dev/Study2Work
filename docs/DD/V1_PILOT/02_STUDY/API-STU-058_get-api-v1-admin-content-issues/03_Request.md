...
| ---: | --- |
| HTTP method | `GET` |
| URI | `/api/v1/admin/content-issues` |
...
| ---: | --- | --- | --- |
| 1 | Trang/trạng thái/mức độ/đích | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Trang/trạng thái/mức độ/đích → hàng đợi vấn đề
