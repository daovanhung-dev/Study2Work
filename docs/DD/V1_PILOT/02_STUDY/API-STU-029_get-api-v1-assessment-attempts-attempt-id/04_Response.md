...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | câu trả lời đã nộp bất biến, điểm/lượt duyệt; người duyệt nhận URL tệp sạch riêng | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> câu trả lời đã nộp bất biến, điểm/lượt duyệt; người duyệt nhận URL tệp sạch riêng
...
{
  "success": false,
  "businessCode": "ATTEMPT_NOT_FOUND",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
