...
| Module | `Study` |
| Method | `GET` |
| Endpoint | `/api/v1/assessment-attempts/{attemptId}` |
| Purpose | câu trả lời đã nộp bất biến, điểm/lượt duyệt; người duyệt nhận URL tệp sạch riêng |
| Consumer/Actor | Chủ sở hữu hoặc người duyệt `PERM-STU-006` |
| Authentication | Chủ sở hữu hoặc người duyệt `PERM-STU-006` |
| Authorization | Chủ sở hữu hoặc người duyệt `PERM-STU-006` |
...
| Side effects | Riêng tư, không lưu; kiểm toán truy cập của người duyệt |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L159` — endpoint contract.
