...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `ATTEMPT_NOT_FOUND` | As specified by API catalog. | `SOURCE_REQUIRED` | `ATTEMPT_NOT_FOUND` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L159` |
| 2 | Endpoint business/error code | DIRECT | `FILE_NOT_CLEAN` | As specified by API catalog. | `409` | `FILE_NOT_CLEAN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L159` |
