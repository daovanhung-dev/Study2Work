...
format: "markdown"
dd_id: "API-STU-057"
api_name: "POST /api/v1/admin/content/{kind}/{id}/archive"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thực thể ổn định đã lưu trữ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: `PERM-STU-004` + MFA.
...
- Endpoint input contract: Lý do, `If-Match` → thực thể ổn định đã lưu trữ.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX chặn ghi danh/danh mục mới; lần ghi danh đã ghim vẫn dùng được; không xóa phiên bản
