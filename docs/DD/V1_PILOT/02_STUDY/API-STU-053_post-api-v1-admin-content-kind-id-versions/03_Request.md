...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/content/{kind}/{id}/versions` |
...
| ---: | --- | --- | --- |
| 1 | ID bản xuất bản/bản nháp gốc, tóm tắt thay đổi | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID bản xuất bản/bản nháp gốc, tóm tắt thay đổi → bản sao `DRAFT` mới
