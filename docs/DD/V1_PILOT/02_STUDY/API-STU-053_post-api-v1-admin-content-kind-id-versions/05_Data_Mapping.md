...
format: "markdown"
dd_id: "API-STU-053"
api_name: "POST /api/v1/admin/content/{kind}/{id}/versions"
...
| ID bản xuất bản/bản nháp gốc, tóm tắt thay đổi | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản sao `DRAFT` mới | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: ID bản xuất bản/bản nháp gốc, tóm tắt thay đổi → bản sao `DRAFT` mới.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa thực thể ổn định; sao chép cấu trúc bất biến vào ID bản nháp; không sửa hàng đã xuất bản
