...
| Purpose | bản sao `DRAFT` mới |
| Consumer/Actor | `PERM-STU-001` |
| Authentication | `PERM-STU-001` |
| Authorization | `PERM-STU-001` |
...
- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L193` — endpoint contract.
