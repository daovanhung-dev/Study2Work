...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `courseId` | `courseId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | ID khóa học ổn định hoặc phiên bản đã xuất bản chỉ định | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID khóa học ổn định hoặc phiên bản đã xuất bản chỉ định → lần ghi danh ghim phiên bản
