...
format: "markdown"
dd_id: "API-STU-028"
api_name: "GET /api/v1/assessments/{assessmentId}/attempts"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản tóm tắt lượt làm | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang → bản tóm tắt lượt làm.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn `(user,assessment,attempt_no desc)`; phản hồi theo chính sách phát hành
