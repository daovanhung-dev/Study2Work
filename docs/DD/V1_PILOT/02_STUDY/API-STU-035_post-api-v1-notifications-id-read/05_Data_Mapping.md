...
format: "markdown"
dd_id: "API-STU-035"
api_name: "POST /api/v1/notifications/{id}/read"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | thời điểm đã đọc | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → thời điểm đã đọc.

<a id="s04"></a>
### S04. Execute source-defined processing

> Cập nhật theo điều kiện người nhận+ID; lần đọc đầu đơn điệu

- Operations/observability contract: Lặp an toàn; không cần kiểm toán
