...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/community-groups/{id}/reports` |
...
| ---: | --- | --- | --- |
| 1 | Danh mục, mô tả <=2000, tệp minh chứng sạch tùy chọn | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Danh mục, mô tả <=2000, tệp minh chứng sạch tùy chọn → báo cáo
