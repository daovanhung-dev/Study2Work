...
format: "markdown"
dd_id: "API-STU-042"
api_name: "POST /api/v1/community-groups/{id}/reports"
...
| Danh mục, mô tả <=2000, tệp minh chứng sạch tùy chọn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | báo cáo | SOURCE_REQUIRED for nested shape | API catalog |
...
- Actor/authorization source: Người học đủ điều kiện.
...
- Endpoint input contract: Danh mục, mô tả <=2000, tệp minh chứng sạch tùy chọn → báo cáo.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX tạo báo cáo + sự kiện; không có báo cáo mở trùng cùng người báo cáo/nhóm/danh mục

- Operations/observability contract: Khóa lặp; sự kiện/kiểm toán người kiểm duyệt
