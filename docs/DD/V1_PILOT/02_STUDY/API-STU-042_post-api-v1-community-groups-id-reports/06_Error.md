...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `DUPLICATE_OPEN_REPORT` | As specified by API catalog. | `SOURCE_REQUIRED` | `DUPLICATE_OPEN_REPORT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L177` |
| 2 | Endpoint business/error code | DIRECT | `FILE_NOT_CLEAN` | As specified by API catalog. | `409` | `FILE_NOT_CLEAN` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L177` |
