...
format: "markdown"
dd_id: "API-STU-021"
api_name: "GET /api/v1/me/progress/summary"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | lộ trình đang hoạt động, thẻ khóa học, lượt chờ duyệt, dữ kiện hoàn thành | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → lộ trình đang hoạt động, thẻ khóa học, lượt chờ duyệt, dữ kiện hoàn thành.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn có chỉ mục theo người dùng; phần trăm là ảnh chụp có thể dựng lại cùng `calculatedAt`

- Operations/observability contract: Riêng tư; bộ nhớ đệm người dùng 15 giây bị làm mới qua hộp thư đi
