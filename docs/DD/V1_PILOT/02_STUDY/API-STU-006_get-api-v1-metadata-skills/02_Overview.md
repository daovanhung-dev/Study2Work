...
| Purpose | kỹ năng chuẩn đang hoạt động |
...
| Side effects | Bộ nhớ đệm 10 phút |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L131` — endpoint contract.
...
- [OQ-STU-SKILLS-HISTORY](../../OPEN_QUESTIONS.md#oq-stu-skills-history).
