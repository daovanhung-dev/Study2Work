...
format: "markdown"
dd_id: "API-STU-044"
api_name: "GET /api/v1/support-requests"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | yêu cầu của chính mình | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Trang/trạng thái → yêu cầu của chính mình.

<a id="s04"></a>
### S04. Execute source-defined processing

> Truy vấn `(requester_id,status,updated_at desc)`
