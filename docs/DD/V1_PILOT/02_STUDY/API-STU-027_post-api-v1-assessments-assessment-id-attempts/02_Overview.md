...
| Purpose | lượt làm/kết quả bất biến |
...
| Side effects | Khóa lặp bắt buộc; sự kiện nộp/chấm/yêu cầu duyệt; thông báo bất đồng bộ |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L157` — endpoint contract.
