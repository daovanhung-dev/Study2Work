...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | kỳ đang hoạt động, phiên bản được ghim, tiến độ, `nextSwitchAllowedAt` | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> kỳ đang hoạt động, phiên bản được ghim, tiến độ, `nextSwitchAllowedAt`
