...
format: "markdown"
dd_id: "API-STU-008"
api_name: "PATCH /api/v1/me/study-profile"
...
| Tên hiển thị 1–100, giới thiệu <=1000, ngôn ngữ/múi giờ, ID kỹ năng | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
- Endpoint input contract: Tên hiển thị 1–100, giới thiệu <=1000, ngôn ngữ/múi giờ, ID kỹ năng, `If-Match` → hồ sơ.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX khóa hồ sơ; kiểm danh mục; thay các liên kết kỹ năng; tăng phiên bản hồ sơ

- Operations/observability contract: Khóa lặp tùy chọn; kiểm toán thay đổi PII
