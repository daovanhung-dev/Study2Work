...
| ---: | --- | --- | --- |
| 1 | Tên hiển thị 1–100, giới thiệu <=1000, ngôn ngữ/múi giờ, ID kỹ năng | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Tên hiển thị 1–100, giới thiệu <=1000, ngôn ngữ/múi giờ, ID kỹ năng, `If-Match` → hồ sơ
