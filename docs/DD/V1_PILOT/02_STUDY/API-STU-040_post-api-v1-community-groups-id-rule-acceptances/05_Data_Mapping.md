...
| Phiên bản quy tắc | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | chấp thuận | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Phiên bản quy tắc → chấp thuận.

<a id="s04"></a>
### S04. Execute source-defined processing

> TX kiểm đúng quy tắc bất biến hiện hành và điều kiện; thêm bản ghi chấp thuận
