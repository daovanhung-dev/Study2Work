...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/community-groups/{id}/rule-acceptances` |
...
| ---: | --- | --- | --- |
| 1 | Phiên bản quy tắc | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Phiên bản quy tắc → chấp thuận
