...
format: "markdown"
dd_id: "API-STU-039"
api_name: "GET /api/v1/community-groups"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | nhóm và phiên bản quy tắc hiện hành đã chấp thuận | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → nhóm và phiên bản quy tắc hiện hành đã chấp thuận.

<a id="s04"></a>
### S04. Execute source-defined processing

> Nối phạm vi nhóm qua liên kết lộ trình/khóa học rõ ràng và điều kiện người học
