...
format: "markdown"
dd_id: "API-STU-026"
api_name: "DELETE /api/v1/assessments/{assessmentId}/draft"
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `VERSION_CONFLICT` | As specified by API catalog. | `412` | `VERSION_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L156` |
| 2 | Endpoint business/error code | DIRECT | `DRAFT_ALREADY_SEALED` | As specified by API catalog. | `SOURCE_REQUIRED` | `DRAFT_ALREADY_SEALED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L156` |
