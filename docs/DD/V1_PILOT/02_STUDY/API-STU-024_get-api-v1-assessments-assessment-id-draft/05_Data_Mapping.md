...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | bản nháp/phiên bản hoặc `null` | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → bản nháp/phiên bản hoặc `null`.

<a id="s04"></a>
### S04. Execute source-defined processing

> Duy nhất người học+bài đánh giá; câu trả lời nhạy cảm không lưu đệm
