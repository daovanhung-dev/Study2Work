...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | yêu cầu/sự kiện/ghi chú đã che dữ liệu | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> yêu cầu/sự kiện/ghi chú đã che dữ liệu
...
{
  "success": false,
  "businessCode": "SUPPORT_REQUEST_NOT_FOUND",
  "message": "<SOURCE_REQUIRED>",
  "data": null,
  "meta": {
    "fieldErrors": []
