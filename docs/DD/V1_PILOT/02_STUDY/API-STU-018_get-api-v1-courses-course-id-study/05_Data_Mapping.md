...
format: "markdown"
dd_id: "API-STU-018"
api_name: "GET /api/v1/courses/{courseId}/study"
...
| ID lần ghi danh tùy chọn | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | chương trình được ghim, quyền truy cập/tiến độ | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: ID lần ghi danh tùy chọn → chương trình được ghim, quyền truy cập/tiến độ.

<a id="s04"></a>
### S04. Execute source-defined processing

> Điều kiện chủ sở hữu lần ghi danh + khóa học; nối phiên bản bất biến được ghim, chương, bài học, ảnh chụp

- Operations/observability contract: Riêng tư; ETag có điều kiện theo phiên bản nội dung
