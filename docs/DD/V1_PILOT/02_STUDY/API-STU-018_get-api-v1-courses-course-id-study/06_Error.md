...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `COURSE_NOT_ENROLLED` | As specified by API catalog. | `SOURCE_REQUIRED` | `COURSE_NOT_ENROLLED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L148` |
| 2 | Endpoint business/error code | DIRECT | `ENROLLMENT_VERSION_AMBIGUOUS` | As specified by API catalog. | `SOURCE_REQUIRED` | `ENROLLMENT_VERSION_AMBIGUOUS` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | No | `docs/BD/04_DAC_TA_API.md:L148` |
