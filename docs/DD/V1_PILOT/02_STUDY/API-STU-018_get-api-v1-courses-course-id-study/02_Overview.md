...
| Purpose | chương trình được ghim, quyền truy cập/tiến độ |
| Consumer/Actor | Người học đã ghi danh |
| Authentication | Người học đã ghi danh |
| Authorization | Người học đã ghi danh |
...
| Side effects | Riêng tư; ETag có điều kiện theo phiên bản nội dung |

## Sources

- [04_DAC_TA_API.md](../../../../BD/04_DAC_TA_API.md): `L148` — endpoint contract.
