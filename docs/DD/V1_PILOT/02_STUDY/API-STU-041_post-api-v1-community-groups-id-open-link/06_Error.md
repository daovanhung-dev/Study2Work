...
format: "markdown"
dd_id: "API-STU-041"
api_name: "POST /api/v1/community-groups/{id}/open-link"
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `RULE_ACCEPTANCE_REQUIRED` | As specified by API catalog. | `SOURCE_REQUIRED` | `RULE_ACCEPTANCE_REQUIRED` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L176` |
| 2 | Endpoint business/error code | DIRECT | `COMMUNITY_NOT_ELIGIBLE` | As specified by API catalog. | `SOURCE_REQUIRED` | `COMMUNITY_NOT_ELIGIBLE` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L176` |
