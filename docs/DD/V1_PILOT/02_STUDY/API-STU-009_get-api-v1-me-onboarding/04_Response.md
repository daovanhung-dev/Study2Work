...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | lược đồ câu hỏi, câu trả lời đã lưu, trạng thái/phiên bản | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> lược đồ câu hỏi, câu trả lời đã lưu, trạng thái/phiên bản
