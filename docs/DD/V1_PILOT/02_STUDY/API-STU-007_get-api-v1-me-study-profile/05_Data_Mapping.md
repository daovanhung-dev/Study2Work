...
format: "markdown"
dd_id: "API-STU-007"
api_name: "GET /api/v1/me/study-profile"
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | hồ sơ, trạng thái thiết lập ban đầu, chế độ hiển thị | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: → hồ sơ, trạng thái thiết lập ban đầu, chế độ hiển thị.

<a id="s04"></a>
### S04. Execute source-defined processing

> Đọc bản chiếu/hồ sơ/kỹ năng đã biết theo khóa chính người dùng
