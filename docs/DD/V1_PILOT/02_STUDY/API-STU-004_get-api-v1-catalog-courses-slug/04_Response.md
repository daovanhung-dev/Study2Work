...
| 4 | `data` | Response data | `data` | `object \| array \| null` | Yes | N/A | N/A | [S06](./05_Data_Mapping.md#s06) | xem trước chương trình khóa học/phiên bản và trạng thái của người học | SOURCE_REQUIRED for nested shape | Catalog output phrase retained below. |
...
> xem trước chương trình khóa học/phiên bản và trạng thái của người học
