...
format: "markdown"
dd_id: "API-STU-004"
api_name: "GET /api/v1/catalog/courses/{slug}"
...
| `slug` | Endpoint URI | S01 | Path parsing | Resource lookup | N/A | N/A | N/A |
| Slug | API catalog | S01/S03 | SOURCE_REQUIRED | SOURCE_REQUIRED | N/A | N/A | Not materialized as a physical key. |
...
| `data` | `object \| array \| null` | Endpoint output phrase | N/A | S06 | xem trước chương trình khóa học/phiên bản và trạng thái của người học | SOURCE_REQUIRED for nested shape | API catalog |
...
- Endpoint input contract: Slug → xem trước chương trình khóa học/phiên bản và trạng thái của người học.

<a id="s04"></a>
### S04. Execute source-defined processing

> Nối bản tóm tắt phiên bản hiện hành/chương/bài học; trạng thái người học được ghim riêng theo người dùng/khóa học

- Operations/observability contract: Phần công khai CDN 60 giây; phần riêng tư `no-store`
