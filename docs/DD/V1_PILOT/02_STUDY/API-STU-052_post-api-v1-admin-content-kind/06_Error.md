...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Endpoint business/error code | DIRECT | `SLUG_CONFLICT` | As specified by API catalog. | `SOURCE_REQUIRED` | `SLUG_CONFLICT` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L192` |
| 2 | Endpoint business/error code | DIRECT | `CONTENT_INVALID` | As specified by API catalog. | `SOURCE_REQUIRED` | `CONTENT_INVALID` | N/A — no legacy error-message ID in BD. | [S05](./05_Data_Mapping.md#s05) | TBD | `docs/BD/04_DAC_TA_API.md:L192` |
