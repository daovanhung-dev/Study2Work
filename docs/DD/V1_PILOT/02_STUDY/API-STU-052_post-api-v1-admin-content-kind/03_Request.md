...
| ---: | --- | --- | --- |
| 1 | Siêu dữ liệu ổn định + bản nháp đầu tiên | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> Siêu dữ liệu ổn định + bản nháp đầu tiên → thực thể/phiên bản
