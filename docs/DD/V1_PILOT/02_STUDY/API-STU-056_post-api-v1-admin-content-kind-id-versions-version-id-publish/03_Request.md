...
| ---: | --- |
| HTTP method | `POST` |
| URI | `/api/v1/admin/content/{kind}/{id}/versions/{versionId}/publish` |
...
| 3 | `versionId` | `versionId` | `string` | Yes | N/A | N/A | Path segment | SOURCE_REQUIRED | N/A | DIRECT from URI. | [S01](./05_Data_Mapping.md#s01) |
...
| ---: | --- | --- | --- |
| 1 | ID kiểm tra, , ghi chú xuất bản | Physical key, location, type or rule | `SOURCE_REQUIRED`; not included in JSON example. |

## Contract source

> ID kiểm tra, `If-Match`, ghi chú xuất bản → phiên bản đã xuất bản
