# Overview — AUTH-RESET-001

## 1. Business intent

**Đặt lại mật khẩu** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/auth/reset-password` và gắn `traceId`.
...
- Ghi chú endpoint: Token một lần và hết hạn.
