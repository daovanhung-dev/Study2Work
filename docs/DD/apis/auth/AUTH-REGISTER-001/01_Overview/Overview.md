...
**Đăng ký tài khoản** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/auth/register` và gắn `traceId`.
...
- Ghi chú endpoint: Không tự cấp quyền admin.
