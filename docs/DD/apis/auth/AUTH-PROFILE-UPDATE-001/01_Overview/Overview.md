# Overview — AUTH-PROFILE-UPDATE-001

## 1. Business intent

**Cập nhật hồ sơ cá nhân** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `PATCH /api/v1/users/me` và gắn `traceId`.
...
- Ghi chú endpoint: Thay đổi contact có thể yêu cầu xác thực lại.
