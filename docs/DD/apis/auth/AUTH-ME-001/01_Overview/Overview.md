# Overview — AUTH-ME-001

## 1. Business intent

**Lấy hồ sơ người dùng hiện tại** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `GET /api/v1/users/me` và gắn `traceId`.
...
- Ghi chú endpoint: Không trả secret hoặc token.
