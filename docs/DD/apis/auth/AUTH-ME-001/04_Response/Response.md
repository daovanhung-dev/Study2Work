...
| email | string | Giá trị trả về của contract |
| fullName | string | Giá trị trả về của contract |
| roles | array | Giá trị trả về của contract |
| contactStatus | string | Giá trị trả về của contract |
| onboardingStatus | string | Giá trị trả về của contract |
