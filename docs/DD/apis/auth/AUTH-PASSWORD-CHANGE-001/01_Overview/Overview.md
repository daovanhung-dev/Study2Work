# Overview — AUTH-PASSWORD-CHANGE-001

## 1. Business intent

**Đổi mật khẩu** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/auth/change-password` và gắn `traceId`.
...
- Ghi chú endpoint: Thu hồi session khác theo chính sách.
