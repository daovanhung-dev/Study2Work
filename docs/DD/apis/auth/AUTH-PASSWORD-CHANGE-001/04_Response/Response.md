# Response — AUTH-PASSWORD-CHANGE-001
...
{
  "success": true,
  "code": "AUTH-PASSWORD-CHANGE-SUCCESS",
  "message": "Thành công",
  "data": {
    "changed": true,
    "revokedSessions": 1
...
| --- | --- | --- |
| changed | boolean | Giá trị trả về của contract |
| revokedSessions | integer | Giá trị trả về của contract |
