# Request — AUTH-PASSWORD-CHANGE-001
...
| --- | --- | --- | --- | --- |
| currentPassword | string | Yes | credential | Theo schema endpoint và rule nghiệp vụ |
| newPassword | string | Yes | credential | Theo schema endpoint và rule nghiệp vụ |
