# Error — AUTH-PASSWORD-CHANGE-001
...
| 422 | DOMAIN_RULE_VIOLATION | Mật khẩu chỉ được xử lý dạng hash; xác thực liên hệ là điều kiện trước onboarding và kích hoạt lộ trình. |
