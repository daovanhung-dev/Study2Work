# Overview — AUTH-RESEND-001

## 1. Business intent

**Gửi lại mã xác thực** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/auth/resend-verification` và gắn `traceId`.
...
- Ghi chú endpoint: Chống spam theo target và IP.
