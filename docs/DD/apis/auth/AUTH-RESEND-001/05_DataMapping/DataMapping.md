...
| sent | - | Read model / response DTO | Filter by scope before serialization |
| retryAfterSeconds | - | Read model / response DTO | Filter by scope before serialization |
