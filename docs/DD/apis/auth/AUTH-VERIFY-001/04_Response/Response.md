...
{
  "success": true,
  "code": "AUTH-VERIFY-SUCCESS",
  "message": "Thành công",
  "data": {
    "verified": true,
    "verifiedAt": "2026-07-05T12:00:00+07:00"
  },
...
| --- | --- | --- |
| verified | boolean | Giá trị trả về của contract |
| verifiedAt | datetime | Giá trị trả về của contract |
