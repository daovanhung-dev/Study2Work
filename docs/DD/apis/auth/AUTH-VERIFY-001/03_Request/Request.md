...
| --- | --- | --- | --- | --- |
| channel | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| target | string | Yes | PII | Theo schema endpoint và rule nghiệp vụ |
| code | string | Yes | credential | Theo schema endpoint và rule nghiệp vụ |
