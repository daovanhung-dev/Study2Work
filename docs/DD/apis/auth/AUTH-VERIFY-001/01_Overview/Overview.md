...
**Xác thực email hoặc số điện thoại** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/auth/verify-contact` và gắn `traceId`.
...
- Ghi chú endpoint: Mã dùng một lần và hết hạn.
