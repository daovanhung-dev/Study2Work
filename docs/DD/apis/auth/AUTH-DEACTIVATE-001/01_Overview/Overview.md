# Overview — AUTH-DEACTIVATE-001

## 1. Business intent

**Yêu cầu vô hiệu hóa tài khoản** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/users/me/deactivate` và gắn `traceId`.
...
- Ghi chú endpoint: Không xóa dữ liệu audit và dữ liệu cần lưu giữ.
