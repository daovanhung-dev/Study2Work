...
{
  "success": true,
  "code": "AUTH-DEACTIVATE-SUCCESS",
  "message": "Thành công",
  "data": {
    "deactivated": true,
    "effectiveAt": "2026-07-05T12:00:00+07:00"
  },
...
| --- | --- | --- |
| deactivated | boolean | Giá trị trả về của contract |
| effectiveAt | datetime | Giá trị trả về của contract |
