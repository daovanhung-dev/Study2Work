# Data Mapping — AUTH-DEACTIVATE-001
...
| deactivated | - | Read model / response DTO | Filter by scope before serialization |
| effectiveAt | - | Read model / response DTO | Filter by scope before serialization |
