# AUTH-DEACTIVATE-001 — Yêu cầu vô hiệu hóa tài khoản

| Thuộc tính | Giá trị |
| --- | --- |
| Method | `POST` |
| Endpoint | `/api/v1/users/me/deactivate` |
...
Yêu cầu vô hiệu hóa tài khoản. Không xóa dữ liệu audit và dữ liệu cần lưu giữ
