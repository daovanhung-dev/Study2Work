...
**Đăng nhập** thuộc module **02. Tài khoản, xác thực và hồ sơ**.
...
1. API gateway/controller nhận `POST /api/v1/auth/login` và gắn `traceId`.
...
- Ghi chú endpoint: Rate limit và lockout theo chính sách.
