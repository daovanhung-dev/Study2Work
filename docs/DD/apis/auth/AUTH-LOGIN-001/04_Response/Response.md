...
| --- | --- | --- |
| accessToken | string | Giá trị trả về của contract |
| refreshToken | string | Giá trị trả về của contract |
| expiresIn | integer | Giá trị trả về của contract |
| user | object | Giá trị trả về của contract |
