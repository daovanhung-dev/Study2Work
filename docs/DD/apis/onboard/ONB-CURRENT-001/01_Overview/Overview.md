# Overview — ONB-CURRENT-001

## 1. Business intent

**Lấy phiên onboarding hiện tại** thuộc module **03. Onboarding**.
...
1. API gateway/controller nhận `GET /api/v1/onboarding/current` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ owner truy cập.
