# Overview — ONB-CONFIRM-001

## 1. Business intent

**Xác nhận hoàn tất onboarding** thuộc module **03. Onboarding**.
...
1. API gateway/controller nhận `POST /api/v1/onboarding/confirm` và gắn `traceId`.
...
- Ghi chú endpoint: Contact phải VERIFIED; selected path phải PUBLISHED.
