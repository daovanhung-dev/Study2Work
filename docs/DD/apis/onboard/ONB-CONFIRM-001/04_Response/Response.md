...
{
  "success": true,
  "code": "ONB-CONFIRM-SUCCESS",
  "message": "Thành công",
  "data": {
    "onboardingStatus": "example",
    "learnerProfile": {},
...
| learnerProfile | object | Giá trị trả về của contract |
| eligibleToActivate | boolean | Giá trị trả về của contract |
