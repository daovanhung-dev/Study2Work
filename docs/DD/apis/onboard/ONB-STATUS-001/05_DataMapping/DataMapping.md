...
| --- | --- | --- | --- |
| contactVerified | - | Read model / response DTO | Filter by scope before serialization |
| onboardingCompleted | - | Read model / response DTO | Filter by scope before serialization |
| blockingReasons | - | Read model / response DTO | Filter by scope before serialization |
