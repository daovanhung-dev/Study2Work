...
| --- | --- | --- |
| contactVerified | boolean | Giá trị trả về của contract |
| onboardingCompleted | boolean | Giá trị trả về của contract |
