# Overview — ONB-STATUS-001

## 1. Business intent

**Lấy trạng thái điều kiện trước khi học** thuộc module **03. Onboarding**.
...
1. API gateway/controller nhận `GET /api/v1/onboarding/status` và gắn `traceId`.
...
- Ghi chú endpoint: Dùng bởi guard frontend nhưng backend vẫn kiểm tra.
