# Overview — ONB-RECOMMEND-001

## 1. Business intent

**Lấy gợi ý lộ trình theo onboarding** thuộc module **03. Onboarding**.
...
1. API gateway/controller nhận `GET /api/v1/onboarding/recommended-paths` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ trả gợi ý khi dữ liệu tối thiểu đủ.
