...
{
  "success": true,
  "code": "ONB-RECOMMEND-SUCCESS",
  "message": "Thành công",
  "data": {
    "items": [],
    "generatedAt": "2026-07-05T12:00:00+07:00",
    "reasonCodes": []
  },
...
| generatedAt | datetime | Giá trị trả về của contract |
| reasonCodes | array | Giá trị trả về của contract |
