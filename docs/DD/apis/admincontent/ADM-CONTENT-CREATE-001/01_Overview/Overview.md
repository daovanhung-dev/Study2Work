# Overview — ADM-CONTENT-CREATE-001

## 1. Business intent

**Tạo nội dung nháp** thuộc module **10. Admin quản trị nội dung**.
...
1. API gateway/controller nhận `POST /api/v1/admin/content/{contentType}` và gắn `traceId`.
...
- Ghi chú endpoint: Schema theo contentType, draft mặc định.
