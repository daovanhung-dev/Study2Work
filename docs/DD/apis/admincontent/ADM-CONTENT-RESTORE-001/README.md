# ADM-CONTENT-RESTORE-001 — Khôi phục phiên bản nội dung

| Thuộc tính | Giá trị |
| --- | --- |
| Method | `POST` |
| Endpoint | `/api/v1/admin/content/{contentType}/{contentId}/restore-version` |
...
Khôi phục phiên bản nội dung. Tạo version mới từ snapshot, không mutate lịch sử
