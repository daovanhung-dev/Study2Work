# Overview — ADM-CONTENT-UNPUBLISH-001

## 1. Business intent

**Gỡ publish nội dung** thuộc module **10. Admin quản trị nội dung**.
...
1. API gateway/controller nhận `POST /api/v1/admin/content/{contentType}/{contentId}/unpublish` và gắn `traceId`.
...
- Ghi chú endpoint: Không phá lịch sử learner; có quyết định fallback.
