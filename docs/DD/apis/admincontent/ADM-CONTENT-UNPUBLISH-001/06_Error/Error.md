# Error — ADM-CONTENT-UNPUBLISH-001
...
| 409 | STATE_CONFLICT | Trạng thái hiện tại không cho phép thao tác |
| 422 | DOMAIN_RULE_VIOLATION | Nội dung chỉ PUBLISH sau pre-publish check thành công; archive không xóa dữ liệu lịch sử học; thao tác rủi ro phải ghi audit reason và before/after. |
