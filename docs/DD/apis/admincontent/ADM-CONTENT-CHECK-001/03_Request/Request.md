...
| --- | --- |
| Method | `POST` |
| URL | `/api/v1/admin/content/{contentType}/{contentId}/pre-publish-check` |
...
| --- | --- | --- | --- | --- |
| targetVersion | integer | No | normal | Theo schema endpoint và rule nghiệp vụ |
