# Overview — ADM-CONTENT-UPDATE-001

## 1. Business intent

**Cập nhật nội dung** thuộc module **10. Admin quản trị nội dung**.
...
1. API gateway/controller nhận `PUT /api/v1/admin/content/{contentType}/{contentId}` và gắn `traceId`.
...
- Ghi chú endpoint: Optimistic concurrency; audit before/after.
