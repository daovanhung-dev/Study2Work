# Data Mapping — ADM-CONTENT-PUBLISH-001
...
| publishedAt | - | Read model / response DTO | Filter by scope before serialization |
| publicVersion | - | Read model / response DTO | Filter by scope before serialization |
