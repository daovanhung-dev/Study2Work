# Response — ADM-CONTENT-PUBLISH-001
...
{
  "success": true,
  "code": "ADM-CONTENT-PUBLISH-SUCCESS",
  "message": "Thành công",
  "data": {
    "id": "00000000-0000-4000-8000-000000000001",
    "status": "DRAFT",
    "publishedAt": "2026-07-05T12:00:00+07:00",
    "publicVersion": 1
  },
...
| publishedAt | datetime | Giá trị trả về của contract |
| publicVersion | integer | Giá trị trả về của contract |
