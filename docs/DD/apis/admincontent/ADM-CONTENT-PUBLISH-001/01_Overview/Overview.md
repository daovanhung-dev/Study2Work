# Overview — ADM-CONTENT-PUBLISH-001

## 1. Business intent

**Publish nội dung** thuộc module **10. Admin quản trị nội dung**.
...
1. API gateway/controller nhận `POST /api/v1/admin/content/{contentType}/{contentId}/publish` và gắn `traceId`.
...
- Ghi chú endpoint: Check success, audit reason và quyền phù hợp.
