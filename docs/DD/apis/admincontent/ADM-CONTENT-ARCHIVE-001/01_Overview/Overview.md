# Overview — ADM-CONTENT-ARCHIVE-001

## 1. Business intent

**Lưu trữ nội dung** thuộc module **10. Admin quản trị nội dung**.
...
1. API gateway/controller nhận `POST /api/v1/admin/content/{contentType}/{contentId}/archive` và gắn `traceId`.
...
- Ghi chú endpoint: Không hard delete khi đã có lịch sử học.
