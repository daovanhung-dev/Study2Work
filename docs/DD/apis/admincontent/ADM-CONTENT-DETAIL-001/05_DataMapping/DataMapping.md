# Data Mapping — ADM-CONTENT-DETAIL-001
...
| --- | --- | --- | --- |
| content | - | Read model / response DTO | Filter by scope before serialization |
| version | - | Read model / response DTO | Filter by scope before serialization |
| publishState | - | Read model / response DTO | Filter by scope before serialization |
