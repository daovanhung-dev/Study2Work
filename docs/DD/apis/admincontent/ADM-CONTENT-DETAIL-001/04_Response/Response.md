# Response — ADM-CONTENT-DETAIL-001
...
{
  "success": true,
  "code": "ADM-CONTENT-DETAIL-SUCCESS",
  "message": "Thành công",
  "data": {
    "content": {},
    "version": {},
...
| --- | --- | --- |
| content | object | Giá trị trả về của contract |
| version | object | Giá trị trả về của contract |
| publishState | object | Giá trị trả về của contract |
