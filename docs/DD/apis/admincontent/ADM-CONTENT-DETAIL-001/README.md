# ADM-CONTENT-DETAIL-001 — Lấy chi tiết nội dung quản trị

| Thuộc tính | Giá trị |
| --- | --- |
| Method | `GET` |
| Endpoint | `/api/v1/admin/content/{contentType}/{contentId}` |
...
Lấy chi tiết nội dung quản trị. Gồm draft metadata, không đưa ra public
