# Overview — ADM-CONTENT-REORDER-001

## 1. Business intent

**Sắp xếp nội dung con** thuộc module **10. Admin quản trị nội dung**.
...
1. API gateway/controller nhận `PATCH /api/v1/admin/content/{contentType}/{contentId}/ordering` và gắn `traceId`.
...
- Ghi chú endpoint: Validate parent và optimistic concurrency.
