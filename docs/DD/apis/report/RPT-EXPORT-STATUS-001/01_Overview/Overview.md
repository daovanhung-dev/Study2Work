# Overview — RPT-EXPORT-STATUS-001

## 1. Business intent

**Lấy trạng thái job xuất báo cáo** thuộc module **12. Báo cáo vận hành**.
...
1. API gateway/controller nhận `GET /api/v1/admin/reports/exports/{jobId}` và gắn `traceId`.
...
- Ghi chú endpoint: Download URL signed và có hạn dùng.
