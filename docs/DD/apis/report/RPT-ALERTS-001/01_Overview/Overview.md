# Overview — RPT-ALERTS-001

## 1. Business intent

**Lấy cảnh báo vận hành** thuộc module **12. Báo cáo vận hành**.
...
1. API gateway/controller nhận `GET /api/v1/admin/reports/alerts` và gắn `traceId`.
...
- Ghi chú endpoint: Không nêu PII không cần thiết.
