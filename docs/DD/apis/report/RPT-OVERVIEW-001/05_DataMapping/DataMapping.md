...
| --- | --- | --- | --- |
| range | - | Read model / response DTO | Filter by scope before serialization |
| metrics | - | Read model / response DTO | Filter by scope before serialization |
| series | - | Read model / response DTO | Filter by scope before serialization |
| breakdowns | - | Read model / response DTO | Filter by scope before serialization |
