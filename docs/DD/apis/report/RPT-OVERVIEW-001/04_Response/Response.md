...
| --- | --- | --- |
| range | object | Giá trị trả về của contract |
| metrics | object | Giá trị trả về của contract |
| series | array | Giá trị trả về của contract |
| breakdowns | object | Giá trị trả về của contract |
