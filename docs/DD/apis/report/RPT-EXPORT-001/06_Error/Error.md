...
| 422 | DOMAIN_RULE_VIOLATION | Báo cáo dùng dữ liệu tổng hợp theo quyền xem; export lớn xử lý bất đồng bộ và liên kết tải xuống có hạn dùng. |
