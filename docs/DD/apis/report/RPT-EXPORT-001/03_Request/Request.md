...
| --- | --- | --- | --- | --- |
| reportType | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| filters | object | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| format | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
