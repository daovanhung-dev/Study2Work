...
{
  "success": true,
  "code": "EXE-REVIEW-SUCCESS",
  "message": "Thành công",
  "data": {
    "submissionId": "00000000-0000-4000-8000-000000000001",
    "status": "DRAFT",
    "score": {},
    "reviewedAt": "2026-07-05T12:00:00+07:00"
  },
...
| --- | --- | --- |
| submissionId | uuid | Giá trị trả về của contract |
| status | string | Giá trị trả về của contract |
| score | object | Giá trị trả về của contract |
| reviewedAt | datetime | Giá trị trả về của contract |
