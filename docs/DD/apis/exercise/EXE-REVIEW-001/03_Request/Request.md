...
| --- | --- |
| Method | `PATCH` |
| URL | `/api/v1/admin/exercise-submissions/{submissionId}/review` |
...
| --- | --- | --- | --- |
| submissionId | uuid / slug | Yes | Phải tồn tại và caller có quyền truy cập |
...
| --- | --- | --- | --- | --- |
| score | number | No | normal | Theo schema endpoint và rule nghiệp vụ |
| feedback | string | Yes | PII | Theo schema endpoint và rule nghiệp vụ |
| status | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
