# Overview — EXE-SUBMISSION-DETAIL-001

## 1. Business intent

**Lấy chi tiết bài nộp** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `GET /api/v1/exercise-submissions/{submissionId}` và gắn `traceId`.
...
- Ghi chú endpoint: Owner hoặc reviewer trong scope.
