# Overview — EXE-ATTEMPT-LIST-001

## 1. Business intent

**Lấy lịch sử lượt làm của learner** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `GET /api/v1/exercises/{exerciseId}/attempts` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ owner hoặc reviewer hợp lệ.
