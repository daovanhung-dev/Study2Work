# Overview — EXE-START-001

## 1. Business intent

**Bắt đầu lượt làm bài** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `POST /api/v1/exercises/{exerciseId}/attempts` và gắn `traceId`.
...
- Ghi chú endpoint: Server kiểm tra số lượt và thời hạn.
