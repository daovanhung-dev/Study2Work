...
{
  "success": true,
  "code": "EXE-START-SUCCESS",
  "message": "Thành công",
  "data": {
    "attemptId": "00000000-0000-4000-8000-000000000001",
    "status": "DRAFT",
    "startedAt": "2026-07-05T12:00:00+07:00",
...
| --- | --- | --- |
| attemptId | uuid | Giá trị trả về của contract |
| status | string | Giá trị trả về của contract |
| startedAt | datetime | Giá trị trả về của contract |
