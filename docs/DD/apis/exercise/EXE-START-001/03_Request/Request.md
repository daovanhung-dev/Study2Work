...
| --- | --- |
| Method | `POST` |
| URL | `/api/v1/exercises/{exerciseId}/attempts` |
...
| --- | --- | --- | --- | --- |
| clientStartedAt | datetime | No | normal | Theo schema endpoint và rule nghiệp vụ |
...
```json
{
  "clientStartedAt": "2026-07-05T12:00:00+07:00"
}
```
