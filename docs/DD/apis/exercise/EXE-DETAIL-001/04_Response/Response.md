...
| --- | --- | --- |
| exercise | object | Giá trị trả về của contract |
| questions | array | Giá trị trả về của contract |
| attemptPolicy | object | Giá trị trả về của contract |
