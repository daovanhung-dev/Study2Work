# Overview — EXE-DETAIL-001

## 1. Business intent

**Lấy đề bài theo quyền learner** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `GET /api/v1/exercises/{exerciseId}` và gắn `traceId`.
...
- Ghi chú endpoint: Không trả đáp án hoặc rubric nội bộ khi chưa được phép.
