...
| --- | --- | --- | --- |
| exercise | - | Read model / response DTO | Filter by scope before serialization |
| questions | - | Read model / response DTO | Filter by scope before serialization |
| attemptPolicy | - | Read model / response DTO | Filter by scope before serialization |
