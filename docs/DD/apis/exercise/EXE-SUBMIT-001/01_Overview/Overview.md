# Overview — EXE-SUBMIT-001

## 1. Business intent

**Nộp bài** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `POST /api/v1/exercises/{exerciseId}/submissions` và gắn `traceId`.
...
- Ghi chú endpoint: Idempotency-Key bắt buộc với thao tác nộp.
