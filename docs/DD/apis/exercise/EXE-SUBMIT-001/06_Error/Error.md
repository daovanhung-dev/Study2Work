...
| 422 | DOMAIN_RULE_VIOLATION | Điểm và trạng thái nộp do server tính; thời hạn, số lần nộp và điều kiện nộp lại được kiểm tra server-side. |
