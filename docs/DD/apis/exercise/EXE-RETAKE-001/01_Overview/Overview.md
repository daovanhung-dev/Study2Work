# Overview — EXE-RETAKE-001

## 1. Business intent

**Kiểm tra quyền nộp lại** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `GET /api/v1/exercises/{exerciseId}/retake-eligibility` và gắn `traceId`.
...
- Ghi chú endpoint: Không dùng kết quả này để bỏ qua kiểm tra server.
