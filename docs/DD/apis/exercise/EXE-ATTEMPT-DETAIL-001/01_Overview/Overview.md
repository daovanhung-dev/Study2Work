# Overview — EXE-ATTEMPT-DETAIL-001

## 1. Business intent

**Lấy chi tiết lượt làm** thuộc module **06. Bài tập và đánh giá**.
...
1. API gateway/controller nhận `GET /api/v1/exercise-attempts/{attemptId}` và gắn `traceId`.
...
- Ghi chú endpoint: Áp dụng phản hồi/đáp án theo trạng thái.
