...
| stats | - | Read model / response DTO | Filter by scope before serialization |
| nextLesson | - | Read model / response DTO | Filter by scope before serialization |
