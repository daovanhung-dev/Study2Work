# Overview — PRG-SUMMARY-001

## 1. Business intent

**Lấy tổng quan tiến độ** thuộc module **07. Tiến độ và hoàn thành**.
...
1. API gateway/controller nhận `GET /api/v1/progress/summary` và gắn `traceId`.
...
- Ghi chú endpoint: Dữ liệu tính từ nguồn server-authoritative.
