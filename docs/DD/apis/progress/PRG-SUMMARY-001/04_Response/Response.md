...
| courseProgress | array | Giá trị trả về của contract |
| stats | object | Giá trị trả về của contract |
| nextLesson | object | Giá trị trả về của contract |
