...
| --- | --- | --- | --- |
| pathProgress | - | Read model / response DTO | Filter by scope before serialization |
| courses | - | Read model / response DTO | Filter by scope before serialization |
| completionRules | - | Read model / response DTO | Filter by scope before serialization |
