# Overview — PRG-PATH-001

## 1. Business intent

**Lấy tiến độ theo lộ trình** thuộc module **07. Tiến độ và hoàn thành**.
...
1. API gateway/controller nhận `GET /api/v1/progress/learning-paths/{pathId}` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ owner hoặc role có quyền support.
