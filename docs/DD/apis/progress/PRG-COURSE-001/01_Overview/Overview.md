# Overview — PRG-COURSE-001

## 1. Business intent

**Lấy tiến độ theo khóa học** thuộc module **07. Tiến độ và hoàn thành**.
...
1. API gateway/controller nhận `GET /api/v1/progress/courses/{courseId}` và gắn `traceId`.
