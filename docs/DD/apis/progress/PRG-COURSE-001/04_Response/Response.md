...
| --- | --- | --- |
| courseProgress | object | Giá trị trả về của contract |
| lessons | array | Giá trị trả về của contract |
| assessments | array | Giá trị trả về của contract |
