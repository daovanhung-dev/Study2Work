...
| --- | --- | --- | --- |
| courseProgress | - | Read model / response DTO | Filter by scope before serialization |
| lessons | - | Read model / response DTO | Filter by scope before serialization |
| assessments | - | Read model / response DTO | Filter by scope before serialization |
