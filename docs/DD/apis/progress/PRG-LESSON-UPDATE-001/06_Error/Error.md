...
| 422 | DOMAIN_RULE_VIOLATION | Tiến độ, mở khóa và điểm tổng kết là dữ liệu server-authoritative; client không truyền giá trị completion hoặc score tự quyết. |
