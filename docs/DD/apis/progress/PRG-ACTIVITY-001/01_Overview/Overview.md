# Overview — PRG-ACTIVITY-001

## 1. Business intent

**Lấy lịch sử hoạt động học** thuộc module **07. Tiến độ và hoàn thành**.
...
1. API gateway/controller nhận `GET /api/v1/progress/activity` và gắn `traceId`.
...
- Ghi chú endpoint: Filters from, to, pathId, courseId.
