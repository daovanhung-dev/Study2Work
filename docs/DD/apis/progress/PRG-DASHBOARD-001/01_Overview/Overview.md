# Overview — PRG-DASHBOARD-001

## 1. Business intent

**Lấy dữ liệu dashboard learner** thuộc module **07. Tiến độ và hoàn thành**.
...
1. API gateway/controller nhận `GET /api/v1/learner/dashboard` và gắn `traceId`.
...
- Ghi chú endpoint: BFF read model, không thay thế endpoint nguồn.
