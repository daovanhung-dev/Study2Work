# Overview — COM-MY-ACCESS-001

## 1. Business intent

**Lấy phạm vi nhóm learner được xem** thuộc module **08. Cộng đồng Zalo**.
...
1. API gateway/controller nhận `GET /api/v1/community-groups/my-access` và gắn `traceId`.
...
- Ghi chú endpoint: Dùng để điều phối UI.
