...
| --- | --- |
| Method | `POST` |
| URL | `/api/v1/admin/community-groups` |
...
| --- | --- | --- | --- | --- |
| name | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| description | string | No | normal | Theo schema endpoint và rule nghiệp vụ |
| externalUrl | string | Yes | external | Theo schema endpoint và rule nghiệp vụ |
| scopeType | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
