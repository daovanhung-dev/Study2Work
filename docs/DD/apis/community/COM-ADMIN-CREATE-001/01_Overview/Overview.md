# Overview — COM-ADMIN-CREATE-001

## 1. Business intent

**Tạo nhóm cộng đồng** thuộc module **08. Cộng đồng Zalo**.
...
1. API gateway/controller nhận `POST /api/v1/admin/community-groups` và gắn `traceId`.
...
- Ghi chú endpoint: URL được validate và audit.
