# Overview — COM-REPORT-001

## 1. Business intent

**Báo cáo nhóm hoặc link cộng đồng** thuộc module **08. Cộng đồng Zalo**.
...
1. API gateway/controller nhận `POST /api/v1/community-groups/{groupId}/reports` và gắn `traceId`.
...
- Ghi chú endpoint: Rate limit và ẩn PII trong danh sách moderator.
