...
| --- | --- |
| Method | `POST` |
| URL | `/api/v1/community-groups/{groupId}/reports` |
...
| --- | --- | --- | --- | --- |
| reasonCode | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| description | string | No | PII | Theo schema endpoint và rule nghiệp vụ |
