...
| name | string | Giá trị trả về của contract |
| description | string | Giá trị trả về của contract |
| eligibility | object | Giá trị trả về của contract |
| openPolicy | object | Giá trị trả về của contract |
