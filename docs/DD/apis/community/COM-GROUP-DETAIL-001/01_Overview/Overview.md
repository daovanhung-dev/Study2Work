# Overview — COM-GROUP-DETAIL-001

## 1. Business intent

**Lấy chi tiết nhóm cộng đồng** thuộc module **08. Cộng đồng Zalo**.
...
1. API gateway/controller nhận `GET /api/v1/community-groups/{groupId}` và gắn `traceId`.
...
- Ghi chú endpoint: Không trả URL gốc nếu có policy che giấu.
