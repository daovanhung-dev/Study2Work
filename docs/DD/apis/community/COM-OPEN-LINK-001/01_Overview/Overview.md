# Overview — COM-OPEN-LINK-001

## 1. Business intent

**Tạo phiên mở link Zalo** thuộc module **08. Cộng đồng Zalo**.
...
1. API gateway/controller nhận `POST /api/v1/community-groups/{groupId}/open-link` và gắn `traceId`.
...
- Ghi chú endpoint: Ghi log mở link, không xác nhận join.
