# Overview — COM-ADMIN-ARCHIVE-001

## 1. Business intent

**Lưu trữ nhóm cộng đồng** thuộc module **08. Cộng đồng Zalo**.
...
1. API gateway/controller nhận `POST /api/v1/admin/community-groups/{groupId}/archive` và gắn `traceId`.
...
- Ghi chú endpoint: Group archive không xóa report/log.
