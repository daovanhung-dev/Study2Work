...
| 422 | DOMAIN_RULE_VIOLATION | Study chỉ quản lý danh mục nhóm, phạm vi hiển thị và log mở liên kết; không đồng bộ thành viên, tin nhắn hay dữ liệu riêng tư từ Zalo. |
