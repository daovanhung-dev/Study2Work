# Overview — CNT-LESSON-RESOURCES-001

## 1. Business intent

**Lấy danh sách tài nguyên bài học** thuộc module **05. Khóa học và nội dung học**.
...
1. API gateway/controller nhận `GET /api/v1/lessons/{lessonId}/resources` và gắn `traceId`.
...
- Ghi chú endpoint: Không trả file private trực tiếp.
