# Overview — CNT-BOOKMARK-LIST-001

## 1. Business intent

**Lấy bookmark của learner** thuộc module **05. Khóa học và nội dung học**.
...
1. API gateway/controller nhận `GET /api/v1/bookmarks` và gắn `traceId`.
...
- Ghi chú endpoint: Filters courseId, pathId.
