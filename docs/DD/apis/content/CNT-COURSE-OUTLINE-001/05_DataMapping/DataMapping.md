# Data Mapping — CNT-COURSE-OUTLINE-001
...
| --- | --- | --- | --- |
| course | - | Read model / response DTO | Filter by scope before serialization |
| chapters | - | Read model / response DTO | Filter by scope before serialization |
| unlockState | - | Read model / response DTO | Filter by scope before serialization |
