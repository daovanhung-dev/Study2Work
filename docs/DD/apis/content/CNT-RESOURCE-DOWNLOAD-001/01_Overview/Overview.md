# Overview — CNT-RESOURCE-DOWNLOAD-001

## 1. Business intent

**Xin signed URL tải tài liệu** thuộc module **05. Khóa học và nội dung học**.
...
1. API gateway/controller nhận `POST /api/v1/lesson-resources/{resourceId}/download-url` và gắn `traceId`.
...
- Ghi chú endpoint: Log download intent, enforce quyền truy cập.
