# Error — CNT-RESOURCE-DOWNLOAD-001
...
| 422 | DOMAIN_RULE_VIOLATION | Chỉ học nội dung thuộc lộ trình đã kích hoạt và được mở khóa; media dùng signed URL ngắn hạn, không trả URL lưu trữ gốc. |
