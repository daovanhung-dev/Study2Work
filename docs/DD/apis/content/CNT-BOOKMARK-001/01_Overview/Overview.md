# Overview — CNT-BOOKMARK-001

## 1. Business intent

**Tạo hoặc cập nhật bookmark bài học** thuộc module **05. Khóa học và nội dung học**.
...
1. API gateway/controller nhận `POST /api/v1/lessons/{lessonId}/bookmarks` và gắn `traceId`.
...
- Ghi chú endpoint: Note chỉ owner xem.
