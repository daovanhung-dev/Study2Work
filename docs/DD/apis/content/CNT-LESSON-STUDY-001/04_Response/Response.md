...
| --- | --- | --- |
| lesson | object | Giá trị trả về của contract |
| resources | array | Giá trị trả về của contract |
| media | object | Giá trị trả về của contract |
| progress | object | Giá trị trả về của contract |
| nextAction | object | Giá trị trả về của contract |
