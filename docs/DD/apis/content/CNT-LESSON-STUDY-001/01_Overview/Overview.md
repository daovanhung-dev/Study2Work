# Overview — CNT-LESSON-STUDY-001

## 1. Business intent

**Mở phiên học bài học** thuộc module **05. Khóa học và nội dung học**.
...
1. API gateway/controller nhận `GET /api/v1/lessons/{lessonId}/study` và gắn `traceId`.
...
- Ghi chú endpoint: Signed URL, unlock và entitlements kiểm tra server.
