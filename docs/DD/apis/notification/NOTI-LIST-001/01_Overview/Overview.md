# Overview — NOTI-LIST-001

## 1. Business intent

**Lấy thông báo của người dùng** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `GET /api/v1/notifications` và gắn `traceId`.
...
- Ghi chú endpoint: Filters type, readStatus, from, to.
