# Overview — NOTI-ADMIN-ARCHIVE-001

## 1. Business intent

**Lưu trữ thông báo** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `POST /api/v1/admin/notifications/{notificationId}/archive` và gắn `traceId`.
...
- Ghi chú endpoint: Không xóa delivery history.
