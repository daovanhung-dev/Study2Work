# Overview — NOTI-MARK-ALL-001

## 1. Business intent

**Đánh dấu tất cả đã đọc** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `POST /api/v1/notifications/mark-all-read` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ notification của owner.
