# Overview — NOTI-MARK-READ-001

## 1. Business intent

**Đánh dấu thông báo đã đọc** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `PATCH /api/v1/notifications/{notificationId}/read` và gắn `traceId`.
