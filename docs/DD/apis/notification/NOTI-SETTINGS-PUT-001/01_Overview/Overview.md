# Overview — NOTI-SETTINGS-PUT-001

## 1. Business intent

**Cập nhật thiết lập nhận thông báo** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `PUT /api/v1/notification-settings/me` và gắn `traceId`.
...
- Ghi chú endpoint: Validate timezone và opt-in.
