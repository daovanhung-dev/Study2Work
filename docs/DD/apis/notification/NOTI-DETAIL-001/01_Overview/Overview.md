# Overview — NOTI-DETAIL-001

## 1. Business intent

**Lấy chi tiết thông báo** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `GET /api/v1/notifications/{notificationId}` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ recipient truy cập.
