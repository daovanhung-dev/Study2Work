...
```json
{
  ...
  "data": {
    ...
    "title": "example",
    "body": "example",
    "readAt": "2026-07-05T12:00:00+07:00"
  },
...
| type | string | Giá trị trả về của contract |
| title | string | Giá trị trả về của contract |
| body | string | Giá trị trả về của contract |
| readAt | datetime | Giá trị trả về của contract |
