# Overview — NOTI-ADMIN-SEND-001

## 1. Business intent

**Gửi thông báo** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `POST /api/v1/admin/notifications/{notificationId}/send` và gắn `traceId`.
...
- Ghi chú endpoint: Idempotent send và audit.
