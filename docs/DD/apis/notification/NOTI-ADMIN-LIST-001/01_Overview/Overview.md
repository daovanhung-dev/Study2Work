# Overview — NOTI-ADMIN-LIST-001

## 1. Business intent

**Danh sách thông báo quản trị** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `GET /api/v1/admin/notifications` và gắn `traceId`.
