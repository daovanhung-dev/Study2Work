...
| --- | --- | --- | --- | --- |
| title | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| body | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| type | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| audience | object | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| scheduledAt | datetime | No | normal | Theo schema endpoint và rule nghiệp vụ |
...
```json
{
  ...
  "type": "example",
  "audience": {},
  "scheduledAt": "2026-07-05T12:00:00+07:00"
}
```
