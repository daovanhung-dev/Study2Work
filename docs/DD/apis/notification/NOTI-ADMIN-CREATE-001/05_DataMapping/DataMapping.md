# Data Mapping — NOTI-ADMIN-CREATE-001
...
| --- | --- | --- | --- |
| title | title | Input DTO → application command | Validate + normalize |
| body | body | Input DTO → application command | Validate + normalize |
| type | type | Input DTO → application command | Validate + normalize |
| audience | audience | Input DTO → application command | Validate + normalize |
| scheduledAt | scheduled_at | Input DTO → application command | Validate + normalize |
