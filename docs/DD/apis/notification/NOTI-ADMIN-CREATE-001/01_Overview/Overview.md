# Overview — NOTI-ADMIN-CREATE-001

## 1. Business intent

**Tạo thông báo nháp** thuộc module **09. Thông báo nghiệp vụ**.
...
1. API gateway/controller nhận `POST /api/v1/admin/notifications` và gắn `traceId`.
...
- Ghi chú endpoint: Kiểm tra audience scope.
