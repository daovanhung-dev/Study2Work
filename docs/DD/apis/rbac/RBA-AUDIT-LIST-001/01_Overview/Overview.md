# Overview — RBA-AUDIT-LIST-001

## 1. Business intent

**Tra cứu audit log** thuộc module **13. RBAC và Audit**.
...
1. API gateway/controller nhận `GET /api/v1/admin/audit-logs` và gắn `traceId`.
...
- Ghi chú endpoint: Filters actorId action resourceType resourceId from to.
