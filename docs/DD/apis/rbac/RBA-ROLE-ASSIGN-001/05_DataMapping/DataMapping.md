# Data Mapping — RBA-ROLE-ASSIGN-001
...
| --- | --- | --- | --- |
| roleId | role_id | Input DTO → application command | Validate + normalize |
| reason | reason | Input DTO → application command | Validate + normalize |
| effectiveFrom | effective_from | Input DTO → application command | Validate + normalize |
| effectiveTo | effective_to | Input DTO → application command | Validate + normalize |
