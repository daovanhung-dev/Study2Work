...
| --- | --- | --- | --- |
| userId | uuid / slug | Yes | Phải tồn tại và caller có quyền truy cập |
...
| --- | --- | --- | --- | --- |
| roleId | uuid | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| reason | string | Yes | audit | Theo schema endpoint và rule nghiệp vụ |
| effectiveFrom | datetime | No | normal | Theo schema endpoint và rule nghiệp vụ |
| effectiveTo | datetime | No | normal | Theo schema endpoint và rule nghiệp vụ |
...
```json
{
  ...
  "effectiveFrom": "2026-07-05T12:00:00+07:00",
  "effectiveTo": "2026-07-05T12:00:00+07:00"
}
```
