# Response — RBA-ROLE-PERMISSIONS-001
...
{
  "success": true,
  "code": "RBA-ROLE-PERMISSIONS-SUCCESS",
  "message": "Thành công",
  "data": {
...
| --- | --- | --- |
| roleId | uuid | Giá trị trả về của contract |
| permissions | array | Giá trị trả về của contract |
| version | integer | Giá trị trả về của contract |
