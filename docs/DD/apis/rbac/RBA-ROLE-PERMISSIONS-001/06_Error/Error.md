# Error — RBA-ROLE-PERMISSIONS-001
...
| 422 | DOMAIN_RULE_VIOLATION | Quyền được kiểm tra server-side; không cho tự nâng quyền; thay đổi role/permission bắt buộc có lý do và audit before/after. |
