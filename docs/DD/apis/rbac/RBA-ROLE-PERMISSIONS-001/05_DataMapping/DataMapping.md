# Data Mapping — RBA-ROLE-PERMISSIONS-001
...
| --- | --- | --- | --- |
| permissionIds | permission_ids | Input DTO → application command | Validate + normalize |
...
| roleId | - | Read model / response DTO | Filter by scope before serialization |
| permissions | - | Read model / response DTO | Filter by scope before serialization |
