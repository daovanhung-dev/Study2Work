# Overview — RBA-ROLE-PERMISSIONS-001

## 1. Business intent

**Cập nhật quyền của role** thuộc module **13. RBAC và Audit**.
...
1. API gateway/controller nhận `PUT /api/v1/admin/roles/{roleId}/permissions` và gắn `traceId`.
...
- Ghi chú endpoint: Optimistic concurrency và audit.
