# Overview — RBA-USER-ROLES-001

## 1. Business intent

**Lấy role của người dùng** thuộc module **13. RBAC và Audit**.
...
1. API gateway/controller nhận `GET /api/v1/admin/users/{userId}/roles` và gắn `traceId`.
