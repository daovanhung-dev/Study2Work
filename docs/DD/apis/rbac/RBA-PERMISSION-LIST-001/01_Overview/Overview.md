# Overview — RBA-PERMISSION-LIST-001

## 1. Business intent

**Lấy danh sách quyền** thuộc module **13. RBAC và Audit**.
...
1. API gateway/controller nhận `GET /api/v1/admin/permissions` và gắn `traceId`.
...
- Ghi chú endpoint: Read-only catalog quyền.
