# Overview — RBA-ROLE-LIST-001

## 1. Business intent

**Lấy danh sách vai trò** thuộc module **13. RBAC và Audit**.
...
1. API gateway/controller nhận `GET /api/v1/admin/roles` và gắn `traceId`.
...
- Ghi chú endpoint: Chỉ Admin/Super Admin.
