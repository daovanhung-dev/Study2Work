...
| actor | object | Giá trị trả về của contract |
| action | string | Giá trị trả về của contract |
| before | object | Giá trị trả về của contract |
| after | object | Giá trị trả về của contract |
| reason | string | Giá trị trả về của contract |
| occurredAt | datetime | Giá trị trả về của contract |
