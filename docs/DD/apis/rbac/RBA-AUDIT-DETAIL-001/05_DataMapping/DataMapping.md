# Data Mapping — RBA-AUDIT-DETAIL-001
...
| actor | - | Read model / response DTO | Filter by scope before serialization |
| action | - | Read model / response DTO | Filter by scope before serialization |
| before | - | Read model / response DTO | Filter by scope before serialization |
| after | - | Read model / response DTO | Filter by scope before serialization |
| reason | - | Read model / response DTO | Filter by scope before serialization |
| occurredAt | - | Read model / response DTO | Filter by scope before serialization |
