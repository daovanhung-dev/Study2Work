# Overview — RBA-AUDIT-DETAIL-001

## 1. Business intent

**Lấy chi tiết audit log** thuộc module **13. RBAC và Audit**.
...
1. API gateway/controller nhận `GET /api/v1/admin/audit-logs/{auditId}` và gắn `traceId`.
...
- Ghi chú endpoint: Masked sensitive values, immutable.
