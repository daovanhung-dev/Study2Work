# Overview — SUP-CREATE-001

## 1. Business intent

**Tạo yêu cầu hỗ trợ** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `POST /api/v1/support-requests` và gắn `traceId`.
...
- Ghi chú endpoint: Sanitize nội dung, rate limit.
