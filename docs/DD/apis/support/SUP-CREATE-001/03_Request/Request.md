...
| --- | --- | --- | --- | --- |
| category | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| subject | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| description | string | Yes | PII | Theo schema endpoint và rule nghiệp vụ |
| attachments | array | No | PII | Theo schema endpoint và rule nghiệp vụ |
