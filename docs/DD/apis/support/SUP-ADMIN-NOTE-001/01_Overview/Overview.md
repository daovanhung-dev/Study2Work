# Overview — SUP-ADMIN-NOTE-001

## 1. Business intent

**Thêm ghi chú nội bộ** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `POST /api/v1/admin/support-requests/{requestId}/notes` và gắn `traceId`.
...
- Ghi chú endpoint: Không hiển thị cho learner.
