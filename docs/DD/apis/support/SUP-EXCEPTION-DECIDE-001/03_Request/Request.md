# Request — SUP-EXCEPTION-DECIDE-001
...
| --- | --- |
| Method | `POST` |
| URL | `/api/v1/admin/learner-path-exceptions/{exceptionId}/decision` |
...
| --- | --- | --- | --- |
| exceptionId | uuid / slug | Yes | Phải tồn tại và caller có quyền truy cập |
...
| --- | --- | --- | --- | --- |
| decision | string | Yes | normal | Theo schema endpoint và rule nghiệp vụ |
| reason | string | Yes | audit | Theo schema endpoint và rule nghiệp vụ |
| effectiveUntil | datetime | No | normal | Theo schema endpoint và rule nghiệp vụ |
...
```json
{
  ...
  "effectiveUntil": "2026-07-05T12:00:00+07:00"
}
```
