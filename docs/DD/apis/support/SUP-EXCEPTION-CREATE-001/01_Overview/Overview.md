# Overview — SUP-EXCEPTION-CREATE-001

## 1. Business intent

**Tạo yêu cầu ngoại lệ lộ trình** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `POST /api/v1/admin/learner-path-exceptions` và gắn `traceId`.
...
- Ghi chú endpoint: Không tự approve bởi người tạo nếu policy tách nhiệm vụ.
