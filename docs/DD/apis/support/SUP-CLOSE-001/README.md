# SUP-CLOSE-001 — Learner đóng ticket

| Thuộc tính | Giá trị |
| --- | --- |
| Method | `POST` |
| Endpoint | `/api/v1/support-requests/{requestId}/close` |
...
Learner đóng ticket. Không tự đóng ticket đang chờ quyết định ngoại lệ
