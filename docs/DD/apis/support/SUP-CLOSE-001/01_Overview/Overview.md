# Overview — SUP-CLOSE-001

## 1. Business intent

**Learner đóng ticket** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `POST /api/v1/support-requests/{requestId}/close` và gắn `traceId`.
...
- Ghi chú endpoint: Không tự đóng ticket đang chờ quyết định ngoại lệ.
