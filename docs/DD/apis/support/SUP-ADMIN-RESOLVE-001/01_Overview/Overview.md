# Overview — SUP-ADMIN-RESOLVE-001

## 1. Business intent

**Giải quyết ticket** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `POST /api/v1/admin/support-requests/{requestId}/resolve` và gắn `traceId`.
...
- Ghi chú endpoint: Audit required.
