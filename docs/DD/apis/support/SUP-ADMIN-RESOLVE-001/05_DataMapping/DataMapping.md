# Data Mapping — SUP-ADMIN-RESOLVE-001
...
| --- | --- | --- | --- |
| resolution | resolution | Input DTO → application command | Validate + normalize |
| resolutionCode | resolution_code | Input DTO → application command | Validate + normalize |
...
| resolvedAt | - | Read model / response DTO | Filter by scope before serialization |
