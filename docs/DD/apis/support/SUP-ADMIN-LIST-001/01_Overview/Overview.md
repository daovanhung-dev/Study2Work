# Overview — SUP-ADMIN-LIST-001

## 1. Business intent

**Danh sách ticket cho staff** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `GET /api/v1/admin/support-requests` và gắn `traceId`.
...
- Ghi chú endpoint: Filters assignee status category priority.
