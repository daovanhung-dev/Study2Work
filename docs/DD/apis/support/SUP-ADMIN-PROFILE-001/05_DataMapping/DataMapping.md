# Data Mapping — SUP-ADMIN-PROFILE-001
...
| --- | --- | --- | --- |
| learner | - | Read model / response DTO | Filter by scope before serialization |
...
| flags | - | Read model / response DTO | Filter by scope before serialization |
| exceptions | - | Read model / response DTO | Filter by scope before serialization |
