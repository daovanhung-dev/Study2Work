# Overview — SUP-ADMIN-PROFILE-001

## 1. Business intent

**Lấy support profile học viên** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `GET /api/v1/admin/learners/{learnerId}/support-profile` và gắn `traceId`.
...
- Ghi chú endpoint: Data minimization, scope check, access audit.
