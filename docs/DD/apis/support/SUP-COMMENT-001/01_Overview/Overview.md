# Overview — SUP-COMMENT-001

## 1. Business intent

**Bổ sung trao đổi cho ticket** thuộc module **11. Admin học viên, hỗ trợ và ngoại lệ**.
...
1. API gateway/controller nhận `POST /api/v1/support-requests/{requestId}/comments` và gắn `traceId`.
...
- Ghi chú endpoint: Kiểm tra ticket active và quyền.
