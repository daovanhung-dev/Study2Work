# Overview — LRN-RESUME-001

## 1. Business intent

**Tiếp tục lộ trình** thuộc module **04. Lộ trình học**.
...
1. API gateway/controller nhận `POST /api/v1/learning-paths/{pathId}/resume` và gắn `traceId`.
...
- Ghi chú endpoint: Không thể resume path đã COMPLETED.
