# Overview — LRN-PATH-DETAIL-001

## 1. Business intent

**Lấy chi tiết lộ trình theo ngữ cảnh learner** thuộc module **04. Lộ trình học**.
...
1. API gateway/controller nhận `GET /api/v1/learning-paths/{pathId}` và gắn `traceId`.
...
- Ghi chú endpoint: Phân biệt catalog public và learner view.
