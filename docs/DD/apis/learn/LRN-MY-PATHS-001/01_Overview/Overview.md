# Overview — LRN-MY-PATHS-001

## 1. Business intent

**Lấy lộ trình của learner** thuộc module **04. Lộ trình học**.
...
1. API gateway/controller nhận `GET /api/v1/learning-paths/me` và gắn `traceId`.
...
- Ghi chú endpoint: Không hiển thị dữ liệu learner khác.
