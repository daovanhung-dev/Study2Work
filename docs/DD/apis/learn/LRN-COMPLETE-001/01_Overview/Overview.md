# Overview — LRN-COMPLETE-001

## 1. Business intent

**Yêu cầu kiểm tra hoàn thành lộ trình** thuộc module **04. Lộ trình học**.
...
1. API gateway/controller nhận `POST /api/v1/learning-paths/{pathId}/complete` và gắn `traceId`.
...
- Ghi chú endpoint: Server tự kiểm tra toàn bộ điều kiện hoàn thành.
