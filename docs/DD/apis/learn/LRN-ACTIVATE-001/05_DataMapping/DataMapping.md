...
| learnerPathId | - | Read model / response DTO | Filter by scope before serialization |
| status | - | Read model / response DTO | Filter by scope before serialization |
| activatedAt | - | Read model / response DTO | Filter by scope before serialization |
