...
| --- | --- |
| Method | `POST` |
| URL | `/api/v1/learning-paths/{pathId}/activate` |
...
| --- | --- | --- | --- |
| pathId | uuid / slug | Yes | Phải tồn tại và caller có quyền truy cập |
...
| --- | --- | --- | --- | --- |
| source | string | No | normal | Theo schema endpoint và rule nghiệp vụ |
