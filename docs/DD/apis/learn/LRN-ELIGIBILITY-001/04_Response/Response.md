...
| --- | --- | --- |
| eligible | boolean | Giá trị trả về của contract |
| blockingReasons | array | Giá trị trả về của contract |
| currentActivePath | object | Giá trị trả về của contract |
