# Data Mapping — LRN-ELIGIBILITY-001
...
| --- | --- | --- | --- |
| eligible | - | Read model / response DTO | Filter by scope before serialization |
| blockingReasons | - | Read model / response DTO | Filter by scope before serialization |
| currentActivePath | - | Read model / response DTO | Filter by scope before serialization |
