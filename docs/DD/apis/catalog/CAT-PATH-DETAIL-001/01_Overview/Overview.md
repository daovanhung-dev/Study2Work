# Overview — CAT-PATH-DETAIL-001

## 1. Business intent

**Xem chi tiết lộ trình công khai** thuộc module **01. Public Catalog**.
...
1. API gateway/controller nhận `GET /api/v1/catalog/learning-paths/{slug}` và gắn `traceId`.
...
- Ghi chú endpoint: Slug phải là lộ trình PUBLISHED.
