# Data Mapping — CAT-PATH-DETAIL-001
...
| curriculum | - | Read model / response DTO | Filter by scope before serialization |
| relatedCourses | - | Read model / response DTO | Filter by scope before serialization |
