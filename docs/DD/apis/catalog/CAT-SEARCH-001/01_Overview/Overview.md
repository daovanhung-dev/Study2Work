# Overview — CAT-SEARCH-001

## 1. Business intent

**Tìm kiếm đồng thời lộ trình và khóa học** thuộc module **01. Public Catalog**.
...
1. API gateway/controller nhận `GET /api/v1/catalog/search` và gắn `traceId`.
...
- Ghi chú endpoint: q bắt buộc và giới hạn độ dài.
