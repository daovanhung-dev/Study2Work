# Overview — CAT-SAMPLE-001

## 1. Business intent

**Phát bài học mẫu** thuộc module **01. Public Catalog**.
...
1. API gateway/controller nhận `GET /api/v1/catalog/sample-lessons/{lessonId}` và gắn `traceId`.
...
- Ghi chú endpoint: Trả signed playback URL ngắn hạn.
