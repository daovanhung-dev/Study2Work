...
| --- | --- | --- |
| hero | object | Giá trị trả về của contract |
| featuredLearningPaths | array | Giá trị trả về của contract |
| featuredCourses | array | Giá trị trả về của contract |
