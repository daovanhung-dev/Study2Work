# Overview — CAT-HOME-001

## 1. Business intent

**Lấy dữ liệu trang giới thiệu Study** thuộc module **01. Public Catalog**.
...
1. API gateway/controller nhận `GET /api/v1/catalog/home` và gắn `traceId`.
...
- Ghi chú endpoint: Public cacheable.
