...
| --- | --- | --- | --- |
| hero | - | Read model / response DTO | Filter by scope before serialization |
| featuredLearningPaths | - | Read model / response DTO | Filter by scope before serialization |
| featuredCourses | - | Read model / response DTO | Filter by scope before serialization |
