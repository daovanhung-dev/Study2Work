# CAT-PATH-LIST-001 — Tìm kiếm và lọc lộ trình công khai
...
| Access | Không yêu cầu |
| Actor | Guest, Learner |
| Operation | READ |

## Mục tiêu

Tìm kiếm và lọc lộ trình công khai. Filters keyword level goal status=PUBLISHED
