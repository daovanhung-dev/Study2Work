# Overview — CAT-PATH-LIST-001

## 1. Business intent

**Tìm kiếm và lọc lộ trình công khai** thuộc module **01. Public Catalog**.
...
1. API gateway/controller nhận `GET /api/v1/catalog/learning-paths` và gắn `traceId`.
...
- Ghi chú endpoint: Filters keyword level goal status=PUBLISHED.
