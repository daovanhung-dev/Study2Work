# Overview — CAT-COURSE-DETAIL-001

## 1. Business intent

**Xem chi tiết khóa học công khai** thuộc module **01. Public Catalog**.
...
1. API gateway/controller nhận `GET /api/v1/catalog/courses/{slug}` và gắn `traceId`.
...
- Ghi chú endpoint: Không lộ nội dung chưa publish.
