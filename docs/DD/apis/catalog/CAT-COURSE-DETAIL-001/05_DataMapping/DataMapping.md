# Data Mapping — CAT-COURSE-DETAIL-001

## 1. Aggregates / tables

`learning_paths, courses, lessons, content_versions`
...
| slug | - | Read model / response DTO | Filter by scope before serialization |
| overview | - | Read model / response DTO | Filter by scope before serialization |
| chapters | - | Read model / response DTO | Filter by scope before serialization |
| sampleLesson | - | Read model / response DTO | Filter by scope before serialization |
