# Response — CAT-COURSE-DETAIL-001
...
{
  "success": true,
  "code": "CAT-COURSE-DETAIL-SUCCESS",
  "message": "Thành công",
  "data": {
...
| slug | string | Giá trị trả về của contract |
| overview | object | Giá trị trả về của contract |
| chapters | array | Giá trị trả về của contract |
| sampleLesson | object | Giá trị trả về của contract |
