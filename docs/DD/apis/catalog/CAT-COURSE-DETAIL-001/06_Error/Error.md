...
| 422 | DOMAIN_RULE_VIOLATION | Chỉ trả về nội dung PUBLISHED và đang hiển thị; nội dung mẫu được kiểm tra quyền truy cập trước khi phát. |
