...
| ---: | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- |
| 1 | Email | `email` | string | Yes | SOURCE_REQUIRED | SOURCE_REQUIRED | Unicode text | Email | Canonical normalized email | N/A | Lookup only; response không tiết lộ existence/status. | [1.2](./05_Data_Mapping.md#dm-1-2) |

> Mỗi field nằm trên một row riêng. Endpoint không định nghĩa Authorization/session proof dù cooldown code có điều kiện ownership.
