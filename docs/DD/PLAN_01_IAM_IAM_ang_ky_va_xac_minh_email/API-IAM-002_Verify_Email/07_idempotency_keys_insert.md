...
- New verify-email idempotency key.
...
| 5 | `actor_id` | Actor ID | `uuid` | - | - | N |  | `NULL` | Anonymous | [Data Mapping](./05_Data_Mapping.md#dm-3-2) |  |
| 6 | `operation` | Operation | `varchar` | 120 | - | Y |  | `POST /api/v1/auth/verify-email` | Fixed | [Data Mapping](./05_Data_Mapping.md#dm-3-2) |  |
| 7 | `key_hash` | Idempotency key hash | `char` | 64 | - | Y |  | `HASH(idempotency_key)` | Header | [Data Mapping](./05_Data_Mapping.md#dm-3-2) |  |
| 8 | `request_hash` | Request hash | `char` | 64 | - | Y |  | `HASH(canonical_json(body))` | Request | [Data Mapping](./05_Data_Mapping.md#dm-3-2) |  |
...
| 13 | `expires_at` | Record expiry | `timestamptz` | - | - | Y |  | `current_timestamp + 24 hours` | Common retention | [Data Mapping](./05_Data_Mapping.md#dm-3-2) |  |
