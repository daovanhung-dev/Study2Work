---
title: "mfa_recovery_codes INSERT"
order: 8
...
| Thuộc tính | Giá trị |
|---|---|
| Physical table | `TBL-IAM-007` |
| Logical table | `mfa_recovery_codes` |
| Operation | `INSERT` |
...
- `One row per recovery code; Q-04 response timing unresolved.`
...
| 3 | `method_id` | `method_id` | `uuid NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Path enrollment ID` | `Path enrollment ID` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 4 | `code_hash` | `code_hash` | `char(64) NOT NULL UNIQUE` | `N/A` | `N/A` | `Y` | `` | `Hash each generated recovery code` | `Hash each generated recovery code` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 5 | `consumed_at` | `consumed_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `NULL` | `NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 6 | `batch_id` | `batch_id` | `uuid NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Generated batch UUID` | `Generated batch UUID` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
