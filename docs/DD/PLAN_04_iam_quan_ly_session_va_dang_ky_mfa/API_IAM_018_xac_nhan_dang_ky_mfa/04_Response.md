...
| 7 | `data.status` | MFA status | `status` | `string` | `No` | `mfa_methods` | `verified_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | ACTIVE when verified_at set | N/A | [DERIVED] |
| 8 | `data.recoveryCodes` | Recovery codes | `recoveryCodes` | `array<string>` | `Yes` | `mfa_recovery_codes` | `code_hash` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Raw codes generated once; only hashes persisted | N/A | Q-04 conflict. [SOURCE_REQUIRED] |
