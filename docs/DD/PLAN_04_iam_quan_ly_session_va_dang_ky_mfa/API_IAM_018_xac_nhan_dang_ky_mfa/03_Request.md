...
|---|---|
| HTTP method | `POST` |
| URI | `/api/v1/me/mfa/enrollments/{id}/confirm` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | MFA enrollment ID | `id` | `uuid` | `Yes` | `N/A` | `N/A` | `UUID v7` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Mã TOTP | `code` | `string` | `Yes` | `6` | `6` | `Unicode/JSON` | `numeric` | `N/A` | `N/A` | Tên vật lý suy dẫn từ TOTP code. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
