...
| Purpose | `TOTP code → active enrollment` |
| Consumer/Actor | `Owner` |
...
- Contract summary: TX L enrollment; verify; activate; store hashed recovery codes; never return secret again.
