...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `SESSION_NOT_FOUND` | Branch `SESSION_NOT_FOUND` theo endpoint source | `404` | `SESSION_NOT_FOUND` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Validation | `○` | `sessionId` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `Yes` | Generic code chưa có endpoint catalog |
