...
| 7 | `data.enrollmentId` | Enrollment ID | `enrollmentId` | `string` | `No` | `mfa_methods` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.secret` | TOTP secret | `secret` | `string` | `No` | `mfa_methods` | `secret_ciphertext` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Return raw once before persistence boundary | N/A | Sensitive; no-store. [DERIVED] |
| 9 | `data.qrPayload` | QR payload | `qrPayload` | `string` | `No` | `N/A` | `N/A` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Generated from enrollment secret | N/A | [DERIVED] |
| 10 | `data.recoveryCodes` | Recovery codes | `recoveryCodes` | `array<string>` | `Yes` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | Q-04 conflict. [SOURCE_REQUIRED] |
...
```json
{
  ...
  "data": {
    "enrollmentId": "0198a4c0-2d18-7a42-a82a-32f56e93bd14",
    "secret": "REDACTED-EXAMPLE",
    "qrPayload": "otpauth://totp/example",
    "recoveryCodes": []
  },
  "meta": {},
...
{
  "success": false,
  "businessCode": "MFA_ALREADY_ENABLED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
