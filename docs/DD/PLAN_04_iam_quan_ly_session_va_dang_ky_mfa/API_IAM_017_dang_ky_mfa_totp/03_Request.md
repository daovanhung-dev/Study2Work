...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | MFA method | `method` | `string` | `Yes` | `N/A` | `N/A` | `Unicode/JSON` | `N/A` | `TOTP` | `N/A` | V1 chỉ TOTP. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Nhãn thiết bị | `deviceLabel` | `string` | `No` | `1` | `80` | `Unicode/JSON` | `text` | `N/A` | `N/A` | Tên vật lý suy dẫn từ label. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
