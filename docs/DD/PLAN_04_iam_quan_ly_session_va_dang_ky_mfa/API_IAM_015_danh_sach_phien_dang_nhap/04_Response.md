...
| 7 | `data[].sessionId` | Session ID | `sessionId` | `string` | `No` | `auth_sessions` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data[].current` | Current session flag | `current` | `boolean` | `No` | `auth_sessions` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Compare current sid | N/A | [DERIVED] |
| 9 | `data[].deviceName` | Device name | `deviceName` | `string` | `Yes` | `auth_sessions` | `device_name` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 10 | `data[].ipMasked` | Masked IP | `ipMasked` | `string` | `Yes` | `auth_sessions` | `ip_hash` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Coarse/masked representation; raw IP unavailable | N/A | [DERIVED] |
| 11 | `data[].lastSeenAt` | Last seen | `lastSeenAt` | `string` | `No` | `auth_sessions` | `last_seen_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | ISO-8601 UTC | N/A | [DERIVED] |
