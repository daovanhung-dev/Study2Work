...
| 9 | `data[].createdAt` | Created at | `createdAt` | `string` | `No` | `users` | `created_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | ISO-8601 UTC | N/A | [DERIVED] |
| 10 | `data[].roles` | Roles | `roles` | `array<string>` | `No` | `roles` | `code` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | [] if none | [DERIVED] |
