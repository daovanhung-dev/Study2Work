...
| Content-Type | `N/A — API không nhận Request Body.` |

## Request header

| No | Logical name | Field name | Required | Value/Format | Description | Data Mapping reference |
|---:|---|---|---:|---|---|---|
| 1 | Access token | `Authorization` | `Yes` | `Bearer token` | DIRECT | `05_Data_Mapping.md#1-validate-data-input` |
...
| No | Logical name | Physical name | Type | Required | Min | Max | Format | Valid values | Default | Description | Data Mapping reference |
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | Trang | `page` | `integer` | `No` | `1` | `N/A` | `integer` | `N/A` | `1` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Kích thước trang | `pageSize` | `integer` | `No` | `1` | `100` | `integer` | `N/A` | `20` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 3 | Account status | `status` | `string` | `No` | `N/A` | `N/A` | `N/A` | `account_status` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
| 4 | Email hash | `emailHash` | `string` | `No` | `N/A` | `N/A` | `exact hash` | `N/A` | `N/A` | Không dùng raw email theo summary. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
| 5 | Global role | `role` | `string` | `No` | `N/A` | `N/A` | `role code` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
