...
- `If-Match and valid transition.`

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `status` | `status` | `account_status NOT NULL DEFAULT 'PENDING_EMAIL_VERIFICATION'` | `N/A` | `N/A` | `Y` | `` | `request.status` | `request.status` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `suspended_at` | `suspended_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp when SUSPENDED else NULL` | `current_timestamp when SUSPENDED else NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 3 | `suspension_reason` | `suspension_reason` | `varchar(500) NULL` | `N/A` | `N/A` | `N` | `` | `request.reason when SUSPENDED else NULL` | `request.reason when SUSPENDED else NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
