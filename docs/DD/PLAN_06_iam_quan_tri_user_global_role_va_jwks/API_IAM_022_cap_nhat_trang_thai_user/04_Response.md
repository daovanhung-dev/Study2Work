...
| 7 | `data.id` | User ID | `id` | `string` | `No` | `users` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.status` | Status | `status` | `string` | `No` | `users` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
...
```json
{
  ...
  "data": {
    "id": "0198a4c0-2d18-7a42-a82a-32f56e93bd16",
    "status": "SUSPENDED",
    "version": 2
  },
  "meta": {},
...
{
  "success": false,
  "businessCode": "INVALID_ACCOUNT_TRANSITION",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
