...
|---|---|
| HTTP method | `PUT` |
| URI | `/api/v1/admin/users/{userId}/status` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Account status | `status` | `string` | `Yes` | `N/A` | `N/A` | `Unicode/JSON` | `N/A` | `ACTIVE\|SUSPENDED` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
