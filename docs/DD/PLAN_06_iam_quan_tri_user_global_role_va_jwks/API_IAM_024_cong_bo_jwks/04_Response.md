...
|---:|---|---|---|---|---:|---|---|---|---|---|---|
| 1 | `keys` | JWK set | `keys` | `array<object>` | `No` | `signing_keys` | `public_jwk` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Collect active/rollover public JWK | Không trả private_key_ref | [DIRECT] |
