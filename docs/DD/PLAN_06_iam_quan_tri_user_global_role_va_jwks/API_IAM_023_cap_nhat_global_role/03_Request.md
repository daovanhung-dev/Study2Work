...
| 3 | Expected version | `If-Match` | `Yes` | `"<row_version>"` | DIRECT | `05_Data_Mapping.md#1-validate-data-input` |
| 4 | Idempotency key | `Idempotency-Key` | `Yes` | `UUID/random` | DIRECT | `05_Data_Mapping.md#1-validate-data-input` |

## Path parameters

| No | Logical name | Physical name | Type | Required | Min | Max | Format | Valid values | Default | Description | Data Mapping reference |
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | User ID | `userId` | `uuid` | `Yes` | `N/A` | `N/A` | `UUID v7` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Danh sách role code | `roleCodes` | `array<string>` | `Yes` | `0` | `SOURCE_REQUIRED` | `Unicode/JSON` | `role code array` | `N/A` | `N/A` | Exact role code set; duplicate không được phép. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Lý do | `reason` | `string` | `Yes` | `1` | `500` | `Unicode/JSON` | `text` | `N/A` | `N/A` | [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
