...
| 7 | `data.userId` | User ID | `userId` | `string` | `No` | `users` | `id` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 8 | `data.roleCodes` | Role codes | `roleCodes` | `array<string>` | `No` | `roles` | `code` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
| 9 | `data.version` | Version | `version` | `integer` | `No` | `users` | `row_version` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DERIVED] |
...
```json
{
  ...
  "data": {
    "userId": "0198a4c0-2d18-7a42-a82a-32f56e93bd17",
    "roleCodes": [
      "LEARNER"
    ],
    "version": 3
...
{
  "success": false,
  "businessCode": "LAST_ADMIN_REQUIRED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
