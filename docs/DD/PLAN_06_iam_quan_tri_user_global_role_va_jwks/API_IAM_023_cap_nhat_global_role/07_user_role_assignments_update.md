---
title: "user_role_assignments UPDATE"
order: 7
...
- `Assignments removed by exact-set diff.`

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `revoked_at` | `revoked_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `revoked_by` | `revoked_by` | `uuid NULL` | `N/A` | `N/A` | `N` | `` | `Authenticated admin ID` | `Authenticated admin ID` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
