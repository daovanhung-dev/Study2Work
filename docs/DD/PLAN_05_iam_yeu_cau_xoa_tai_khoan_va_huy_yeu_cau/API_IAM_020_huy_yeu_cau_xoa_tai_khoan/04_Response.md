...
| 7 | `data.status` | Account status | `status` | `string` | `No` | `users` | `status` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | Direct | N/A | [DIRECT] |
...
{
  "success": false,
  "businessCode": "DELETION_GRACE_EXPIRED",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
