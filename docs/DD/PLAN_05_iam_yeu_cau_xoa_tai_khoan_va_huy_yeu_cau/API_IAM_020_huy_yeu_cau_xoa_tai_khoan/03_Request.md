...
|---|---|
| HTTP method | `DELETE` |
| URI | `/api/v1/me/deletion-request` |
...
|---:|---|---|---:|---|---|---|
| 1 | Idempotency key | `Idempotency-Key` | `Yes` | `UUID/random` | DIRECT | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Recovery confirmation/proof | `SOURCE_REQUIRED` | `string` | `Yes` | `N/A` | `N/A` | `Unicode/JSON` | `recovery flow proof` | `N/A` | `N/A` | Q-06: credential/challenge/token chưa được định nghĩa. [SOURCE_REQUIRED] | `05_Data_Mapping.md#1-validate-data-input` |
