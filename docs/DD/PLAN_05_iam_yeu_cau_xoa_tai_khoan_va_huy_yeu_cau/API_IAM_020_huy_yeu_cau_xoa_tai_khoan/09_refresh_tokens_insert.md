...
| 5 | `token_hash` | `token_hash` | `char(64) NOT NULL UNIQUE` | `N/A` | `N/A` | `Y` | `` | `Hash generated token` | `Hash generated token` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 6 | `status` | `status` | `token_status NOT NULL DEFAULT 'ACTIVE'` | `N/A` | `N/A` | `Y` | `` | `ACTIVE` | `ACTIVE` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 7 | `issued_at` | `issued_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
