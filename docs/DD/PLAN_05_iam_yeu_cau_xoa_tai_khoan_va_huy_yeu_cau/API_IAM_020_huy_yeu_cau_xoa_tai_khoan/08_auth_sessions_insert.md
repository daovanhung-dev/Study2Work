...
- `Only after Q-06 recovery proof.`
...
| 5 | `user_id` | `user_id` | `uuid NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Recovered users.id` | `Recovered users.id` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
...
| 7 | `session_epoch` | `session_epoch` | `bigint NOT NULL` | `N/A` | `N/A` | `Y` | `` | `SOURCE_REQUIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 8 | `last_seen_at` | `last_seen_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 9 | `expires_at` | `expires_at` | `timestamptz NOT NULL` | `N/A` | `N/A` | `Y` | `` | `Session expiry policy` | `Session expiry policy` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
