...
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `status` | `status` | `account_status NOT NULL DEFAULT 'PENDING_EMAIL_VERIFICATION'` | `N/A` | `N/A` | `Y` | `` | `ACTIVE` | `ACTIVE` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `deletion_requested_at` | `deletion_requested_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `NULL` | `NULL` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
