...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | Business/Auth | `○` | `DELETION_GRACE_EXPIRED` | Branch `DELETION_GRACE_EXPIRED` theo endpoint source | `409` | `DELETION_GRACE_EXPIRED` | `SOURCE_REQUIRED` | `05_Data_Mapping.md` | `Yes` | HTTP/message chưa có nguồn thì giữ TBD |
| 2 | Validation | `○` | `SOURCE_REQUIRED` | Thiếu field bắt buộc hoặc sai type/format theo Request | `400` | `VALIDATION_ERROR` | `SOURCE_REQUIRED` | `05_Data_Mapping.md#1-validate-data-input` | `Yes` | Generic code chưa có endpoint catalog |
