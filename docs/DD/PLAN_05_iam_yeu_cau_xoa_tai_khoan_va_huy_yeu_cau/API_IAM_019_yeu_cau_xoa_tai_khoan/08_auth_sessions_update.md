...
| 3 | `revoke_reason` | `revoke_reason` | `varchar(100) NULL` | `N/A` | `N/A` | `N` | `` | `ACCOUNT_DELETION_REQUESTED` | `ACCOUNT_DELETION_REQUESTED` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
