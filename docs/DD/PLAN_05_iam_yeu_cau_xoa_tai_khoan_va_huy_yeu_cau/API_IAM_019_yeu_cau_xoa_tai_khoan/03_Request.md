...
| 4 | Step-up proof | `SOURCE_REQUIRED` | `Yes` | `recent MFA/password` | Schema chưa định nghĩa. | `05_Data_Mapping.md#1-validate-data-input` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | Nội dung xác nhận | `confirmText` | `string` | `Yes` | `N/A` | `N/A` | `Unicode/JSON` | `typed confirmation` | `N/A` | `N/A` | Tên vật lý suy dẫn từ contract. [DERIVED] | `05_Data_Mapping.md#1-validate-data-input` |
| 2 | Lý do | `reason` | `string` | `No` | `0` | `SOURCE_REQUIRED` | `Unicode/JSON` | `text` | `N/A` | `N/A` | Optional; max length chưa có nguồn. [DIRECT] | `05_Data_Mapping.md#1-validate-data-input` |
