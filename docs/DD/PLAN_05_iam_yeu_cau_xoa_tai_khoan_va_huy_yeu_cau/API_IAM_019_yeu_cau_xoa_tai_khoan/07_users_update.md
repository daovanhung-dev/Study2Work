...
- `Legal-hold check source is Q-05.`

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `status` | `status` | `account_status NOT NULL DEFAULT 'PENDING_EMAIL_VERIFICATION'` | `N/A` | `N/A` | `Y` | `` | `DELETION_PENDING` | `DELETION_PENDING` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
| 2 | `deletion_requested_at` | `deletion_requested_at` | `timestamptz NULL` | `N/A` | `N/A` | `N` | `` | `current_timestamp` | `current_timestamp` | `05_Data_Mapping.md#3-insertupdate-thong-tin` | `DIRECT` |
