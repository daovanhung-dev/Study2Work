...
| 7 | `data.graceEndsAt` | Grace end | `graceEndsAt` | `string` | `No` | `users` | `deletion_requested_at` | `05_Data_Mapping.md#4-check-ket-qua-execute-query` | +30 days UTC | N/A | [DIRECT] |
...
```json
{
  ...
  "data": {
    "graceEndsAt": "2026-09-01T08:00:00Z"
  },
  "meta": {},
...
{
  "success": false,
  "businessCode": "LEGAL_HOLD_ACTIVE",
  "message": "SOURCE_REQUIRED",
  "data": null,
  "meta": {},
  "traceId": "0198a4c0-2d18-7a42-a82a-32f56e93bd10"
