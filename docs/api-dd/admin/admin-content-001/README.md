...
Folder này là bản API Detail Design draft cho `ADMIN-CONTENT-001`. Nội dung được tạo từ BD, API checklist và diagrams; các điểm chưa có source rõ ràng được ghi trong Open Questions.
