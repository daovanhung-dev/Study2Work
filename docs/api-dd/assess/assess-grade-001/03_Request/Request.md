...
6. Validate state hiện tại và business rules: Service identity only; hidden tests/runner details never exposed; output becomes evidence after validation.
