...
|---|---|---:|---|---|---|
| `quizId` | `UUID/string` | Y | UUID nếu là ID; enum/string nếu là provider. | 7c3a2f1b-31c5-4a21-9b3e-7d1745c4748a | E422 |
| `attemptId` | `UUID/string` | Y | UUID nếu là ID; enum/string nếu là provider. | 7c3a2f1b-31c5-4a21-9b3e-7d1745c4748a | E422 |
...
6. Validate state hiện tại và business rules: Enforce `BR-ASSESS-001`; attempt status/time limit, snapshot version, no client-trusted score.
