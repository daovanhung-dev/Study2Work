...
6. Validate state hiện tại và business rules: Refresh token hash lookup, revocation, expiry, rotation replay protection and one-time-use semantics.
