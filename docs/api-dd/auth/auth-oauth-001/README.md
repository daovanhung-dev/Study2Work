...
| Updated | `2026-07-02` |
| Module | `AUTH` |
| Endpoint | `GET/POST /api/v1/auth/oauth/{provider}` |
| Source checklist | `docs/checklists/API.md` |
| Worklog | `.agent/worklog/2026-07/0004_api_dd_canonical_drafts.md` |

## Purpose

Folder này là bản API Detail Design draft cho `AUTH-OAUTH-001`. Nội dung được tạo từ BD, API checklist và diagrams; các điểm chưa có source rõ ràng được ghi trong Open Questions.
