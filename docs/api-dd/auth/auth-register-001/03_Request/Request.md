...
6. Validate state hiện tại và business rules: Enforce `BR-AUTH-001`, `BR-AUTH-002`, `BR-AUTH-003`; define duplicate email/phone behavior without account enumeration; never return password/token secrets.
