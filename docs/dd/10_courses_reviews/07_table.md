...
| Thuộc tính | Giá trị |
|---|---|
| Physical table | `courses; discussions; users` |
| Logical table | `Course visibility, public reviews và replies` |
| Operation | `N/A — no DB mutation` |
| Data Mapping step | `3.1/4.1/4.2/4.3 — SELECT only` |

## Update mapping

**Áp dụng khi**

- `N/A — API #10 là read-only.`
