...
### 1. Nhận `PATCH /api/v1/notifications/read-all` từ actor `Student` trong AC-20.
...
- Source: `AC-20` / ERD / API Index theo nội dung bước.
### 4. Thực hiện đọc/ghi trên entity được ERD hỗ trợ: `notifications`, `users`. Exact SELECT/INSERT/UPDATE/DELETE condition chỉ được chốt khi AC khóa đủ; phần chưa có evidence được đánh `TBD`.
