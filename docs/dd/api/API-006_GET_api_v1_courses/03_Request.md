...
| Field | Location | Type | Required | Validation / source |
|---|---|---|---|---|
| `category` | Query | `TBD` | TBD | Explicitly named in AC flow; detailed constraints are not specified |
| `page` | Query | `TBD` | TBD | Explicitly named in AC flow; detailed constraints are not specified |
| `size` | Query | `TBD` | TBD | Explicitly named in AC flow; detailed constraints are not specified |
| `sort` | Query | `TBD` | TBD | Explicitly named in AC flow; detailed constraints are not specified |
