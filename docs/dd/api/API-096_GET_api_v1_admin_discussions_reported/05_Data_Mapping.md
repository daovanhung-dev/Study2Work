...
### 1. Nhận `GET /api/v1/admin/discussions/reported` từ actor `Admin` trong AC-37.
...
- Source: `AC-37` / ERD / API Index theo nội dung bước.
### 3. Thực hiện đọc/ghi trên entity được ERD hỗ trợ: `discussions`, `users`, `courses`. Exact SELECT/INSERT/UPDATE/DELETE condition chỉ được chốt khi AC khóa đủ; phần chưa có evidence được đánh `TBD`.
