...
|---|---|---|---|
| `data.duration` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.questions` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.attempts_left` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
