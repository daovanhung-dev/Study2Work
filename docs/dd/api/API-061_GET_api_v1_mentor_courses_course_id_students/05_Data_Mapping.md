...
### 1. Nhận `GET /api/v1/mentor/courses/{course_id}/students` từ actor `Mentor` trong AC-25.
...
- Source: `AC-25` / ERD / API Index theo nội dung bước.
### 4. Thực hiện đọc/ghi trên entity được ERD hỗ trợ: `courses`, `enrollments`, `users`, `lesson_progress`. Exact SELECT/INSERT/UPDATE/DELETE condition chỉ được chốt khi AC khóa đủ; phần chưa có evidence được đánh `TBD`.
