...
### 1. Nhận `DELETE /api/v1/admin/notifications/{notification_id}` từ actor `Admin` trong AC-36.
...
|---|---|---|---|
| `notifications` | DELETE / exact operation TBD | ERD-backed entity | Exact predicate/mutation only where AC explicitly fixes it |
