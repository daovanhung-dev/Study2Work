...
|---|---|---|---|
| `data.sections` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.lesson previews` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
