...
### 1. Nhận `PUT /api/v1/admin/quizzes/{quiz_id}` từ actor `Admin` trong AC-35.
...
|---|---|---|---|
| `quizzes` | PUT / exact operation TBD | ERD-backed entity | Exact predicate/mutation only where AC explicitly fixes it |
