...
|---|---|---|---|
| `data.title` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.mentor` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.price` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.metadata` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
