...
|---|---|---|---|
| `data.access_token` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.refresh_token` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
