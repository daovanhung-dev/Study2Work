...
### 1. Nhận `GET /api/v1/mentor/courses/{course_id}/students/{student_id}/progress` từ actor `Mentor` trong AC-26.
...
- Source: `AC-26` / ERD / API Index theo nội dung bước.
### 3. Đọc path parameter: `course_id`, `student_id`; type/range validation chưa được diagram khóa thì để `TBD`.
