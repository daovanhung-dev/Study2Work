...
### 1. Nhận `PATCH /api/v1/admin/discussions/{discussion_id}/moderate` từ actor `Admin` trong AC-37.

- Source: `AC-37` / ERD / API Index theo nội dung bước.
### 2. Kiểm tra authentication/authorization phù hợp precondition của AC-37; HTTP/error code cụ thể để `TBD` nếu AC không chỉ rõ.
...
|---|---|---|---|
| `discussions` | PATCH / exact operation TBD | ERD-backed entity | Exact predicate/mutation only where AC explicitly fixes it |
