...
### 1. Nhận `PATCH /api/v1/mentor/content/{content_id}/publish` từ actor `Mentor` trong AC-22.

- Source: `AC-22` / ERD / API Index theo nội dung bước.
### 2. Kiểm tra authentication/authorization phù hợp precondition của AC-22; HTTP/error code cụ thể để `TBD` nếu AC không chỉ rõ.
