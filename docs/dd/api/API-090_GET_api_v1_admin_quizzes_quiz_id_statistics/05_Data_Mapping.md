...
### 1. Nhận `GET /api/v1/admin/quizzes/{quiz_id}/statistics` từ actor `Admin` trong AC-35.
...
- Source: `AC-35` / ERD / API Index theo nội dung bước.
### 4. Thực hiện đọc/ghi trên entity được ERD hỗ trợ: `quizzes`, `quiz_attempts`, `quiz_answers`. Exact SELECT/INSERT/UPDATE/DELETE condition chỉ được chốt khi AC khóa đủ; phần chưa có evidence được đánh `TBD`.
