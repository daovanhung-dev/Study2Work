...
### 1. Nhận `GET /api/v1/mentor/lectures/{lecture_id}` từ actor `Mentor` trong AC-21.
...
- Source: `AC-21` / ERD / API Index theo nội dung bước.
### 3. Đọc path parameter: `lecture_id`; type/range validation chưa được diagram khóa thì để `TBD`.
