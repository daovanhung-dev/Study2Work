...
### 1. Nhận `GET /api/v1/users/me/progress` từ actor `Student` trong AC-13.

- Source: `AC-13` / ERD / API Index theo nội dung bước.
### 2. Kiểm tra authentication/authorization phù hợp precondition của AC-13; HTTP/error code cụ thể để `TBD` nếu AC không chỉ rõ.
