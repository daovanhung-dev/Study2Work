...
### 1. Nhận `PATCH /api/v1/mentor/support/{request_id}/resolve` từ actor `Mentor` trong AC-24.
...
- Source: `AC-24` / ERD / API Index theo nội dung bước.
### 3. Đọc path parameter: `request_id`; type/range validation chưa được diagram khóa thì để `TBD`.
