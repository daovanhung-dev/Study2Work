...
|---|---|---|---|
| `data.content` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.video` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.resource refs` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
