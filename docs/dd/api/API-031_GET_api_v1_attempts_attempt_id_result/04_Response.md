...
|---|---|---|---|
| `data.score` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.feedback` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
| `data.status` | `TBD` | Explicit output in AC | Mapping chi tiết xem Data Mapping |
