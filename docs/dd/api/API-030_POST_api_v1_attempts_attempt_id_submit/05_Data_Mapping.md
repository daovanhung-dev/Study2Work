...
### 1. Nhận `POST /api/v1/attempts/{attempt_id}/submit` từ actor `Student` trong AC-16.
...
| `quiz_answers` | POST / exact operation TBD | ERD-backed entity | Exact predicate/mutation only where AC explicitly fixes it |
