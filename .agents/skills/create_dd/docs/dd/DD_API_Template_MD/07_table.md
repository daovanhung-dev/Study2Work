...
| Thuộc tính | Giá trị |
|---|---|
| Physical table | `<TABLE_ID>` |
| Logical table | `<TABLE_NAME>` |
...
- `<UPDATE_CONDITION_OR_N/A>`.

| No | Item ID / Column | Item name | Type | Length | Scale | Required | Main key | Setting content | Source | Data Mapping step | Remarks |
|---:|---|---|---|---:|---:|---:|---:|---|---|---|---|
| 1 | `<COLUMN_1>` | `<LOGICAL_NAME_1>` | `<TYPE>` | `<LENGTH>` | `<SCALE>` | `<Y/N>` | `<●/blank>` | `<SETTING>` | `<SOURCE>` | `<STEP>` | |

## Insert mapping

**Áp dụng khi**

- `<INSERT_CONDITION_OR_N/A>`.
