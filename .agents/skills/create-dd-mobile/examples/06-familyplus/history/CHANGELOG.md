# CHANGELOG — FAMILYPLUS / FamilyPlus

## [v1.2] - 2026-06-30
### Changed
- Marked FAMILYPLUS DD docs as `Approved - DD docs complete`.
...
## [v1.1] - 2026-06-30
### Changed
- Recorded accepted product decisions Q-15, Q-11 in README, Overall, Import_File, and checklist traceability.
...
## [v1.0] - 2026-06-28
### Added
- Initial DD created from docs/BD/project_flow/BD_BioAI_Product_Flow_Sale_Admin_v2.0.md (BD-BIOAI-PRODUCT-FLOW-002), scope BD sections 10/M11, 13, 14.2, 16.1 AC-06, Appendix A UC-11.
- Created README, Overall, List_Features, Function_List, Views, Import_File, diagrams README, assets README, and changelog.

### Impact
- Affected module: M11 / FAMILYPLUS.
