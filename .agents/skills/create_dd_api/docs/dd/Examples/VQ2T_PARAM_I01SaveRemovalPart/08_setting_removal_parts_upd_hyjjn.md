---
title: "setting_removal_parts_upd_hyjjn"
order: 8
source_workbook: "【VQ2T-PARAM】API設計_I01_I01SaveRemovalPart_Ver1.0_VN 1.xlsx"
source_sheet: "setting_removal_parts_upd_hyjjn"
dd_id: "I01SaveRemovalPart"
format: markdown
---
# setting_removal_parts_upd_hyjjn
...
|---:|---|---|---|---:|---:|---:|---:|---|
| 1 | `parts_list_id` | 取外部品ID | `character varying` | 5 |  | Y | ● | ＜Không đổi＞ |
| 2 | `sdiknr_no` | 世代管理番号 | `integer` | - |  | Y | ● | ＜Không đổi＞ |
| 3 | `seiskjy_id` | 拠点ID | `character varying` | 5 |  |  |  | ＜Không đổi＞ |
| 4 | `sisnlin_id` | ラインID | `character varying` | 5 |  |  |  | ＜Không đổi＞ |
| 5 | `bmn_id` | 部門ID | `character varying` | 3 |  |  |  | ＜Không đổi＞ |
| 6 | `parts_list_nm` | プリセット名 | `character varying` | 50 |  |  |  | ＜Không đổi＞ |
| 7 | `file_nm` | ファイル名 | `character varying` | 50 |  |  |  | ＜Không đổi＞ |
| 8 | `sksi_dt` | 作成日時 | `timestamp with time zone` | - |  |  |  | ＜Không đổi＞ |
| 9 | `sksiprg_cd` | 作成者コード | `character varying` | 32 |  |  |  | ＜Không đổi＞ |
| 10 | `sishkshn_dt` | 更新日時 | `timestamp with time zone` | - |  |  |  | NOW() |
| 11 | `sishkshnprg_cd` | 更新者コード | `character varying` | 32 |  |  |  | Param['sishkshnprg_cd'] |
| 12 | `skj_flg` | 削除フラグ | `character varying` | 1 |  |  |  | ＜Không đổi＞ |
| 13 | `hyjjn_no` | 表示順 | `integer` | - |  |  |  | Tăng giá trị hyjjn_no thêm 1 |

---
## Phụ lục đối chiếu nguồn Excel
- Workbook nguồn: `【VQ2T-PARAM】API設計_I01_I01SaveRemovalPart_Ver1.0_VN 1.xlsx`
- Sheet nguồn: `setting_removal_parts_upd_hyjjn`
- Dimension: `A1:BR20`
- Trạng thái: `visible`
...
| 20 | `O20` | integer |  |
| 20 | `S20` | - |  |
| 20 | `W20` | Tăng giá trị hyjjn_no thêm 1 |  |
