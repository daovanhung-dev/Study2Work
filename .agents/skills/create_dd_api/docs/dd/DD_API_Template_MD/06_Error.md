...
|---:|---|---|---|---|---:|---|---|---|---:|---|
| 1 | System error | `-` | `-` | Trường hợp lỗi truy cập DB | `500` | `9999` | `DLG000000` | `<STEP>` | `<Yes/No>` | |
| 2 | Check quyền | `-` | `<ITEM>` | `<CONDITION>` | `<STATUS>` | `<CODE>` | `<MESSAGE_ID>` | `<STEP>` | `<Yes/No>` | |
| 3 | Check tồn tại | `○` | `<ITEM>` | `<CONDITION>` | `<STATUS>` | `<CODE>` | `<MESSAGE_ID>` | `<STEP>` | `<Yes/No>` | |
