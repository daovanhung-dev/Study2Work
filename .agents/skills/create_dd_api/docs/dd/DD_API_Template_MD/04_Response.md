...
|---:|---|---|---|---|---:|---|---|---|---|---|---|
| 1 | `HTTPStatus` | HTTP Status | `HTTPStatus` | `integer` | `No` | `N/A` | `N/A` | `<STEP>` | Fixed by branch | `N/A` | Success: `200`; system error: `500`; validation error: `400` |
| 2 | `status` | Status | `status` | `integer` | `No` | `N/A` | `N/A` | `<STEP>` | Success=`1`; error=`2` | `N/A` | Business status |
| 3 | `response` | Nội dung response | `response` | `object` | `No` | `N/A` | `N/A` | `<STEP>` | Object mapping | `{}` if no content | |
| 3.1 | `response.<field>` | `<LOGICAL_NAME>` | `<physical_name>` | `<TYPE>` | `<Yes/No>` | `<TABLE>` | `<COLUMN>` | `<STEP>` | `<TRANSFORM>` | `<RULE>` | `<REMARKS>` |
| E1 | `response.error_code` | Error code | `error_code` | `string` | `No` | `N/A` | `N/A` | `<ERROR_STEP>` | Fixed by error case | `N/A` | Error branch |
| E2 | `response.error_message_id` | Error Message ID | `error_message_id` | `string` | `No` | `N/A` | `N/A` | `<ERROR_STEP>` | Fixed by error case | `N/A` | Error branch |
