...
| 2 | Basic authen | `Authorization` | `<Yes/No>` | `Bearer <token>` | Token xác thực | `05_Data_Mapping.md#11-get-request-header` |

## Path parameters

| No | Logical name | Physical name | Type | Required | Min | Max | Format | Valid values | Default | Description | Data Mapping reference |
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | `<LOGICAL_NAME>` | `<physical_name>` | `<TYPE>` | `<Yes/No>` | `<MIN>` | `<MAX>` | `<FORMAT>` | `<VALID_VALUES>` | `<DEFAULT>` | `<DESCRIPTION>` | `<STEP>` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|---|
| 1 | `<LOGICAL_NAME>` | `<physical_name>` | `<TYPE>` | `<Yes/No>` | `<MIN>` | `<MAX>` | `<CHARACTER_TYPE>` | `<FORMAT>` | `<VALID_VALUES>` | `<DEFAULT>` | `<DESCRIPTION>` | `<STEP>` |
