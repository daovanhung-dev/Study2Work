...
COLLECTION_STATUS: VERIFIED (114 tests)
```
...
category retrieval and API #6 public course retrieval. The register,
verification, category and course tests use the current `app.modules.guest.*`
namespace; full collection is available.
