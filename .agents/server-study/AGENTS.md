...
1. Chỉ coi route hiện có là runtime-verified khi import chain và HTTP test đã pass; hiện Study import, register HTTP tests và auth login/refresh tests đã pass.
