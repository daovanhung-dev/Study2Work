...
| Task | Page |
|---|---|
| Architecture/deployable boundary | `architecture.md` |
| Shared UI/design | `../project/design.md`, `conventions.md` |
| API/auth/dependencies | `dependencies.md` |
| Feature/module routing | `modules/README.md` |
