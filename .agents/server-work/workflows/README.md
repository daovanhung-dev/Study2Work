...
without copying Study's Python, SQLAlchemy, static secrets or ES256. Treat empty
services and target-contract-only routes as `UNWIRED` until an actual
import/registration exists.
