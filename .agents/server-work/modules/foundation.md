...
BigInt/Date serialization, numeric path validation, request validation,
multipart upload handling, and owner/role checks. It returns a consistent
trace ID header and JSON error envelope for handled Prisma, parser and Multer
failures.
