...
|---|---|---|---|---|
| WMB_CHAT-V01 | `TroChuyen` | `lib/views/tro_chuyen/tro_chuyen.dart` | WIRED | Partner list và mở ChatView. |
| WMB_CHAT-V02 | `ChatView` | `lib/views/tro_chuyen/chat.dart` | WIRED | History/send/polling 3 giây, dedup ids, dispose cancellation. |

## WMB_CHAT-V01 — TroChuyen

- **Source:** `lib/views/tro_chuyen/tro_chuyen.dart`
- **Status:** WIRED
- **Function:** WMB_CHAT-FN01
...
## WMB_CHAT-V02 — ChatView

- **Source:** `lib/views/tro_chuyen/chat.dart`
- **Status:** WIRED
- **Function:** WMB_CHAT-FN02
