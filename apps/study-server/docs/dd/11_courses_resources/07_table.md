...
| Thuộc tính | Giá trị |
|---|---|
| Physical table | `courses; lessons; resources` |
| Logical table | `Published course scope, lesson relation và resource metadata` |
| Operation | `N/A — no DB mutation` |
| Data Mapping step | `3.1/4.1 — SELECT only` |

## Update mapping

**Áp dụng khi**

- `N/A — API #11 là read-only.`
