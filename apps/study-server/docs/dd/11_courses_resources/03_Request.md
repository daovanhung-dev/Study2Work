...
|---|---|
| HTTP method | `GET` |
| URI | `/api/v1/courses/{course_id}/resources` |
...
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | Course ID | `course_id` | `int64` | `Yes` | `N/A — chưa đặc tả` | `N/A — chưa đặc tả` | Integer path segment | `N/A` | `N/A` | ID của khóa học cần lấy tài nguyên | [`1.1/1.2`](./05_Data_Mapping.md#11-get-request-path) |
...
```http
GET /api/v1/courses/101/resources HTTP/1.1
