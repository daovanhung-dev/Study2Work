...
|---:|---|---|---:|---|---|---|
| 1 | Authorization | `Authorization` | `No` | `N/A — public endpoint` | Không yêu cầu Bearer token | [`0.4`](./05_Data_Mapping.md#04-get-request-header) |
| 2 | Content type | `Content-Type` | `No` | `N/A — request không có body` | GET không có request body theo contract | [`0.4`](./05_Data_Mapping.md#04-get-request-header) |
...
```http
GET /api/v1/courses?page=1&size=20 HTTP/1.1
