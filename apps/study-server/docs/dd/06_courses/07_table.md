...
| Logical table | `N/A — course list query only` |
| Operation | `N/A — no DB mutation` |
| Data Mapping step | `2/3/4 — SELECT and count only` |

## Update mapping

**Áp dụng khi**

- `N/A — API #6 không có UPDATE.`
