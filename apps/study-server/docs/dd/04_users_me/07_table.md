...
| Logical table | `N/A — current user profile query` |
| Operation | `N/A — no DB mutation` |
| Data Mapping step | `2.1 — SELECT users by JWT user_id` |

## Update mapping

**Áp dụng khi**

- `N/A — API #4 không có UPDATE được source xác nhận.`
...
- `N/A — API #4 không có INSERT được source xác nhận.`
...
- `N/A — API #4 không có DELETE được source xác nhận.`
