...
|---:|---|---|---|---:|---|---|---|---|---|---|---|---|
| 1 | User ID | `user_id` | `int64` | `Yes` | `N/A — chưa đặc tả` | `N/A — chưa đặc tả` | `numeric` | `int64` | `N/A` | `N/A` | ID user dùng cho verification dispatch | [`2.1`](./05_Data_Mapping.md#21-validate-user-id) |
| 2 | Email | `email` | `email` | `Yes` | `N/A — chưa đặc tả` | `N/A — chưa đặc tả` | `text` | `email` | `N/A` | `N/A` | Địa chỉ nhận mã/link xác thực | [`2.2`](./05_Data_Mapping.md#22-validate-email) |

> Mỗi field phải nằm trên một row riêng. Không có field token/link, expiry hoặc retry trong request contract V1.
