...
| Thuộc tính | Giá trị |
|---|---|
| Physical table | `N/A — no source-confirmed DB table` |
| Logical table | `N/A — external Email Provider side effect` |
| Operation | `N/A — no DB mutation` |
| Data Mapping step | `3.2 — external dispatch; no DB mapping` |

## Update mapping

**Áp dụng khi**

- `N/A — API #2 không có UPDATE được ERD/contract xác nhận.`
...
- `N/A — API #2 không có INSERT được ERD/contract xác nhận.`
...
- `N/A — API #2 không có DELETE được ERD/contract xác nhận.`
