...
|---:|---|---|---:|---|---|---|
| 1 | Authorization | `Authorization` | `No` | `N/A — public endpoint` | Không yêu cầu Bearer token | [`0.1`](./05_Data_Mapping.md#01-thực-hiện-check-quyền) |
| 2 | Content type | `Content-Type` | `No` | `N/A — request không có body` | GET không có request body theo contract | [`1`](./05_Data_Mapping.md#1-get-request-data) |

## Path parameters

| No | Logical name | Physical name | Type | Required | Min | Max | Format | Valid values | Default | Description | Data Mapping reference |
|---:|---|---|---|---:|---:|---:|---|---|---|---|---|
| 1 | Course ID | `course_id` | `int64` | `Yes` | `N/A — chưa đặc tả` | `N/A — chưa đặc tả` | Integer path segment | `N/A` | `N/A` | ID của khóa học cần xem | [`1.1/1.2`](./05_Data_Mapping.md#11-get-request-path) |
