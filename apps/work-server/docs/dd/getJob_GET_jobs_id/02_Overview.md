...
| ---: | --- |
| API ID | `getJob` |
| Source runtime handler/use-case | jobs.view.getJob |
| Module | Jobs |
| Method | `GET` |
| Endpoint | `/api/v1/jobs/:id` |
| Purpose | Load one public JD by numeric id. |
...
- Invalid id is rejected before Prisma lookup.
- Missing JD maps to JOB_NOT_FOUND.
