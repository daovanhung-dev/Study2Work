...
| 2 | Authentication | - | `credentials` | Không tồn tại doanh nghiệp hoặc mật khẩu không khớp | 401 | `INVALID_CREDENTIALS` | N/A — source không có message ID | `query result` | N/A |  |
