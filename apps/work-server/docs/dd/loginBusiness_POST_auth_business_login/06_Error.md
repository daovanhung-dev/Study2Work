...
| 3 | Authentication | - | `credentials` | Không tồn tại doanh nghiệp hoặc bcrypt/legacy password không khớp | 401 | `INVALID_CREDENTIALS` | N/A — source không có message ID | `query result` | N/A |  |
