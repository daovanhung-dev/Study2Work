...
| businessCode | string | `SYSTEM_HEALTH_LIVE` | Business code do view/system route trả về. | successResponse |
| message | string | Work API is live. | Message source-confirmed. | successResponse |
...
| data.service | string \| null | source value | Static service identifier. | src/app.ts live route |
| data.environment | string \| null | source value | config.appEnv. | src/app.ts live route |
