...
| ---: | --- | --- | --- | --- | --- |
| 1 | INTERNAL_SERVER_ERROR | 500 | Lỗi máy chủ. | Unhandled error is mapped safely without exposing secret. | apps/work-server/src/core/exceptions.ts |
| 2 | NOT_FOUND | 404 | Không tìm thấy tài nguyên. | Unknown route falls through app notFoundHandler. | apps/work-server/src/app.ts |
