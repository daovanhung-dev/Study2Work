...
| ---: | --- | --- | --- | --- |
| 1 | service | data field | Static service identifier. | src/app.ts live route |
| 2 | environment | data field | config.appEnv. | src/app.ts live route |

## Validation and branch rules

- Returns 200 without dependency probe.
- Environment is taken from typed config.
