...
| ---: | --- | --- | --- | --- |
| 1 | service | data field | Static service identifier from the route. | src/api/v1.ts system route |

## Validation and branch rules

- sendSuccess returns status 200 and `SYSTEM_ROOT_LOADED`.
- Trace middleware runs before the route.
