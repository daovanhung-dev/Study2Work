...
| businessCode | string | `SYSTEM_ROOT_LOADED` | Business code do view/system route trả về. | successResponse |
| message | string | Welcome to Study2Work. | Message source-confirmed. | successResponse |
...
| data.service | string \| null | source value | Static service identifier from the route. | src/api/v1.ts system route |
