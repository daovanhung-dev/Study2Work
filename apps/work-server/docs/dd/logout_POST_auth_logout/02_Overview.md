...
| Purpose | Xác thực request logout và trả thành công; token bị client xóa, server không revoke token. |
...
- Stateless logout; không có DB write, denylist hoặc Set-Cookie..
