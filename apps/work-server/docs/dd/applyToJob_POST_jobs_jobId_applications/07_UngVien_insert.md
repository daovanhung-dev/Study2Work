...
| ---: | --- | --- | --- | --- |
| 1 | sinhvien_id | INSERT | token.id | BigInt |
| 2 | doanhnghiep_id | INSERT | JD.doanhnghiep_id | BigInt |
| 3 | jd_id | INSERT | path.jobId | BigInt |

## Insert/Update/Delete behavior

- id, created_at and trangthai use Prisma/schema defaults.
- Unique key is (jd_id, sinhvien_id).
