...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Job ID | jobId | string -> positive safe integer | Yes | digits only; >0; Number.isSafeInteger | N/A | Target JD primary key. | apps/work-server/src/modules/applications/validate.ts |
