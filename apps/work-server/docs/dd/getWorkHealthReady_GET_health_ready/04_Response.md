...
| businessCode | string | `SYSTEM_HEALTH_READY` | Business code do view/system route trả về. | successResponse |
| message | string | Work API is ready. | Message source-confirmed. | successResponse |
...
| data.service | string \| null | source value | Static service identifier. | src/app.ts ready route and core/database.ts |
| data.environment | string \| null | source value | config.appEnv. | src/app.ts ready route and core/database.ts |
| data.dependencies.database | string \| null | source value | configured after probeDatabase succeeds. | src/app.ts ready route and core/database.ts |
| data.dependencies.redis | string \| null | source value | configured when REDIS_URL exists; otherwise not_configured. | src/app.ts ready route and core/database.ts |
