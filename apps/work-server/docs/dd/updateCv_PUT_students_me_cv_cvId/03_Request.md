...
| ---: | --- |
| HTTP method | `PUT` |
| URI | `/api/v1/students/me/cv/:cvId` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | CV ID | cvId | string -> positive safe integer | Yes | digits only; >0; Number.isSafeInteger | N/A | CV primary key. | apps/work-server/src/modules/cv/models.ts |
