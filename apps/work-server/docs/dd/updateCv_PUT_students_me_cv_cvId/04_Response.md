...
| businessCode | string | `CV_UPDATED` | Business code do view/system route trả về. | successResponse |
| message | string | Cập nhật CV thành công. | Message source-confirmed. | successResponse |
